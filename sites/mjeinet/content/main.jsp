                ...
                <div class="VisualLink" id="jntisMainContentStart">
                    <ul class="MVisualLinkList">
                        <li class="MVisualLinkList01">
                            <a href="/mjeinet/sub.do?m=53" title="장비예약신청" target="_self">
                                <div class="h_icon"></div>
                                <h3>장비예약신청</h3>
                            </a>
                        </li>
                        <li class="MVisualLinkList02">
                            <a href="/mjeinet/sub.do?m=53" title="장비검색" target="_self">
                                <div class="h_icon02"></div>
                                <h3>장비검색</h3>
                            </a>
                        </li>
                        <li class="MVisualLinkList03">
                            <a href="/mjeinet/sub.do?m=73" title="장비정보" target="_self">
                                <div class="h_icon03"></div>
                                <h3>장비정보</h3>
                            </a>
                        </li>
						<li class="MVisualLinkList04">
                            <a href="/mjeinet/sub.do?m=110" title="예약이용관리" target="_self">
                ...
                <ul class="Main01">
                    ...
                    <li>
                        <div class="status icon02">
                            ...
                            <h4>등록장비수</h4>
                            <h4><span id="strEquCnt"></span>점 (전남<e id="strJEquCnt"></e>점)</h4>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="board">
                            ...
                            <div class="article article_mn1">
                                <h3 class="TitBoard TitBoard01">
                                    ...
                                    >공지사항</a>
                                    <a class="more" href="/jntis/sub.do?m=98">MORE+</a>
                                </h3>
