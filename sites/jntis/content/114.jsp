...
<%
     ...
     String listMode = util.getStr(request.getParameter("listMode"),"orgList");
     ...
     String m = "114";
     String boardComIdx = "00061";//코드를 입력하세요
%>
<jsp:include page="/web/comBoard.do" flush="true">
     ...
     <jsp:param name="m" value="114"/>
     <jsp:param name="boardComIdx" value="00061"/>
</jsp:include>