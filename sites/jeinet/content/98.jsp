...
<% 
	...
	String siteId = util.getStr(request.getParameter("boardIdx")); //게시판 구분
	String boardComIdx = "00009";//코드를 입력하세요
	if(tab.equals("") || tab == null || tab.equals(null) || tab == "null"){
		tab = "build";
	}
