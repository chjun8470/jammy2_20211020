	...
	<div class="col-lg-12">
		<div class="block">
			...
			<div class="block-content">
				<div class="pull-left">
					<form:form commandName="searchCounterDayVO" action="${pageContext.request.contextPath}/cms/admin/counter.do?act=weekly" method="post" class="form-inline form-search" role="form">
						<fieldset>
