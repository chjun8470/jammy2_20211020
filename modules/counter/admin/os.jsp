	...
	<div class="col-lg-12">
		<div class="block">
			<ul class="nav nav-tabs">
			    ...
			    <li><a href="?act=browser&amp;siteId=<c:out value='${searchCounterLogVO.siteId}'/>">브라우저별</a></li>
			    <li class="active"><a href="?act=os&amp;siteId=<c:out value='${searchCounterLogVO.siteId}'/>">OS별</a></li>
			    <li><a href="?act=page&amp;siteId=<c:out value='${searchCounterLogVO.siteId}'/>">페이지별</a></li>
			</ul>		
			<div class="block-content">
				<div class="pull-left">
					<form:form commandName="searchCounterLogVO" action="${pageContext.request.contextPath}/cms/admin/counter.do?act=os" method="post" class="form-inline form-search" role="form">
						<fieldset>
				...
				<div class="pull-right">
					<a href="?act=os&amp;mode=excel&amp;siteId=<c:out value='${searchCounterLogVO.siteId}'/>&amp;device=<c:out value='${searchCounterLogVO.device}'/>&amp;startDate=<c:out value='${searchCounterLogVO.startDate}'/>&amp;endDate=<c:out value='${searchCounterLogVO.endDate}'/>" class="btn btn-primary">엑셀다운로드</a>
				</div>
			</div>
