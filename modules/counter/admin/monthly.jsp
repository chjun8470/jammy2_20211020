	...
	<div class="col-lg-12">
		<div class="block">
			...
			<div class="block-content">
				<div class="pull-left">
					<form:form commandName="searchCounterDayVO" action="${pageContext.request.contextPath}/cms/admin/counter.do?act=monthly" method="post" class="form-inline form-search" role="form">
						<fieldset>
							...
							<div class="form-group">
								<form:input path="startDate" class="form-control mdatepicker" style="display:inlne-block; width:80px;" /> ~ 
								<form:input path="endDate" class="form-control mdatepicker" style="display:inlne-block; width:80px;" />
							</div>						
				...
				<div class="pull-right">
					<a href="?act=monthly&amp;mode=excel&amp;siteId=<c:out value='${searchCounterDayVO.siteId}'/>&amp;device=<c:out value='${searchCounterDayVO.device}'/>&amp;startDate=<c:out value='${searchCounterDayVO.startDate}'/>&amp;endDate=<c:out value='${searchCounterDayVO.endDate}'/>" class="btn btn-primary">엑셀다운로드</a>
				</div>			
			</div>
			<div class="block-content np">		
				<table class="table">
					...
					<tbody>
						...
						<fmt_rt:formatNumber var="percentHits" value="${sumHits == 0 ? 0 : (result.hits / sumHits * 100)}" maxFractionDigits="1" />
						<fmt_rt:formatNumber var="percentUniqHits" value="${sumUniqHits == 0 ? 0 : (result.uniqHits / sumUniqHits * 100)}" maxFractionDigits="1" />						
						<tr>
