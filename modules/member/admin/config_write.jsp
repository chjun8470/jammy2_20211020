	...
	<div class="col-lg-12">	
		<div class="block">
			<ul class="nav nav-tabs">
			    <li><a href="<c:url value='/cms/admin/member/gnrl.do?mberSttus=P' />">회원목록(승인)</a></li>
			    <li><a href="<c:url value='/cms/admin/member/gnrl.do?mberSttus=A' />">회원목록(가입대기)</a></li>
			    <li><a href="<c:url value='/cms/admin/member/gnrl.do?mberSttus=D' />">회원목록(탈퇴)</a></li>			    
