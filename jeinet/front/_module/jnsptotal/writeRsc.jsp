...
<div id="locationFinder"></div>
	...
	<div class="clear_wrap">
			<div class="left_box w80">
				<div class="box_in">
					<p class="tr mb5"></p>
					<table id="step1" summary="연구시설의 상세정보입력" class="tbl04">
...
<!--                 		<tr class="equipRegistOption" id="equipMainDetail" title="주장비 추가등록 옵션" style="display:none;"> -->
                		...
                		<tr>
                			...
                			<td class="brn">
                				<input id="fixedAsetNo" name="fixedAsetNo" title="고정자산번호" style="width:47%;" maxlength="30" type="text" onkeydown="$('#fixedAsetCheckVal').val('N')" onkeydown="$('#fixedAsetCheckVal').val('N')" onkeyup="if(event.keyCode==32){this.value=this.value.replace(/[\s]/gi,'');alert('스페이스바는 사용하실 수 없습니다.');}"/>
                		...
                		<tr>
                			<th scope="row" class="bln"><label for="korNm" id="kor"> * 한글시설명</label></th>
                			<td class="brn srch_label">
                				<input id="korNm" name="korNm" title="한글시설명" style="width:70%;" type="text" maxlength="30"/>
                				<!-- <div>
                		...
                		<tr>
                			...
                			<td class="brn srch_label">
                				<input id="korKeyWord1" name="korKeyWord1" title="한글키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="korKeyWord2" name="korKeyWord2" title="한글키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="korKeyWord3" name="korKeyWord3" title="한글키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="korKeyWord4" name="korKeyWord4" title="한글키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="korKeyWord5" name="korKeyWord5" title="한글키워드" style="width:80px;" type="text" maxlength="15"/>
                			</td>
                		</tr>
                		
                		<tr>
                			<th scope="row" class="bln"><label for="engNm" id="eng"> * 영문시설명</label></th>
                			<td class="brn">
                				<input id="engNm" name="engNm" title="영문시설명" style="width:100%;" type="text" maxlength="100"/>
                			</td>
                		</tr>
                		<tr>
                			<th scope="row" class="bln"><label for="engKeyWord1" id="engKeyWordTR">영문키워드</label></th>
                			<td class="brn srch_label">
                				<input id="engKeyWord1" name="engKeyWord1" title="영문키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="engKeyWord2" name="engKeyWord2" title="영문키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="engKeyWord3" name="engKeyWord3" title="영문키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="engKeyWord4" name="engKeyWord4" title="영문키워드" style="width:80px;" type="text" maxlength="15"/>
                				<input id="engKeyWord5" name="engKeyWord5" title="영문키워드" style="width:80px;" type="text" maxlength="15"/>
                			</td>
                		</tr>
                		<tr>
...
<!--  								<input id="manufactureNm" name="manufactureNm" style="width:40%;background-color:#dddddd;" type="text" value="" readonly="readonly"/> -->
									<input id="manufactureNm" name="manufactureNm" style="width:40%;" type="text" value="" maxlength="50"/>
<!-- 								<input id="manufactureFind" name = "manufactureFind" title="제작사,모델찾기버튼" type="button" value="찾기" onclick="manuFactureFind()"/> -->
								<input id="manuFactureNone" name = "manuFactureNone" title="모델명 없음" type="checkbox" onclick="manuFactureNoneCheck()"/><label for="manuFactureNone">모델명 없음</label>
                			</td>
                		</tr>
                		<tr>
					...
					<select name="branchCd3" id="branchCd3" onchange="branchCall(this.value,'')" style="width:100px">		                			
						...
						<tr id="takeCdChange3" >
							...
							<td class="brn">
								<div class="equipCdOption" id="equiCdpsubDetail1">
									<input id="takeSdt" name="takeSdt" class="equipCalendar" title="구축일자(개발, 시설 선택 시)" type="text" value="" readonly="readonly"/>
									~
									<input id="takeEdt" name="takeEdt" class="equipCalendar" title="구축일자(개발, 시설 선택 시)" type="text" value="" readonly="readonly"/>
									<p> </p>
								</div>
							</td>
						</tr>
                		...
                		<tr>
                			<th scope="row" class="bln"><label for="fileList" id="fileImage"> * 시설사진</label></th>
                			<td>
				...
				<br/> * 가로형 이미지만 등록해주세요.
	                ...
	                <div class="btn_box" id="div_step1">
	                		...
	                		<div class="btn_right_box" >
		                		...
		                		<button onclick="nextPage();" class="btn_inp_b_01" type="button">2단계로</button>
		                		<input class="btn_inp_w_01" type="button" onclick="window.location.href='/sys/sys_jnsptotal.do'" value="목록"/>
	                		</div>
	                </div>
<!-- ////////////////// 2단계///////////////////// -->
	                <table id ="step2" summary="연구시설의 상세정보입력" class="tbl04" style="display:none;">
	                	<caption>연구시설 상세정보</caption>
	                	<colgroup>
	               			<col width="220px">
	               			<col width="">
                		...
                		<tr>
                			...
                			<td class="brn srch_label">
                				<label><input id="rndY" name="rndYN" type="radio" value="Y" />R&D 과제(연구개발사업 조사분석대상)</label>
                				
                				<label><input id="rndN" name="rndYN" type="radio" value="N" />비 R&D 과제</label>
                				<br/>
                				<input id="rndInfo" name="rndInfo" value="" maxlength="30"/>
                			...
                			<td class="brn srch_label">
                				...
                				<table style="width:100%">
	                				...
	                				<tbody>
		                				<tr>
		                					<th rowspan="2">토지비</th>
			                				<td><input type="text" style="width:60%" id="landPrc" name = "landPrc" value = "0" onkeyup="korNumTrans(this.value,'landPrcKor');"/>(원)</td>
			                				<th>면적</th>
			                				<td><input type="text" style="width:60%" id="landArea" name = "landArea" value = "0" />㎡</td>	
		                				</tr>
		                				<tr>
		                				...
		                				<tr id = "noneLandReason" style="display:none">
		                					<th>사유</th>
		                					<td colspan="3">
		                						<input type="text" id="landReason" name="landReason" style="width:60%"/>
	                			...
	                			<table style="width:100%">
	                				...
	                				<tbody>
		                				<tr>
		                					<th rowspan="2">건물비</th>
			                				<td><input type="text" style="width:60%" id="buildPrc" name = "buildPrc" value = "0" onkeyup="korNumTrans(this.value,'buildPrcKor');"/>(원)</td>
			                				<th>면적</th>
			                				<td><input type="text" style="width:60%" id="buildArea" name = "buildArea" value = "0" />㎡</td>	
		                				</tr>
		                				<tr >
		                				...
		                				<tr>
		                					<th>지상층수</th>
			                				<td><input type="text" style="width:60%" id="floorUp" name = "floorUp" value = "0" />(층)</td>
			                				<th>지하층수</th>
			                				<td><input type="text" style="width:60%" id="floorDown" name = "floorDown" value = "0" />(층)</td>	
		                				</tr>
		                				<tr id = "noneBuildReason" style="display:none">
		                					<th>사유</th>
		                					<td colspan="3">
		                						<input type="text" style="width:60%" id="buildReason" name="buildReason"/>
		                		...
		                		<table style="width:100%">
	                				...
	                				<tbody>
		                				<tr>
			                				...
			                				<td colspan="3"><input type="text" style="width:40%" id="equipFacilitiesTakePrc" name = "equipFacilitiesTakePrc" value = "0" onkeyup="korNumTrans(this.value,'equipFacilitiesTakePrcKor')"/>(원)
			                				<span style="float:right">
			                					<input type="checkbox" onclick = "equipFacilitiesYNCheck()" id="equipFacilitiesY" name = "equipFacilitiesYN" value = "Y" /><label for="equipFacilitiesY">특수설비 없음</label>
                				...
                				<table style="width:100%">
	                				...
	                				<tbody>
		                				<tr>
			                				...
			                				<td colspan="3">
				                				<input type="text" style="width:40%" id="equipTakePrc" name = "equipTakePrc" value = "0" onkeyup="korNumTrans(this.value,'equipTakePrcKor')"/>(원)
				                				<input id="equipTakePrcNoneYN" onclick = "equipTakePrcNoneCheck()" name = "equipTakePrcNoneYN" title="연구장비없음" type="checkbox"/>
...
<!-- 				                				<input type="button" value="연구장비선택" onclick="alert('미실장');"/> -->
		                				...
		                				<tr>
			                				...
			                				<td colspan="3">
			                				<input type="text" style="width:60%" id="equipLittleTakePrc" name = "equipLittleTakePrc" value = "0" onkeyup="korNumTrans(this.value,'equipLittleTakePrcKor')"/>(원)
			                				</td>
		                				</tr>
		                				<tr>
		                					<td colspan="3">
                				...
                				<table style="width:100%">
                					...
                					<tr>
                						<th>총 구축금액</th>
                						<td><input type="text" style="width:100%;background-color:#0F0F0F0F" id="takePrc" name="takePrc" value="0" readonly="readonly">(원)</td>
                						<th>국산금액</th>
                						<td><input type="text" style="width:100%" id="takePrcForeign" name="takePrcForeign" value="0" onkeyup="korNumTrans(this.value)">(원)</td>
                						<th>외산금액</th>
                						<td><input type="text" style="width:100%" id="takePrcDomestic" name="takePrcDomestic" value="0" onkeyup="korNumTrans(this.value)">(원)</td>
                					</tr>
                					<tr>
                		...
                		<tr class="useTypeCd" id="useTypeCd_06" style="display:none">
							...
							<td class="brn"><input id="useTypeReason" name="useTypeReason" style="width:450px;" type="text" value=""/></td>
						</tr>
...
<!-- 									<input id="idleDisuseCd5" name="idleDisuseCd" type="radio" value="05"/><label for="idleDisuseCd5">대여</label> -->
						...
						<tr id="trDisuseCd" class="disuseCd" style="display:none;">
									...
									<td class="brn">
 										<input id="disuseOrgan" name="disuseOrgan" type="text" value="" style="background-color:#0F0F0F0F"/>
<!-- 									<input id="disuseOrganFinder" onclick="alert('미실장');" type = "button" value="찾기"/> -->
										...
										<p id="pDisuseCd_01" style="display:none">
											<span class="f_blue">
												매각일자가 불용판정일자와 다를 경우, 매각된 일자로 수정해주세요 
											</span>
										</p>
										<p id="pDisuseCd_02" style="display:none">
											<span class="f_blue">
												재활용일자가 불용판정일자와 다를 경우, 재활용된 일자로 수정해주세요
											 </span>
										</p>
										<p id="pDisuseCd_03" style="display:none">
											<span class="f_blue">
												폐기일자가 불용판정일자와 다를 경우, 폐기된 일자로 수정해주세요
											 </span>
										</p>
										<p id="pDisuseCd_04" style="display:none">
											<span class="f_blue">
												양여일자가 불용판정일자와 다를 경우, 양여된 일자로 수정해주세요 
											</span><br/>
											<!-- <span class="f_orange">
												찾기를 통해 기관을 선택해주세요. 찾고자 하는 기관이 없을 경우에는 관리자에게 문의하시기 바랍니다.
											</span> -->
										</p>
										<p id="pDisuseCd_05" style="display:none">
											<span class="f_blue">
												대여일자가 불용판정일자와 다를 경우, 대여된 일자로 수정해주세요 
											</span><br/>
											<!-- <span class="f_orange">
												찾기를 통해 기관을 선택해주세요. 찾고자 하는 기관이 없을 경우에는 관리자에게 문의하시기 바랍니다.
											</span> -->
                		...
                		<tr>
							...
							<td class="brn">
								<textarea id="feature" name="equipDetailFeature" title="시설설명" style="width:100%;" rows="5" cols="10" maxlength="300"></textarea>
<!-- 								<br/> * 50자 이상 입력해주세요 -->
							</td>
						</tr>
                		<tr>
