	  ...
	  <form name="fwrite" id="fwrite" action="?<%=m%>" method="post" enctype="multipart/form-data" >
		...
		<div class="skin_bbs_write" style="margin-top:30px">
			...
			<tr>
				...
				<td>
					<input type="text" class="inp_text box_style_2" name="sampleNm" id="sampleNm" value="" size="70"/>
				</td>
			</tr>
			<tr>
				<th scope="col"><font color="red">*</font> 시료수</th>
				<td>
					<input type="text" class="inp_text box_style_3" name="sampleNo" id="sampleNo" value="" size="30"/>
					* 숫자 1이상의 정수 입력
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" class="inp_text box_style_6" name="corpResponsibleUser" id="corpResponsibleUser" value="테스트" size="30"/>
				</td>
			</tr>
			<tr>
				<th scope="col"><font color="red">*</font> 연락처</th>
				<td>
					<input type="text" class="inp_text box_style_7" name="phone" id="phone" value="<%=util.getStr(userMap.get("CP_NO"))%>" size="12"/>
					* ex) 010-0123-4567
				</td>
			</tr>
			<tr>
