...
a:hover {
  ...
  <form name="fview" id="fview" action="./sub.do" method="post" >
	...
	<h2 class="h4_tit">국가 R&D 사업정보</h2>
	<table class="skin_view" style="">
	  	<caption>국가 R&D 사업정보표</caption>
		<colgroup>
		  <col style="width:15%;" />
		  <col style="width:35%;" />
		  <col style="width:15%;" />
		...
		<tbody>
			...
			<tr>
			    ...
			    <td class="r_line_none" colspan="3">
					<a href="#" onclick="window.open('<%=util.getStr(dataMap.get("NEW_TYPE2"))%>','url','width=750,height=700,scrollbars=yes')">
	...
	<div class="b_btn_area">
		<div class="btn_hr_new btn_right_box">
			<input type="button" class="btn_rgt lft_btn_box_new" value="목록" onclick="pageGo('list')"/>
			<%if(m.equals("Y")){%>
		    <input type="button" class="btn_rgt" value="수정" onclick="pageGo('editProc')"/>
		    <%}%>
	 	</div>
	</div>
