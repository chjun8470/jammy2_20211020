  ...
  <%if(util.getStr(boardMap.get("PERM_FILE")).equals("Y")){ %>
					...
					<div style="display:inline-block;" id="<%=fileFullGrp%>fileGrpBox">
	                    ...
	                    <label for="<%=fileFullGrp %>MainYN1">대표이미지</label>
	              		...
	              		<button class="addImageBtn b_btn_00201" type="button" onclick="addRowFile('<%=fileFullGrp%>');"><img src="/img/board/btn_plus.gif" alt="첨부파일 추가 버튼" /></button>
						<button class="delImageBtn b_btn_00201" type="button" onclick="delRowFile('<%=fileFullGrp%>');"><img src="/img/board/btn_del.gif" alt="첨부파일 삭제 버튼" /></button>
