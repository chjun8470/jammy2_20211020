...
<div class="b_btn_listBox005">
	<button type="button" class="b_btn_block005" onclick="goSubmit('list','image')"><img src="/img/board/btn_block_ovr.png" alt="이미지리스트" /></button>
			...
			<li style="margin-right:18px;">
					<div class="info_agency">
						<div class="logo_agency">
							...
							<%}else{%>
								<img src = "/file/<%=fileGrp+"/"+rs.get("TITLE")%>" alt="이미지<%=cont%>"/>
							<%}%>
							</p>
						</div>
