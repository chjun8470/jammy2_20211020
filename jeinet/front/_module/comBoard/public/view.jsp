...
<div class="b_ContBox">
	...
	%>
		...
		<div class="PubimgBox" style="margin-top:30px;"><iframe src = "/file/<%=fileGrp+"/"+dataMap.get("TITLE")%>" title="PDF 자료" width="100%" height="562px" scrolling="yes" ></iframe></div>
			<p class="TxtPubView2">
...
<!--b_btn_area E--><!--Contents E--><!--ContWrap E--><!--SubBox E--><!--SubWrap E-->
		...
		<div>
			...
			<table class="dsc_btm_edt_box" style="width:100%;">
				<colgroup>
					<col width="10%" />
					<col width="10%" />
					<col width="15%" />
		...
		<%if(util.getStr(boardMap.get("PERM_CMT")).equals("Y")) { %>
				...
				<button type="button" id="inpCmt" class="btn_rgt2 color_box_btn_2 btn_rgt_new_cnci">등록</button>
