			...
			<tbody>
				...
				%>
						...
						<div style="display: inline-block;">
							<div>
								<input class="fileimg_box_1" type="file" name="<%=fileFullGrp%>File1" id="<%=fileFullGrp%>File1" style="height:37px;" title="파일첨부" />
							</div>
						</div>
				...
				%>
						...
						<div style="display: inline-block;">
							<div>
								<input class="filepdf_box_1" type="file" name="<%=fileFullGrp%>File2" id="<%=fileFullGrp%>File2" style="height:37px;" title="파일첨부" />
							</div>
						</div>
	            ...
	            <% }else{ %>
						<div style="display: inline-block;" id="<%=fileFullGrp%>fileGrpBox">
							<div>
								<input class="filepdf_box_1" type="file" name="<%=fileFullGrp%>File1" id="<%=fileFullGrp%>File1" style="height:26px;" title="파일첨부" />
							</div>
						</div>
						<div style="display: inline-block;" id="<%=fileFullGrp%>fileGrpBox">
							<div>
								<input type="file" class="filepdf_box_1" name="<%=fileFullGrp%>File2" id="<%=fileFullGrp%>File2" style="height:26px;" title="파일첨부" />
							</div>
						</div>
