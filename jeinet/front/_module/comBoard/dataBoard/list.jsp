			...
			<div class="basic_grid basic_grid2">
        		...
        		<div class="list_top_1 margin_left_20px">
                	<div class="b_srchBox_1 ">
                    	<div class="b_srchBox_1_du">자료구분 :&nbsp;</div>
                        <select class="b_select_1" name="searchDataType" id="searchDataType">
				...
				<div class="list_top_1">
                	<div class="b_srchBox_1" style="width: auto;">
						<div style="margin: 0px 0px 0px 20px; height: 35px; line-height: 35px; float: left;">검색구분 :&nbsp;</div>
                        ...
                        <div class="b_srch">
                           	<input type="text" class="b_srch_txt" name="searchWord" title="검색단어입력" id="searchWord" value="<%=util.getStr(paramMap.get("searchWord"))%>" style="width:97%;"/>
                        </div>
						<!-- 검색버튼 -->
						<div class="b_srch_dn">
