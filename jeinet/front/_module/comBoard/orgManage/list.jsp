...
%>
	...
	<div class="list_top006">
		...
		<div class="b_srchBox006">
			...
			<div class="b_srch006">
				<!-- 키워드 -->
				<input class="b_srch_txt006" type="text" name="searchWord" id="searchWord" value="<%=util.getStr(paramMap.get("searchWord"))%>" placeholder="이름을 입력하세요" />
				<!-- 검색버튼 -->
				<input type="image" class="b_go_btn006" value="검색" src="/img/board/btn_ico_srch.png" onclick="goSubmit('list')" />
			</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="r_line_none file">
								<a href="./sub.do?m=<%=m%>&amp;mode=view&amp;listMode=list&amp;orgSearchWord=<%=orgSearchWord%>&amp;searchWord=<%=searchWord%>&amp;orgGrpCd=<%=orgGrpCd%>&amp;boardIdx=<%=util.getStr(rs.get("ARTICLE_ID"))%>"><img src="/img/cont/ico_mid02_tab02.png" alt="담당자보기" /></a>
						</td>
					</tr>
					<% cont--; } %>
				</tbody>
