              ...
              <table class="skin_basic_write">
                    ...
                    <tbody>
	                   ...
	                   <tr>
	                          ...
	                          <td>
	                          		<input type="radio" name="data06" value="남자" checked="checked" id="genderTypeCdMale" style="width:20px;"><label for="genderTypeCdMale">남자</label>
									<input type="radio" name="data06" value="여자" id="genderTypeCdFemale" style="width:20px;"><label for="genderTypeCdFemale">여자</label>
							  </td>
	                   </tr>
	                   <tr>
	                          <th scope="row" class="tit">
