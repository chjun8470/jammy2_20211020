...
<h2 class="menu-title">Excel Upload</h2>
<hr/>
	<div class="search-box" style="margin-top: 10px;">
		<fieldset class="dhx_fs" style="padding-right:10px">
		<div style ="float:left">
		<form name="uploadForm" action="/sys/registration.do" method="post" onSubmit="return false;" encType="multipart/form-data">
			<input type="hidden" name="mode" id="mode" value="<%=mode%>" />
			<input type="hidden" name="list_mode" id="list_mode" value="orgManage" />
		...
		<div style="float: right">
			...
			<input type="button" class="btn_inp_b_01" onclick ="location.href='./getPatentTemPlateFile.do?list_mode=orgManage'" value="입력양식다운로드" title="입력양식다운로드">
		</div>
		</fieldset>
	</div>
<br />
...
<div align="right">
	<input type="button" class="btn_inp_w_01" onclick ="location.href='./sys_jip_registration.do'" value="목록" title="목록">
</div>
