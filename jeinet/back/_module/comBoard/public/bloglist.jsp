	...
	<form action="?<%=myPage%>" name="searchForm" id="searchForm" method="post" class="boardSearch">
		...
		<div class="publist_top_wrap">
			...
			<div class="b_btn_listBox">
				<button type="button" class="b_btn_block" id="cont_block" onclick="goSubmit('list','imagelist','<%=sortMode%>')"><img src="/img/board/btn_block.png" alt="블럭형"></button>
				<button type="button" class="b_btn_blog" id="cont_blog" onclick="goSubmit('list','bloglist','<%=sortMode%>')"><img src="/img/board/btn_blog_ovr.png" alt="블로그형" /> </button>
			</div>
		</div>
	</form>
</div>
