	...
	<div class="skin_bbs_write" style="margin-top: 30px">
			...
			<tbody>
                ...
                <%--
              	...
              	<tr>
	            	<th scope="row">
                      	<span style="color:red; font-size:11pt;">* </span><label for="subject">자료구분</label>
                    </th>
					<td>
						<select name="dataType" id="dataType" class="select_box">
				...
				<tr>
					...
					<td>
						<input type="text" class="inp_txt" name="subject" id="subject" value="<%=util.getStr(dataMap.get("SUBJECT"))%>" style="width: 820px; font-size:10pt;" maxlength="100" />
