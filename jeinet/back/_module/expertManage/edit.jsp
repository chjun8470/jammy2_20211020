                     ...
                     <tbody>
                           	...
                           	<tr>
                           		...
                           		<td>
                           			...
                           			<%}else{ %>
                           				<input type="text" name="birthDate" id="birthDate"  value="<%=util.getStr(dataMap.get("BIRTH_DATE")) %>" class="inp_txt" style="border:0px;" readonly>
                           			<%} %>
                           		</td>
			                ...
			                <tr>
			                	<th scope="row" class="tit">* 승인요청</th>
			                	<td colspan="3">
			                		<select  class="select_box" name="proState" id="proState" >
			                			...
			                			<option value="20" <%=(util.getStr(dataMap.get("PRO_STATE"))).equals("승인")? "selected='selected'" : "" %>>승인</option>
			                			<option value="30" <%=(util.getStr(dataMap.get("PRO_STATE"))).equals("반려")? "selected='selected'" : "" %>>반려</option>
			                		</select>
			                	</td>
			            	</tr>
			            	<tr>
...
<!-- 경력정보 S -->
		...
		<%if(listCR.size()>0){ %>
        	...
        	<tr id="career_info<%=crCnt%>" onclick="setLicenseBtn(<%=scCnt%>, 'career')">
				...
				<td><input type="text" name="crStart" id="crStart<%=crCnt%>" value="<%=util.getStr(rs.get("CR_START"))%>" style="width:100%;" class="inp_txt"></td>
				<td><input type="text" name="crFinish" id="crFinish<%=crCnt%>" value="<%=util.getStr(rs.get("CR_FINISH"))%>" style="width:100%;" class="inp_txt"></td>
			...
			<tr id="career_info<%=crCnt%>">
				...
				<td><input type="text" name="crStart" id="crStart<%=crCnt%>" style="width:100%;" class="inp_txt"></td>
				<td><input type="text" name="crFinish" id="crFinish<%=crCnt%>" style="width:100%;" class="inp_txt"></td>
...
<!-- 자격사항 E -->
              ...
              <div class="btn_right_box" style="text-align: right; width: 980px;">
                     <input type="button" class="btn_inp_b_01" value="수정하기" onclick="goCheck('editProc')"/>
