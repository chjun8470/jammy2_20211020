		...
		<table id="step1"  class="skin_basic_write">
			...
			<tbody>
				...
				<tr>
					<th scope="col">담당자</th>
					<td scope="col">
						<%=util.getStr(dataMap.get("EQU_USER_NM")) %>
					</td>
					<th scope="col">직위</th>
					<td scope="col">
						<%=util.getStr(dataMap.get("EQU_USER_POSITION")) %>
					</td>
				</tr>
				<tr>
					<th scope="col">전화번호</th>
					<td scope="col">
						<%=util.getStr(dataMap.get("EQU_USER_PHONE")) %>
					</td>
					<th scope="col">이메일</th>
					<td scope="col">
						<%=util.getStr(dataMap.get("EQU_USER_EMAIL")) %>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						...
						<%=util.getStr(dataMap.get("START_TIME")) %>시  ~
						<%=util.getStr(String.valueOf(dataMap.get("END_DT"))) %>
						<%=util.getStr(dataMap.get("END_TIME")) %>시
					</td>
				</tr>
				<tr>
