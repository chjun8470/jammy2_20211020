					...
					<tr>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="OwnOrgNm" id="utilityOwnOrg" value="" style="width: 70%; font-size:10pt; " maxlength="100" readonly="readonly"/>
						...
						<tr>
							...
							<td colspan="3">
								...
								<select class="p_select" name="utilitysearchArea" id="utilitysearchArea2" style="display:none;">
									<option value="">선택하세요</option>
									<%
