	...
	<div class="bbs-top">
				...
				<div class="search_box" style="padding:10px">
					...
					<select id="searchType" name="searchType">
						<option value="NAME" <%if("NAME".equals(searchType)) {%>selected="selected"<%} %>>기관명</option>
						<option value="ID" <%if("ID".equals(searchType)) {%>selected="selected"<%} %>>기관코드</option>
					</select>
	...
	<div class="contents_box">
		...
		<table class="skin_basic_list">
			...
			for(HashMap rs:dataList) {%>
				<tr>
					<td><%=cont%></td>
					<td><%=util.getStr(rs.get("ORG_GRP_CD"))%></td>
