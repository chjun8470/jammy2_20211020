					...
					<table id="step1" class="skin_basic_write">
						...
						<tr>
							...
							<td class="top_sell brn">
								<input type="text" class="inp_text" maxlength="20" style="width:300px" name="eduNm" id="eduNm"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="top_sell brn" colspan="3">
								<input type="text" class="inp_text" name="eduAuspicesNm" id="eduAuspicesNm"/>
							</td>
						</tr>
						<tr>
							...
							<td class="top_sell brn">
							<%if(loginVO.getAuthLv().equals("99")){ %>
							<input type="hidden" name="orgGrpCd" id="orgGrpCd" value=""/>
							<input type="text" class="inp_text" maxlength="20" name="orgGrpNm" id="orgGrpNm" value="" readonly="readonly"/>
						...
						<tr>
							...
							<td class="top_sell brn">
								<input type="text" class="inp_text" maxlength="50" id="eduPlace" name="eduPlace" readonly="readonly" value="<%=util.getStr(dataMap.get("ADDR1"))%>" style="width:300px"/>
								<input type="button" id="eduPostButton" value="찾아보기" class="btn_inp_b_01" onclick="eduPost()">
								<br/>
								<input type="text" class="inp_text" maxlength="100" class="inputBox_2" id="eduPlaceDetail" name="eduPlaceDetail" value="<%=util.getStr(dataMap.get("ADDR2"))%>" style="width:400px"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="top_sell brn">
							<input type="text" class="inp_text" maxlength="20" id="eduPeople" name="eduPeople" />명
							</td>
						</tr>
						<tr>
							<th scope="col" class="top_sell bln"><label for="eduUseFlag1">사용여부</label></th>
							<td class="top_sell brn">
							<label><input type="radio" name="eduUseFlag" id="eduUseFlag1" value="10"/>사용</label>
							<label><input type="radio" name="eduUseFlag" id="eduUseFlag2" value="20"/>미사용</label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<input type="button" name="operData" id="operData" class="btn_inp_b_01" value="회원정보 조회" onclick="popupWindow('orgUserPop')">
							<table class="skin_basic_write">
									<tr>
						...
						<tr>
							...
							<td class="top_sell brn">
							<label><input type="radio" name="eduFreeYn" id="eduFreeYn1" value="Y"> 무료</label>
							<label><input type="radio" name="eduFreeYn" id="eduFreeYn2" value="N"> 유료</label>

							<span id="eduPayBox" style="display:none">
								<input type="text" class="inp_text" maxlength="20" name="eduPay" id="eduPay"/>원
							</span>
							</td>
						</tr>
						<tr>
							...
							<td class="top_sell brn">
							<label><input type="radio" name="eduInsurance" id="eduInsurance1" value="Y" >적용</label>
						...
						<tr>
							...
							<td class="top_sell brn">
							<input type="text" class="inp_text" maxlength="20" id="eduTel" name="eduTel"/>
							<br/>
							ex) 010-000-0000
							</td>
						</tr>
						<tr>
							...
							<td class="top_sell brn">
							<textarea cols="50" rows="4" maxlength="500" name="eduTarget" id="eduTarget"></textarea>
							</td>
						</tr>
						<tr>
							<th scope="col" class="top_sell bln"><label for="eduContent">교육내용</label></th>
							<td class="top_sell brn">
							<textarea cols="50" rows="4" maxlength="500" name="eduContent" id="eduContent"></textarea>
							</td>
						</tr>
						<!-- <tr>
