			...
			<h3>[연구장비 상세정보]</h3>
				<table id="step1" summary="연구장비의 상세정보입력" class="skin_basic_write">
						...
						<tr>
							...
							<td>
								&nbsp;&nbsp;전라남도 <input type="radio" name="utilityArea" id="utilityArea1" value="1"  checked="checked" onclick="radio_area('utilitysearchArea','1')"/>
								&nbsp;&nbsp;전라남도 외 지역 <input type="radio" name="utilityArea" id="utilityArea2" value="2"  onclick="radio_area('utilitysearchArea','2')"/>&nbsp;&nbsp;
								<select class="p_select" name="area" id="utilitysearchArea1">
									<option value="">선택하세요</option>
									<%
										int utilitynumArea = 1;
										for(HashMap rs:areaSigunguList) {
										%>
									<option <%if(util.getStr(dataMap.get("AREA")).equals(util.getStr(rs.get("CODE_CD")))) { %>selected <% } %>
