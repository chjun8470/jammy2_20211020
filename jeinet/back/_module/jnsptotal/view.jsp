	...
	<div class="clear_wrap">
		...
		<table id="step1" summary="연구장비의 상세정보입력" class="skin_basic_write">
			...
			<tbody>
	            ...
	            <%--
	            	<tr>
	                	<th scope="row" class="top_sell bln"><label for="">R&D과제정보</label></th>
	                	<td class="top_sell brn">협의중</td>
	                </tr>
				   	<tr>
				...
				<tr class="equipRegistOption" id="equipMainDetail" title="주장비 추가등록 옵션" >
				  ...
				  <tr class="equipRegistOption" id="equipMain" >
					...
					<td class="brn">
						<%=util.getStr(dataMap.get("EQCP_NM"))%>(<%=util.getStr(dataMap.get("EQCP_ID"))%>)
					</td>
				  </tr>
				  --%>
	            ...
	            <tr>
	                ...
	                <td <% if(!util.getStr(equGoodsDataMapCopy.get("AREA_SIGUNGU")).equals(util.getStr(equGoodsDataMapCopy.get("UP_AREA_SIGUNGU"))) && !equGoodsDataMapCopy.equals(null)){out.println("class='txt_red'");}else{out.println("class='top_sell bln'");} %>>
		             	<%=util.getStr(equGoodsDataMap.get("AREA_SIGUNGU"))%>
	                </td>
	            </tr>
		          <tr>
	    ...
	    <table summary="연구장비의 상세정보" class="skin_basic_write">
		    ...
		    <colgroup>
		   	...
		   	<tbody>
	            ...
	            <tr>
	            	<th scope="row" class="top_sell bln">장비문의연락처</th>
	            ...
	            <tr>
	            	<th scope="row" class="top_sell bln">장비주소</th>
