			...
			<h3>[연구장비 상세정보]</h3>
				<table id="step1" summary="연구장비의 상세정보입력" class="skin_basic_write">
                		...
                		<tr <%=!util.getStr(dataMap.get("TAKE_CD")).equals("1") ? "style='display:none'":""%> id="warrantyTR">
                			...
                			<td>
                				<input class="inp_txt" type="text" id="equipWarranty" name="equipWarranty" value="<%=util.getStr(dataMap.get("EQUIP_WARRANTY"))%>" maxlength="3"/> 년
                			</td>
                		</tr>
						<tr id="trTakeDt">
							<th scope="row">
						...
						<tr>
							...
							<td>
								...
								<select class="p_select" name="areaSigungu" id="utilitysearchArea1" <%if(util.getStr(dataMap.get("AREA")).equals( "2" )) { %>style="display:none;" <% } %> >
								...
								<select class="p_select" name="areaSigungu" id="utilitysearchArea2" <%if(util.getStr(dataMap.get("AREA")).equals( "1" )) { %>style="display:none;" <% } %> >
									<option value="">선택하세요</option>
									<%
	                	...
	                	<tr>
                			...
                			<td>
                				<input class="inp_txt" type="text" value="<%=util.getStr(dataMap.get("LOCATION")) %>" name = "location" id="location" style="width:280px;" maxlength="50"/>
                				...
                				<input type="button" class="btn_inp_w_01" value="기관정보 불러오기" onclick="callDeptInfo('org')"/>
						...
						<tr>
							...
							<td >
								...
								<input class="inp_txt" type="text" name="ownOrgNm" id="orgNm" style="width:30%;" maxlength="20" value="<%=util.getStr(equGoodsDataMap.get("OWN_ORG_NM"))%>" onkeydown='$("#orgGrpCd").val("")'/>
						...
						<tr>
							...
							<td>
								...
								<input class="inp_txt" type="text" name="ownOrgSubNm" id="orgSubNm" style="width:30%;" value="<%=util.getStr(equGoodsDataMap.get("OWN_ORG_SUB_NM"))%>"  maxlength="20" onkeydown='$("#orgSubGrpCd").val("")'/>
                			...
                			<td>
	                			...
	                			<table class="skin_basic_write">
	                				<tr>
	                					...
	                					<td style="width:200px;">
	                						<input class="inp_txt" type="text" name="operOrgGrpSub" id="operOrgGrpSub" value="<%=util.getStr(dataMap.get("OPER_ORG_GRP_SUB")) %>" style="border-width:0px; width:200px;" readonly>
	                					</td>
	                				</tr>
	                				<tr>
                ...
                <table summary="연구장비의 상세정보입력" class="skin_basic_write">
						...
						<!-- 주소등록 -->
						<tr>
							<th scope="row"><label for="refEquTel" id="refEquTelLB"> * 장비주소</label></th>
							<td colspan="3">
