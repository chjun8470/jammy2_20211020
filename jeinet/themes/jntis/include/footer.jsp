...
<li><a href="http://jeinet.jnsp.re.kr/file/02.JNTISManual(user) - ver 0.3.pdf">매뉴얼 다운로드</a></li>
<li class="end"><a href="javascript:snsFaceBook()"><img src="/img/common/icon_sns01.png" alt="페이스북 바로가기"/></a></li>
</ul>
</div>
<div class="f_qr">
<img src="/img/jntis/common/f_qr.jpg" alt="QR코드" />
</div>
<div class="f_site">
<ul>
<li>
...
<div class="f_info">
<div class="f_info1">전라남도 영암군 삼호읍 대불주거3로 55 (526-897)</div>
<div class="f_info2">
