...
public void jspInit() {
	...
	sql_a.append("       , CONCAT (B.SIGN_IMG,B.ORG_STAMP_FILE) AS FILE_SRC ");
	sql_a.append("       , G.ORG_GRP_NM ");
	sql_a.append("       , B.CERTI_ORG ");
	sql_a.append("       , B.CERTI_DIRECTOR ");
	sql_a.append("       , CONCAT(DATE_FORMAT(now(),'%Y'),'-',cast(B.EDU_ID as char(50)),cast(A.EDU_RESV_ID as char(50))) AS SN ");
	sql_a.append("       , CONCAT(DATE_FORMAT(NOW(),'%Y'),'년  ',DATE_FORMAT(NOW(),'%m'),'월  ',DATE_FORMAT(NOW(),'%d'),'일  ') AS nnn ");
	sql_a.append("		 , CONCAT(CONCAT(B.EDU_ST_DT,' ~ ',B.EDU_ED_DT),' (',cast(B.EDU_TOTAL_TIME as char(50)),' 시간) ') AS EDU ");
	sql_a.append(" ");
	...
	sql_a.append("WHERE A.EDU_RESV_ID = '^resvid^' ");
	sql_a.append("AND A.RESV_STATE = '^state^' ");
	sql_a.append("AND A.EDU_ID = '^eduId^' ");
...
class ReportHandler{
	...
	private void executeSheet10( ) throws Exception{
		//쉬트 초기화 함수 호출
		getSheetPaperInfo("User Define", "2300x3170", "256", "VERTICAL", "56 70 56 70");
		initSheetVariant(68, 82, 585, 817, true);
		...
		getScriptFromview44(true, true);    //Void 밴드 호출
	...
	private void getScriptFromveiw(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet10_B3="수    료    증";
			sheet10_B10="소         속 :";
			sheet10_G10 = a_ORG_GRP_NM;
			sheet10_B11="성         명 :";
			sheet10_G11 = a_PSN_NM;
			sheet10_B12="교   육   명 :";
			sheet10_G12 = a_EDU_NM;
			sheet10_B13="교 육 기 간 :";
			sheet10_G13 = a_EDU;
			sheet10_B16="    위 사람은 상기과정을 성실히 수료\n 하였으므로 이 증서를 수여합니다.";
			sheet10_B22 = a_nnn;
			sheet10_D26 = a_CERTI_ORG;
			sheet10_B28 = a_CERTI_DIRECTOR;
			AI_BOX_OBJ1 = String.valueOf(a_CI_FILE_SRC);
		}    //end if(bIsFirst)
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromview44(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	private void writeScriptveiw( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_D26"), nYCurPos+mapTop.get("sheet10_D26"), mapWidth.get("sheet10_D26"), mapHeight.get("sheet10_D26"), sheet10_D26, "sheet10_D26", mapStyle.get("sheet10_D26"));
		...
		objectWrite(DRAW_OBJECT, nXCurPos+352, nYCurPos+568, 85, 79, AI_BOX_OBJ1, "AI_BOX_OBJ1", "draw_style_2");
		if(true)
		{
			propertyWrite(DRAW_OBJECT, "AI_BOX_OBJ1", "imageZIndex", "-7");
		}
	}
	...
	private void getBgImageScriptEx(int nIndex) throws Exception{
		switch(nIndex){
			...
			objectWrite(DRAW_OBJECT, 68, 82, 515, 732, "", "AI_IMAGE_OBJ6", "draw_style_0");
			objectWrite(DRAW_OBJECT, 127, 396, 373, 174, "", "AI_IMAGE_OBJ9", "draw_style_1");
			break;
		}
	}
	...
	private void setFieldVariableFroma() throws Exception{
		...
		a_FILE_SRC = GetB(a.getString(10));
		a_ORG_GRP_NM = GetB(a.getString(11));
		a_CERTI_ORG = GetB(a.getString(12));
		a_CERTI_DIRECTOR = GetB(a.getString(13));
		a_SN = GetB(a.getString(14));
		a_nnn = GetB(a.getString(15));
		a_EDU = GetB(a.getString(16));
	}
	...
	private List<Object> getAIRowDataFroma() throws Exception{
		...
		row.add(a.getObject(13));
		row.add(a.getObject(14));
		row.add(a.getObject(15));
		row.add(a.getObject(16));
	...
	private void setParam() {
		...
		resvid_Param=decoder.getParameterB("resvid");
		//resvid_Param=aiReplace(resvid_Param, str, "\n");
		mapParam.put("resvid", resvid_Param);

		state_Param=decoder.getParameterB("state");
		//state_Param=aiReplace(state_Param, str, "\n");
		mapParam.put("state", state_Param);

		eduId_Param=decoder.getParameterB("eduId");
		//eduId_Param=aiReplace(eduId_Param, str, "\n");
		mapParam.put("eduId", eduId_Param);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B10", 39, 202, 90, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G10", 129, 202, 346, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_B11", 39, 226, 90, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G11", 129, 226, 346, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_B12", 39, 250, 90, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G12", 129, 250, 346, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_B13", 39, 274, 90, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G13", 129, 274, 18, 24, "cell_style_2");
		setCellInfoMap_Internal("sheet10_B16", 39, 338, 436, 100, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B2", 39, 33, 436, 29, "cell_style_0");
		setCellInfoMap_Internal("sheet10_B22", 39, 458, 436, 40, "cell_style_4");
		setCellInfoMap_Internal("sheet10_D26", 75, 538, 400, 40, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B28", 39, 578, 436, 60, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B3", 39, 62, 436, 120, "cell_style_1");
	}
