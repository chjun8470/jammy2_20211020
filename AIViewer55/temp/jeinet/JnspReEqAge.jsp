...
public void jspInit() {
	...
	sql_a.append("ORDER BY CNT DESC ");
	...
	//sql_aa
	StringBuilder sql_aa = new StringBuilder();
	sql_aa.setLength(0);
	sql_aa.append("SELECT ");
	sql_aa.append("	AA.ORG_GRP_NM AS AREA , ");
	sql_aa.append("	AA.SM, ");
	sql_aa.append("	AA.EQUIP, ");
	sql_aa.append("	SUM(AA.EQU_CNT) AS CNT ");
	sql_aa.append("	FROM ");
	sql_aa.append("	( ");
	sql_aa.append("		SELECT ");
	sql_aa.append("			A.ORG_GRP_NM, ");
	sql_aa.append("			SUM(B.TAKE_PRC) AS SM, ");
	sql_aa.append("			( ");
	sql_aa.append("				SELECT COUNT(0) FROM TB_EQU_INFO AS AAA ");
	sql_aa.append("				WHERE AAA.RND_MAIN_ORG = A.ORG_GRP_NM ");
	sql_aa.append("				AND AAA.EQUIP_CD = 2 ");
	sql_aa.append("			)AS EQUIP, ");
	sql_aa.append("		( ");
	sql_aa.append("			SELECT ");
	sql_aa.append("				COUNT(0) ");
	sql_aa.append("			FROM ");
	sql_aa.append("				TB_EQU_INFO ");
	sql_aa.append("			WHERE TB_EQU_INFO.USER_IDX IN ");
	sql_aa.append("						( ");
	sql_aa.append("							SELECT ");
	sql_aa.append("								USER_IDX ");
	sql_aa.append("							FROM ");
	sql_aa.append("								TB_USER_COPY ");
	sql_aa.append("							WHERE TB_USER_COPY.ORG_GRP_CD = A.ORG_GRP_CD ");
	sql_aa.append("						) ");
	sql_aa.append("		) AS EQU_CNT ");
	sql_aa.append("	FROM TB_ORG_GRP AS A ");
	sql_aa.append("	LEFT JOIN TB_EQU_INFO AS B ");
	sql_aa.append("		ON A.ORG_GRP_NM = B.RND_MAIN_ORG ");
	sql_aa.append("	LEFT JOIN TB_USER_COPY AS C ");
	sql_aa.append("		ON A.USER_IDX = C.USER_IDX ");
	sql_aa.append("	WHERE A.AREA_CD = 1 ");
	sql_aa.append("	GROUP BY A.ORG_GRP_NM ");
	sql_aa.append("	) AS AA ");
	sql_aa.append("	WHERE 1=1 ");
	sql_aa.append("GROUP BY AA.ORG_GRP_NM ");
	sql_aa.append("ORDER BY CNT DESC ");
	sql_aa.append("LIMIT 10 ");
	initializer.prepareQuery("sql_aa", sql_aa.toString());

	//sql_getJnspReEqAre
	StringBuilder sql_getJnspReEqAre = new StringBuilder();
	sql_getJnspReEqAre.setLength(0);
	sql_getJnspReEqAre.append("SELECT ");
	sql_getJnspReEqAre.append("				A.ORG_GRP_NM AS AREA, ");
	...
	sql_getJnspReEqAreTt.append("				A.ORG_GRP_NM AS AREA, ");
	...
	//sql_getJnspReEqAgeTb
	StringBuilder sql_getJnspReEqAgeTb = new StringBuilder();
	sql_getJnspReEqAgeTb.setLength(0);
	sql_getJnspReEqAgeTb.append("SELECT ");
	sql_getJnspReEqAgeTb.append("				A.ORG_GRP_NM AS AREA, ");
	sql_getJnspReEqAgeTb.append("				A.ORG_GRP_CD, ");
	sql_getJnspReEqAgeTb.append("				( ");
	sql_getJnspReEqAgeTb.append("					SELECT COUNT(0) FROM TB_EQU_INFO AS B1 ");
	sql_getJnspReEqAgeTb.append("					LEFT JOIN TB_EQU_GOODS AS C1 ");
	sql_getJnspReEqAgeTb.append("					ON B1.RND_EQU_IDX  = C1.RND_EQU_IDX ");
	sql_getJnspReEqAgeTb.append("					WHERE A.ORG_GRP_CD = C1.OWN_ORG ");
	sql_getJnspReEqAgeTb.append("					AND B1.STATE = '2' ");
	sql_getJnspReEqAgeTb.append("					AND B1.EQUIP_CD = '1' ");
	sql_getJnspReEqAgeTb.append("					AND (B1.DELETE_YN != 'Y' OR B1.DELETE_YN IS NULL) ");
	sql_getJnspReEqAgeTb.append("				)AS CNT, ");
	sql_getJnspReEqAgeTb.append("				( ");
	sql_getJnspReEqAgeTb.append("					SELECT SUM(B1.TAKE_PRC) FROM TB_EQU_INFO AS B1 ");
	sql_getJnspReEqAgeTb.append("					LEFT JOIN TB_EQU_GOODS AS C1 ");
	sql_getJnspReEqAgeTb.append("					ON B1.RND_EQU_IDX  = C1.RND_EQU_IDX ");
	sql_getJnspReEqAgeTb.append("					WHERE A.ORG_GRP_CD = C1.OWN_ORG ");
	sql_getJnspReEqAgeTb.append("					AND B1.STATE = '2' ");
	sql_getJnspReEqAgeTb.append("					AND B1.EQUIP_CD = '1' ");
	sql_getJnspReEqAgeTb.append("					AND (B1.DELETE_YN != 'Y' OR B1.DELETE_YN IS NULL) ");
	sql_getJnspReEqAgeTb.append("				)AS SM ");
	sql_getJnspReEqAgeTb.append(" ");
	sql_getJnspReEqAgeTb.append("			FROM TB_ORG_GRP AS A ");
	sql_getJnspReEqAgeTb.append("			WHERE 1 = 1 ");
	sql_getJnspReEqAgeTb.append("			AND (A.DELETE_YN != 'Y' OR A.DELETE_YN IS NULL) ");
	sql_getJnspReEqAgeTb.append("			AND A.APPLY_CD = '20' ");
	sql_getJnspReEqAgeTb.append("			AND A.ORG_TYPE = '2' ");
	sql_getJnspReEqAgeTb.append("	ORDER BY CNT DESC ");
	initializer.prepareQuery("sql_getJnspReEqAgeTb", sql_getJnspReEqAgeTb.toString());
}
...
class ReportHandler{
	...
	private java.sql.PreparedStatement stat_aa;		//ResultSet aa 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet aa;		//ResultSet aa 객체
	...
	private java.sql.PreparedStatement stat_getJnspReEqAgeTb;		//ResultSet getJnspReEqAgeTb 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet getJnspReEqAgeTb;		//ResultSet getJnspReEqAgeTb 객체
	...
	private StringBuilder sql_aa = new StringBuilder();		//ResultSet aa 객체를 생성하기 위한 쿼리문 저장
	...
	private StringBuilder sql_getJnspReEqAgeTb = new StringBuilder();		//ResultSet getJnspReEqAgeTb 객체를 생성하기 위한 쿼리문 저장
	...
	//ResultSet aa 객체에서 필드 값을 받는 쿼리 필드 변수
	private String aa_AREA;
	private double aa_SM;
	private long aa_EQUIP;
	private long aa_CNT;
	...
	//ResultSet getJnspReEqAgeTb 객체에서 필드 값을 받는 쿼리 필드 변수
	private String getJnspReEqAgeTb_AREA;
	private String getJnspReEqAgeTb_ORG_GRP_CD;
	private long getJnspReEqAgeTb_CNT;
	private double getJnspReEqAgeTb_SM;
	...
	private void executeSheet10( ) throws Exception{
		...
		getScriptFromrrrr(true, true);    //Void 밴드 호출
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		//DataSet 객체 생성
		//ResultSet getJnspReEqAgeTb 객체의 생성
		if(getJnspReEqAgeTb==null){
			getJnspReEqAgeTb = stat_getJnspReEqAgeTb.executeQuery();
		}else{
			getJnspReEqAgeTb.beforeFirst();
		}
		...
		//--while Loop Start--##
		while(getJnspReEqAgeTb.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromgetJnspReEqAgeTb();	//RecordSet getJnspReEqAgeTb에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet10_B21 = getJnspReEqAgeTb_AREA;
			sheet10_J21 = getJnspReEqAgeTb_CNT;
			sheet10_R21 = getJnspReEqAgeTb_SM;
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromrrrr(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=20;    //밴드 출력 높이
	...
	private void writeScripttest( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_J20"), nYCurPos+mapTop.get("sheet10_J20"), mapWidth.get("sheet10_J20"), mapHeight.get("sheet10_J20"), sheet10_J20, "sheet10_J20", mapStyle.get("sheet10_J20"));
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+28, 726, 322, AI_CHART_OBJ32, "AI_CHART_OBJ32", "draw_style_0");
	}
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_J21"), nYCurPos+mapTop.get("sheet10_J21"), mapWidth.get("sheet10_J21"), mapHeight.get("sheet10_J21"), String.valueOf(sheet10_J21), "sheet10_J21", mapStyle.get("sheet10_J21"));
	...
	//----rrrr 스크립트 문 출력 함수----
	private void writeScriptrrrr( ) throws Exception{
		//스크립트문 생성
	...
	private void initSQLConst() throws Exception {
		...
		stat_aa = initializer.configPreparedStatement("sql_aa", mapParam, conn_jnsp, null);
		...
		stat_getJnspReEqAgeTb = initializer.configPreparedStatement("sql_getJnspReEqAgeTb", mapParam, conn_jnsp, null);
	}
	...
	//ResultSet aa 객체에서 필드 값 설정 함수
	private void setFieldVariableFromaa() throws Exception{
		aa_AREA = GetB(aa.getString(1));
		aa_SM = aa.getDouble(2);
		aa_EQUIP = aa.getLong(3);
		aa_CNT = aa.getLong(4);
	}

	//ResultSet aa 객체의 필드 값 초기화 함수
	private void setFieldInitFromaa(){
		aa_AREA = "";
		aa_SM = 0;
		aa_EQUIP = 0L;
		aa_CNT = 0L;
	...
	//ResultSet aa 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromaa() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(aa.getObject(1));
		row.add(aa.getDouble(2));
		row.add(aa.getLong(3));
		row.add(aa.getLong(4));
	...
	private void setFieldVariableFromgetJnspReEqAre() throws Exception{
		getJnspReEqAre_AREA = GetB(getJnspReEqAre.getString(1));
		getJnspReEqAre_ORG_GRP_CD = GetB(getJnspReEqAre.getString(2));
		getJnspReEqAre_CNT = getJnspReEqAre.getLong(3);
		getJnspReEqAre_SM = getJnspReEqAre.getDouble(4);
	}
	...
	private List<Object> getAIRowDataFromgetJnspReEqAre() throws Exception{
		...
		row.add(getJnspReEqAre.getLong(3));
		row.add(getJnspReEqAre.getDouble(4));
	...
	private void setFieldVariableFromgetJnspReEqAreTt() throws Exception{
		getJnspReEqAreTt_AREA = GetB(getJnspReEqAreTt.getString(1));
		getJnspReEqAreTt_ORG_GRP_CD = GetB(getJnspReEqAreTt.getString(2));
		getJnspReEqAreTt_CNT = getJnspReEqAreTt.getLong(3);
		getJnspReEqAreTt_SM = getJnspReEqAreTt.getDouble(4);
	}
	...
	private List<Object> getAIRowDataFromgetJnspReEqAreTt() throws Exception{
		...
		row.add(getJnspReEqAreTt.getLong(3));
		row.add(getJnspReEqAreTt.getDouble(4));

		return row;
	}

	//ResultSet getJnspReEqAgeTb 객체에서 필드 값 설정 함수
	private void setFieldVariableFromgetJnspReEqAgeTb() throws Exception{
		getJnspReEqAgeTb_AREA = GetB(getJnspReEqAgeTb.getString(1));
		getJnspReEqAgeTb_ORG_GRP_CD = GetB(getJnspReEqAgeTb.getString(2));
		getJnspReEqAgeTb_CNT = getJnspReEqAgeTb.getLong(3);
		getJnspReEqAgeTb_SM = getJnspReEqAgeTb.getDouble(4);
	}

	//ResultSet getJnspReEqAgeTb 객체의 필드 값 초기화 함수
	private void setFieldInitFromgetJnspReEqAgeTb(){
		getJnspReEqAgeTb_AREA = "";
		getJnspReEqAgeTb_ORG_GRP_CD = "";
		getJnspReEqAgeTb_CNT = 0L;
		getJnspReEqAgeTb_SM = 0;
	}

	//ResultSet getJnspReEqAgeTb 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromgetJnspReEqAgeTb() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(getJnspReEqAgeTb.getObject(1));
		row.add(getJnspReEqAgeTb.getObject(2));
		row.add(getJnspReEqAgeTb.getLong(3));
		row.add(getJnspReEqAgeTb.getDouble(4));
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B20", 24, 372, 232, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_J20", 256, 372, 231, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_R20", 487, 372, 224, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 232, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_J21", 256, 0, 231, 20, "cell_style_8");
