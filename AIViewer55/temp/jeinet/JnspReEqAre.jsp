...
public void jspInit() {
	...
	sql_a.append("			SUM(B.TAKE_PRC) AS SM, ");
	sql_a.append("			( ");
	...
	sql_b.append("		SUM(B.TAKE_PRC) AS SM, ");
	sql_b.append("		( ");
	sql_b.append("			SELECT ");
	sql_b.append(" ");
	...
	sql_b.append("											AND B.USE_SCOPE_CD = '2' ");
	sql_b.append("										) ");
	sql_b.append("			AND (TB_EQU_INFO.DELETE_YN != 'Y' or TB_EQU_INFO.DELETE_YN IS NULL) ");
	...
	sql_b.append("AND (B.DELETE_YN != 'Y' or B.DELETE_YN IS NULL) ");
	...
	sql_c.setLength(0);
	sql_c.append("SELECT ");
	sql_c.append("	A.RND_MAIN_ORG AS AXIS , ");
	sql_c.append("	A.DEPT_NM, ");
	sql_c.append("	COUNT(0) AS CNT ");
	sql_c.append("FROM ( ");
	sql_c.append("	SELECT ");
	sql_c.append("		A.KOR_NM, ");
	sql_c.append("		A.USER_IDX, ");
	sql_c.append("		A.RND_MAIN_ORG, ");
	sql_c.append("		B.DEPT_NM, ");
	sql_c.append("		COUNT(*) AS CNT ");
	sql_c.append("	FROM ");
	sql_c.append("		TB_EQU_INFO AS A ");
	sql_c.append("	INNER JOIN TB_USER_COPY AS B ");
	sql_c.append("	ON A.USER_IDX = B.USER_IDX ");
	sql_c.append("	INNER JOIN TB_ORG_GRP AS C ");
	sql_c.append("	ON B.USER_IDX = C.USER_IDX ");
	sql_c.append("	WHERE 1=1 ");
	sql_c.append("	AND C.AREA_CD = 1 ");
	sql_c.append("	GROUP BY A.RND_MAIN_ORG ,A.USER_IDX ");
	sql_c.append("	ORDER BY CNT DESC ");
	sql_c.append(") AS A ");
	sql_c.append("GROUP BY A.RND_MAIN_ORG ");
	sql_c.append("ORDER BY CNT DESC ");
	...
	sql_d.setLength(0);
	sql_d.append("SELECT ");
	sql_d.append("	A.AREA AS AXIS, ");
	sql_d.append("	COUNT(0) AS CNT ");
	sql_d.append("FROM ( ");
	sql_d.append("SELECT ");
	sql_d.append("	SUBSTRING(A.LOCATION,4,3) AS AREA, ");
	sql_d.append("	COUNT(0) AS CNT ");
	sql_d.append("FROM ");
	sql_d.append("	TB_EQU_INFO AS A ");
	sql_d.append("INNER JOIN TB_USER_COPY AS B ");
	sql_d.append("	ON A.USER_IDX = B.USER_IDX ");
	sql_d.append("INNER JOIN TB_ORG_GRP AS C ");
	sql_d.append("	ON B.USER_IDX = C.USER_IDX ");
	sql_d.append("WHERE 1=1 ");
	sql_d.append("	AND C.AREA_CD = 1 ");
	sql_d.append("GROUP BY SUBSTRING(A.LOCATION,4,3) ,A.USER_IDX ");
	sql_d.append("ORDER BY CNT DESC ");
	sql_d.append(") AS A ");
	sql_d.append("GROUP BY A.AREA ");
	sql_d.append("ORDER BY CNT DESC ");
	initializer.prepareQuery("sql_d", sql_d.toString());

	//sql_bb
	StringBuilder sql_bb = new StringBuilder();
	sql_bb.setLength(0);
	sql_bb.append("SELECT ");
	sql_bb.append("	AA.AREA , ");
	sql_bb.append("	AA.ORG_CNT, ");
	sql_bb.append("	AA.EQUIP, ");
	sql_bb.append("	AA.SM, ");
	sql_bb.append("	SUM(AA.EQU_CNT) AS CNT ");
	sql_bb.append("FROM ");
	sql_bb.append("	( ");
	sql_bb.append("		SELECT ");
	sql_bb.append("		SUBSTRING(A.ADDR1,3,5) AS AREA, ");
	sql_bb.append("		SUM(B.TAKE_PRC) AS SM, ");
	sql_bb.append("		( ");
	sql_bb.append("			SELECT ");
	sql_bb.append(" ");
	sql_bb.append("				COUNT(0) AS CNT ");
	sql_bb.append("			FROM TB_ORG_GRP AS AAA ");
	sql_bb.append("			WHERE AAA.AREA_CD = 1 ");
	sql_bb.append("			AND SUBSTRING(AAA.ADDR1,3,5) = SUBSTRING(A.ADDR1,3,5) ");
	sql_bb.append("		) AS ORG_CNT, ");
	sql_bb.append("		( ");
	sql_bb.append("			SELECT ");
	sql_bb.append("					COUNT(0) ");
	sql_bb.append("			FROM ");
	sql_bb.append("				TB_EQU_INFO ");
	sql_bb.append("			WHERE TB_EQU_INFO.USER_IDX IN ");
	sql_bb.append("										( ");
	sql_bb.append("											SELECT ");
	sql_bb.append("												USER_IDX ");
	sql_bb.append("											FROM ");
	sql_bb.append("												TB_USER_COPY ");
	sql_bb.append("											WHERE TB_USER_COPY.ORG_GRP_CD = A.ORG_GRP_CD ");
	sql_bb.append("											AND B.USE_SCOPE_CD = '2' ");
	sql_bb.append("										) ");
	sql_bb.append("			AND (TB_EQU_INFO.DELETE_YN != 'Y' or TB_EQU_INFO.DELETE_YN IS NULL) ");
	sql_bb.append("		)AS EQUIP, ");
	sql_bb.append("		( ");
	sql_bb.append("			SELECT ");
	sql_bb.append("				COUNT(0) ");
	sql_bb.append("			FROM ");
	...
	sql_bb.append("										  ) ");
	sql_bb.append("			AND (TB_EQU_INFO.DELETE_YN != 'Y' or TB_EQU_INFO.DELETE_YN IS NULL) ");
	sql_bb.append("		) AS EQU_CNT ");
	sql_bb.append("FROM TB_ORG_GRP AS A ");
	sql_bb.append("	LEFT JOIN TB_EQU_INFO AS B ");
	sql_bb.append("		ON A.ORG_GRP_NM = B.RND_MAIN_ORG ");
	sql_bb.append("WHERE A.AREA_CD = 1 ");
	sql_bb.append("AND (B.DELETE_YN != 'Y' or B.DELETE_YN IS NULL) ");
	sql_bb.append("GROUP BY A.ORG_GRP_NM ");
	sql_bb.append("	) AS AA ");
	sql_bb.append("WHERE 1=1 ");
	sql_bb.append("GROUP BY AA.AREA ");
	sql_bb.append("ORDER BY CNT DESC ");
	sql_bb.append("LIMIT 10 ");
	initializer.prepareQuery("sql_bb", sql_bb.toString());
	...
	sql_getJnspReEqAre.append("				( ");
	sql_getJnspReEqAre.append("					SELECT SUM(B1.TAKE_PRC) FROM TB_EQU_INFO AS B1 ");
	sql_getJnspReEqAre.append("					LEFT JOIN TB_EQU_GOODS AS C1 ");
	sql_getJnspReEqAre.append("					ON B1.RND_EQU_IDX  = C1.RND_EQU_IDX ");
	sql_getJnspReEqAre.append("					WHERE A.ORG_GRP_CD = C1.OWN_ORG ");
	sql_getJnspReEqAre.append("					AND B1.STATE = '2' ");
	...
	sql_getJnspReEqAre.append("			AND A.ORG_TYPE = '2' ");
	...
	sql_getJnspReEqAreTt.append("				( ");
	sql_getJnspReEqAreTt.append("					SELECT SUM(B1.TAKE_PRC) FROM TB_EQU_INFO AS B1 ");
	sql_getJnspReEqAreTt.append("					LEFT JOIN TB_EQU_GOODS AS C1 ");
	sql_getJnspReEqAreTt.append("					ON B1.RND_EQU_IDX  = C1.RND_EQU_IDX ");
	sql_getJnspReEqAreTt.append("					WHERE A.ORG_GRP_CD = C1.OWN_ORG ");
	sql_getJnspReEqAreTt.append("					AND B1.STATE = '2' ");
	...
	sql_getJnspReEqAreTt.append("			AND A.ORG_TYPE = '2' ");
	...
	sql_getJnspReEqAreTb.append("				( ");
	sql_getJnspReEqAreTb.append("					SELECT SUM(B1.TAKE_PRC) FROM TB_EQU_INFO AS B1 ");
	sql_getJnspReEqAreTb.append("					LEFT JOIN TB_EQU_GOODS AS C1 ");
	sql_getJnspReEqAreTb.append("					ON B1.RND_EQU_IDX  = C1.RND_EQU_IDX ");
	sql_getJnspReEqAreTb.append("					WHERE A.ORG_GRP_CD = C1.OWN_ORG ");
	sql_getJnspReEqAreTb.append("					AND B1.STATE = '2' ");
	...
	sql_getJnspReEqAreTb.append("			AND A.ORG_TYPE = '2' ");
...
class ReportHandler{
	...
	private java.sql.PreparedStatement stat_bb;		//ResultSet bb 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet bb;		//ResultSet bb 객체
	...
	private StringBuilder sql_bb = new StringBuilder();		//ResultSet bb 객체를 생성하기 위한 쿼리문 저장
	...
	private String c_AXIS;
	private String c_DEPT_NM;
	private long c_CNT;

	//ResultSet d 객체에서 필드 값을 받는 쿼리 필드 변수
	private String d_AXIS;
	private long d_CNT;

	//ResultSet bb 객체에서 필드 값을 받는 쿼리 필드 변수
	private String bb_AREA;
	private long bb_ORG_CNT;
	private long bb_EQUIP;
	private double bb_SM;
	private long bb_CNT;
	...
	private void executeSheet10( ) throws Exception{
		...
		//밴드 함수 호출
		getScriptFromyyyyyy(true, false);    //Void 밴드 호출
	...
	private void getScriptFromyyyyyy(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		while(getJnspReEqAreTb.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet10_L21 = getJnspReEqAreTb_CNT;
			sheet10_R21 = getJnspReEqAreTb_SM;
	...
	//-----스크립트 출력 함수-----
	//----yyyyyy 스크립트 문 출력 함수----
	private void writeScriptyyyyyy( ) throws Exception{
		//스크립트문 생성
	...
	private void writeScripttest( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_L20"), nYCurPos+mapTop.get("sheet10_L20"), mapWidth.get("sheet10_L20"), mapHeight.get("sheet10_L20"), sheet10_L20, "sheet10_L20", mapStyle.get("sheet10_L20"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_R20"), nYCurPos+mapTop.get("sheet10_R20"), mapWidth.get("sheet10_R20"), mapHeight.get("sheet10_R20"), sheet10_R20, "sheet10_R20", mapStyle.get("sheet10_R20"));
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_L21"), nYCurPos+mapTop.get("sheet10_L21"), mapWidth.get("sheet10_L21"), mapHeight.get("sheet10_L21"), String.valueOf(sheet10_L21), "sheet10_L21", mapStyle.get("sheet10_L21"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_R21"), nYCurPos+mapTop.get("sheet10_R21"), mapWidth.get("sheet10_R21"), mapHeight.get("sheet10_R21"), String.valueOf(sheet10_R21), "sheet10_R21", mapStyle.get("sheet10_R21"));
	}
	...
	private void initSQLConst() throws Exception {
		...
		stat_bb = initializer.configPreparedStatement("sql_bb", mapParam, conn_jnsp, null);
	...
	private void setFieldVariableFromc() throws Exception{
		c_AXIS = GetB(c.getString(1));
		c_DEPT_NM = GetB(c.getString(2));
		c_CNT = c.getLong(3);
	}
	...
	//ResultSet bb 객체에서 필드 값 설정 함수
	private void setFieldVariableFrombb() throws Exception{
		bb_AREA = GetB(bb.getString(1));
		bb_ORG_CNT = bb.getLong(2);
		bb_EQUIP = bb.getLong(3);
		bb_SM = bb.getDouble(4);
		bb_CNT = bb.getLong(5);
	}

	//ResultSet bb 객체의 필드 값 초기화 함수
	private void setFieldInitFrombb(){
		bb_AREA = "";
		bb_ORG_CNT = 0L;
		bb_EQUIP = 0L;
		bb_SM = 0;
	...
	//ResultSet bb 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFrombb() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(bb.getObject(1));
		row.add(bb.getLong(2));
		row.add(bb.getLong(3));
		row.add(bb.getDouble(4));
		row.add(bb.getLong(5));
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B20", 24, 372, 290, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_L20", 314, 372, 173, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_R20", 487, 372, 224, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 290, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_L21", 314, 0, 173, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_R21", 487, 0, 224, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 29, 20, "cell_style_10");
	}
