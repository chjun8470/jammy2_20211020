...
public void jspInit() {
	...
	sql_a2.append("				WHERE STATE = '2' ");
	sql_a2.append("			) AS A ");
	sql_a2.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a2.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_a2.append("			WHERE 1 = 1 ");
	sql_a2.append("AND A.IDX = '2' ");
	sql_a2.append("GROUP BY A.ORG_NM ");
	sql_a2.append("ORDER BY CNT DESC ");
	...
	sql_a1.append("				WHERE STATE = '2' ");
	sql_a1.append("			) AS A ");
	sql_a1.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a1.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	...
	//sql_a1a1
	StringBuilder sql_a1a1 = new StringBuilder();
	sql_a1a1.setLength(0);
	sql_a1a1.append("SELECT ");
	sql_a1a1.append("				A.IDX, ");
	sql_a1a1.append("				A.ORG_NM AS AREA, ");
	sql_a1a1.append("				A.ORG_GRP_CD, ");
	sql_a1a1.append("				COUNT(0) AS CNT ");
	sql_a1a1.append("			FROM( ");
	sql_a1a1.append("				SELECT ");
	sql_a1a1.append("					'1' AS IDX , ");
	sql_a1a1.append("					STATE AS STATE, ");
	sql_a1a1.append("					INTRL_APLC_NO AS APLC_NO, ");
	sql_a1a1.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a1a1.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a1a1.append("				FROM TB_SEARCH_BRAND ");
	sql_a1a1.append("				WHERE STATE = '2' ");
	sql_a1a1.append("				UNION ALL ");
	sql_a1a1.append("				SELECT ");
	sql_a1a1.append("					'2' AS IDX , ");
	sql_a1a1.append("					STATE AS STATE, ");
	sql_a1a1.append("					APLC_NO AS APLC_NO, ");
	sql_a1a1.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a1a1.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a1a1.append("				FROM TB_SEARCH_DESIGN ");
	sql_a1a1.append("				WHERE STATE = '2' ");
	sql_a1a1.append("				UNION ALL ");
	sql_a1a1.append("				SELECT ");
	sql_a1a1.append("					'3' AS IDX , ");
	sql_a1a1.append("					STATE AS STATE, ");
	sql_a1a1.append("					KNOW_HOW_NO AS APLC_NO, ");
	sql_a1a1.append("					ORG_NM AS ORG_NM, ");
	sql_a1a1.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a1a1.append("				FROM TB_SEARCH_KNOW_HOW ");
	sql_a1a1.append("				WHERE STATE = '2' ");
	sql_a1a1.append("				UNION ALL ");
	sql_a1a1.append("				SELECT ");
	sql_a1a1.append("					'4' AS IDX , ");
	sql_a1a1.append("					STATE AS STATE, ");
	sql_a1a1.append("					APLC_NO AS APLC_NO, ");
	sql_a1a1.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a1a1.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a1a1.append("				FROM TB_SEARCH_PATENT_UTILITY_MODEL ");
	sql_a1a1.append("				WHERE STATE = '2' ");
	sql_a1a1.append("				UNION ALL ");
	sql_a1a1.append("				SELECT ");
	sql_a1a1.append("					'5' AS IDX , ");
	sql_a1a1.append("					STATE AS STATE, ");
	sql_a1a1.append("					REG_NO AS APLC_NO, ");
	sql_a1a1.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a1a1.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a1a1.append("				FROM TB_SEARCH_PROGRAM ");
	sql_a1a1.append("				WHERE STATE = '2' ");
	sql_a1a1.append("			) AS A ");
	sql_a1a1.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a1a1.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_a1a1.append("			WHERE 1 = 1 ");
	sql_a1a1.append("AND A.IDX = '1' ");
	sql_a1a1.append("GROUP BY A.ORG_NM ");
	sql_a1a1.append("LIMIT 10 ");
	initializer.prepareQuery("sql_a1a1", sql_a1a1.toString());

	//sql_a2a2
	StringBuilder sql_a2a2 = new StringBuilder();
	sql_a2a2.setLength(0);
	sql_a2a2.append("SELECT ");
	sql_a2a2.append("				A.IDX, ");
	sql_a2a2.append("				A.ORG_NM AS AREA, ");
	sql_a2a2.append("				A.ORG_GRP_CD, ");
	sql_a2a2.append("				COUNT(0) AS CNT ");
	sql_a2a2.append("			FROM( ");
	sql_a2a2.append("				SELECT ");
	sql_a2a2.append("					'1' AS IDX , ");
	sql_a2a2.append("					STATE AS STATE, ");
	sql_a2a2.append("					INTRL_APLC_NO AS APLC_NO, ");
	sql_a2a2.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a2a2.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a2a2.append("				FROM TB_SEARCH_BRAND ");
	sql_a2a2.append("				WHERE STATE = '2' ");
	sql_a2a2.append("				UNION ALL ");
	sql_a2a2.append("				SELECT ");
	sql_a2a2.append("					'2' AS IDX , ");
	sql_a2a2.append("					STATE AS STATE, ");
	sql_a2a2.append("					APLC_NO AS APLC_NO, ");
	sql_a2a2.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a2a2.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a2a2.append("				FROM TB_SEARCH_DESIGN ");
	sql_a2a2.append("				WHERE STATE = '2' ");
	sql_a2a2.append("				UNION ALL ");
	sql_a2a2.append("				SELECT ");
	sql_a2a2.append("					'3' AS IDX , ");
	sql_a2a2.append("					STATE AS STATE, ");
	sql_a2a2.append("					KNOW_HOW_NO AS APLC_NO, ");
	sql_a2a2.append("					ORG_NM AS ORG_NM, ");
	sql_a2a2.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a2a2.append("				FROM TB_SEARCH_KNOW_HOW ");
	sql_a2a2.append("				WHERE STATE = '2' ");
	sql_a2a2.append("				UNION ALL ");
	sql_a2a2.append("				SELECT ");
	sql_a2a2.append("					'4' AS IDX , ");
	sql_a2a2.append("					STATE AS STATE, ");
	sql_a2a2.append("					APLC_NO AS APLC_NO, ");
	sql_a2a2.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a2a2.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a2a2.append("				FROM TB_SEARCH_PATENT_UTILITY_MODEL ");
	sql_a2a2.append("				WHERE STATE = '2' ");
	sql_a2a2.append("				UNION ALL ");
	sql_a2a2.append("				SELECT ");
	sql_a2a2.append("					'5' AS IDX , ");
	sql_a2a2.append("					STATE AS STATE, ");
	sql_a2a2.append("					REG_NO AS APLC_NO, ");
	sql_a2a2.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a2a2.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a2a2.append("				FROM TB_SEARCH_PROGRAM ");
	sql_a2a2.append("				WHERE STATE = '2' ");
	sql_a2a2.append("			) AS A ");
	sql_a2a2.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a2a2.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_a2a2.append("			WHERE 1 = 1 ");
	sql_a2a2.append("AND A.IDX = '2' ");
	sql_a2a2.append("GROUP BY A.ORG_NM ");
	sql_a2a2.append("ORDER BY CNT DESC ");
	sql_a2a2.append("LIMIT 10 ");
	initializer.prepareQuery("sql_a2a2", sql_a2a2.toString());
}
...
class ReportHandler{
	...
	private java.sql.PreparedStatement stat_a1a1;		//ResultSet a1a1 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet a1a1;		//ResultSet a1a1 객체
	private java.sql.PreparedStatement stat_a2a2;		//ResultSet a2a2 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet a2a2;		//ResultSet a2a2 객체
	...
	private StringBuilder sql_a1a1 = new StringBuilder();		//ResultSet a1a1 객체를 생성하기 위한 쿼리문 저장
	private StringBuilder sql_a2a2 = new StringBuilder();		//ResultSet a2a2 객체를 생성하기 위한 쿼리문 저장
	...
	//ResultSet a1a1 객체에서 필드 값을 받는 쿼리 필드 변수
	private String a1a1_IDX;
	private String a1a1_AREA;
	private String a1a1_ORG_GRP_CD;
	private long a1a1_CNT;

	//ResultSet a2a2 객체에서 필드 값을 받는 쿼리 필드 변수
	private String a2a2_IDX;
	private String a2a2_AREA;
	private String a2a2_ORG_GRP_CD;
	private long a2a2_CNT;
	...
	void service(JspWriter out) throws Exception{
		try{    //try 구문
			...
			//DataSet Close
			cleanup(a2a2, stat_a2a2, null, null);
			cleanup(a1a1, stat_a1a1, null, null);
	...
	private void getScriptFromyyy(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//DataSet 객체 생성
			//ResultSet a2a2 객체의 생성
			if(a2a2==null){
				a2a2 = stat_a2a2.executeQuery();
			}else{
				a2a2.beforeFirst();
			}
			...
			//데이터 fetch
			if(a2a2.next()){
				setFieldVariableFroma2a2();	//ResultSet a2a2에서 필드 값 설정
			}else{
				setFieldInitFroma2a2();	//ResultSet a2a2의 필드 값 초기화
			}
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		//ResultSet a1 객체의 생성
		if(a1==null){
			a1 = stat_a1.executeQuery();
		}else{
			a1.beforeFirst();
		}

		//--while Loop Start--##
		while(a1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFroma1();	//RecordSet a1에서 필드 값 설정
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+34, 726, 362, AI_CHART_OBJ41, "AI_CHART_OBJ41", "draw_style_0");
	}
	...
	private void initSQLConst() throws Exception {
		...
		stat_a1a1 = initializer.configPreparedStatement("sql_a1a1", mapParam, conn_jnsp, null);

		stat_a2a2 = initializer.configPreparedStatement("sql_a2a2", mapParam, conn_jnsp, null);
	}
	...
	private void setFieldVariableFroma2() throws Exception{
		...
		a2_ORG_GRP_CD = GetB(a2.getString(3));
		a2_CNT = a2.getLong(4);
	}
	...
	private List<Object> getAIRowDataFroma2() throws Exception{
		...
		row.add(a2.getObject(3));
		row.add(a2.getLong(4));
	...
	private void setFieldVariableFroma1() throws Exception{
		...
		a1_ORG_GRP_CD = GetB(a1.getString(3));
		a1_CNT = a1.getLong(4);
	}
	...
	private List<Object> getAIRowDataFroma1() throws Exception{
		...
		row.add(a1.getObject(3));
		row.add(a1.getLong(4));
	...
	//ResultSet a1a1 객체에서 필드 값 설정 함수
	private void setFieldVariableFroma1a1() throws Exception{
		a1a1_IDX = GetB(a1a1.getString(1));
		a1a1_AREA = GetB(a1a1.getString(2));
		a1a1_ORG_GRP_CD = GetB(a1a1.getString(3));
		a1a1_CNT = a1a1.getLong(4);
	}

	//ResultSet a1a1 객체의 필드 값 초기화 함수
	private void setFieldInitFroma1a1(){
		a1a1_IDX = "";
		a1a1_AREA = "";
		a1a1_ORG_GRP_CD = "";
		a1a1_CNT = 0L;
	...
	//ResultSet a1a1 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFroma1a1() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(a1a1.getObject(1));
		row.add(a1a1.getObject(2));
		row.add(a1a1.getObject(3));
		row.add(a1a1.getLong(4));

		return row;
	}

	//ResultSet a2a2 객체에서 필드 값 설정 함수
	private void setFieldVariableFroma2a2() throws Exception{
		a2a2_IDX = GetB(a2a2.getString(1));
		a2a2_AREA = GetB(a2a2.getString(2));
		a2a2_ORG_GRP_CD = GetB(a2a2.getString(3));
		a2a2_CNT = a2a2.getLong(4);
	}

	//ResultSet a2a2 객체의 필드 값 초기화 함수
	private void setFieldInitFroma2a2(){
		a2a2_IDX = "";
		a2a2_AREA = "";
		a2a2_ORG_GRP_CD = "";
		a2a2_CNT = 0L;
	...
	//ResultSet a2a2 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFroma2a2() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(a2a2.getObject(1));
		row.add(a2a2.getObject(2));
		row.add(a2a2.getObject(3));
		row.add(a2a2.getLong(4));
	...
	private void getChartDataAI_CHART_OBJ41( ) throws Exception{
		...
		//ResultSet a2 객체의 생성
		if(a2==null){
			a2 = stat_a2.executeQuery();
		}else{
			a2.beforeFirst();
		}
		if(!a2.isBeforeFirst()){		//생성된 ResultSet에 레코드가 없으면
			return;
		}
		...
		while(a2.next()){   //데이터 루프문
			//데이터 fetch
			setFieldVariableFroma2();   //RecordSet a2에서 필드 값 설정

			//X축 레이블 필드 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + a2_AREA + "\t";

			//데이터 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + a2_CNT + "\r\n";
		}   //while end
	}
