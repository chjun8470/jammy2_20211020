...
public void jspInit() {
	...
	sql_ff.append("ORDER BY USER_CNT DESC ");
	...
	sql_ff12.append("ORDER BY USER_CNT DESC ");
...
class ReportHandler{
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+32, 723, 355, AI_CHART_OBJ38, "AI_CHART_OBJ38", "draw_style_0");
	}
	...
	private void getChartDataAI_CHART_OBJ38( ) throws Exception{
		...
		//계열(Series) 필드 설정
		AI_CHART_OBJ38="\t";
		AI_CHART_OBJ38=AI_CHART_OBJ38 + "USER_CNT\r\n";
		...
		while(ff.next()){   //데이터 루프문
			...
			//X축 레이블 필드 설정
			AI_CHART_OBJ38=AI_CHART_OBJ38 + ff_LOCATION_DTL + "\t";

			//데이터 설정
			AI_CHART_OBJ38=AI_CHART_OBJ38 + ff_USER_CNT + "\r\n";
		}   //while end
	}
