...
class ReportHandler{
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		while(jip2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B22 = jip2_IDX;
			sheet10_N22 = jip2_CNT;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos+1, nYCurPos+32, 724, 368, AI_CHART_OBJ43, "AI_CHART_OBJ43", "draw_style_0");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_N21"), nYCurPos+mapTop.get("sheet10_N21"), mapWidth.get("sheet10_N21"), mapHeight.get("sheet10_N21"), sheet10_N21, "sheet10_N21", mapStyle.get("sheet10_N21"));
	}
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_N22"), nYCurPos+mapTop.get("sheet10_N22"), mapWidth.get("sheet10_N22"), mapHeight.get("sheet10_N22"), String.valueOf(sheet10_N22), "sheet10_N22", mapStyle.get("sheet10_N22"));
	}
	...
	private void setFieldVariableFromjip2() throws Exception{
		...
		jip2_ORG_GRP_NM = GetB(jip2.getString(4));
		jip2_CNT = jip2.getLong(5);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 348, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_N21", 372, 0, 339, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 348, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_N22", 372, 0, 339, 20, "cell_style_6");
	}
