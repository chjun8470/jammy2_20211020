...
public void jspInit() {
	...
	sql_a3.append("				WHERE STATE = '2' ");
	sql_a3.append("			) AS A ");
	sql_a3.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a3.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_a3.append("			WHERE 1 = 1 ");
	sql_a3.append("AND A.IDX = '3' ");
	sql_a3.append("GROUP BY A.ORG_NM ");
	sql_a3.append("ORDER BY CNT DESC ");
	...
	//sql_a3a3
	StringBuilder sql_a3a3 = new StringBuilder();
	sql_a3a3.setLength(0);
	sql_a3a3.append("SELECT ");
	sql_a3a3.append("				A.IDX, ");
	sql_a3a3.append("				A.ORG_NM AS AREA, ");
	sql_a3a3.append("				A.ORG_GRP_CD, ");
	sql_a3a3.append("				COUNT(0) AS CNT ");
	sql_a3a3.append("			FROM( ");
	sql_a3a3.append("				SELECT ");
	sql_a3a3.append("					'1' AS IDX , ");
	sql_a3a3.append("					STATE AS STATE, ");
	sql_a3a3.append("					INTRL_APLC_NO AS APLC_NO, ");
	sql_a3a3.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a3a3.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a3a3.append("				FROM TB_SEARCH_BRAND ");
	sql_a3a3.append("				WHERE STATE = '2' ");
	sql_a3a3.append("				UNION ALL ");
	sql_a3a3.append("				SELECT ");
	sql_a3a3.append("					'2' AS IDX , ");
	sql_a3a3.append("					STATE AS STATE, ");
	sql_a3a3.append("					APLC_NO AS APLC_NO, ");
	sql_a3a3.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a3a3.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a3a3.append("				FROM TB_SEARCH_DESIGN ");
	sql_a3a3.append("				WHERE STATE = '2' ");
	sql_a3a3.append("				UNION ALL ");
	sql_a3a3.append("				SELECT ");
	sql_a3a3.append("					'3' AS IDX , ");
	sql_a3a3.append("					STATE AS STATE, ");
	sql_a3a3.append("					KNOW_HOW_NO AS APLC_NO, ");
	sql_a3a3.append("					ORG_NM AS ORG_NM, ");
	sql_a3a3.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a3a3.append("				FROM TB_SEARCH_KNOW_HOW ");
	sql_a3a3.append("				WHERE STATE = '2' ");
	sql_a3a3.append("				UNION ALL ");
	sql_a3a3.append("				SELECT ");
	sql_a3a3.append("					'4' AS IDX , ");
	sql_a3a3.append("					STATE AS STATE, ");
	sql_a3a3.append("					APLC_NO AS APLC_NO, ");
	sql_a3a3.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a3a3.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a3a3.append("				FROM TB_SEARCH_PATENT_UTILITY_MODEL ");
	sql_a3a3.append("				WHERE STATE = '2' ");
	sql_a3a3.append("				UNION ALL ");
	sql_a3a3.append("				SELECT ");
	sql_a3a3.append("					'5' AS IDX , ");
	sql_a3a3.append("					STATE AS STATE, ");
	sql_a3a3.append("					REG_NO AS APLC_NO, ");
	sql_a3a3.append("					OWN_ORG_NM AS ORG_NM, ");
	sql_a3a3.append("					ORG_GRP_CD AS ORG_GRP_CD ");
	sql_a3a3.append("				FROM TB_SEARCH_PROGRAM ");
	sql_a3a3.append("				WHERE STATE = '2' ");
	sql_a3a3.append("			) AS A ");
	sql_a3a3.append("			LEFT JOIN TB_ORG_GRP AS B ");
	sql_a3a3.append("			ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_a3a3.append("			WHERE 1 = 1 ");
	sql_a3a3.append("AND A.IDX = '3' ");
	sql_a3a3.append("GROUP BY A.ORG_NM ");
	sql_a3a3.append("ORDER BY CNT DESC ");
	sql_a3a3.append("LIMIT 10 ");
	initializer.prepareQuery("sql_a3a3", sql_a3a3.toString());
	...
	sql_getJnspJipPatent.append("			AND B.ORG_TYPE = '2' ");
	...
	sql_getJnspJipPatentTb.append("			AND B.ORG_TYPE = '2' ");
	...
	sql_getJnspJipPatentTt.append("			AND B.ORG_TYPE = '2' ");
...
class ReportHandler{
	...
	private java.sql.PreparedStatement stat_a3a3;		//ResultSet a3a3 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet a3a3;		//ResultSet a3a3 객체
	...
	private StringBuilder sql_a3a3 = new StringBuilder();		//ResultSet a3a3 객체를 생성하기 위한 쿼리문 저장
	...
	//ResultSet a3a3 객체에서 필드 값을 받는 쿼리 필드 변수
	private String a3a3_IDX;
	private String a3a3_AREA;
	private String a3a3_ORG_GRP_CD;
	private long a3a3_CNT;
	...
	void service(JspWriter out) throws Exception{
		try{    //try 구문
			...
			cleanup(a3a3, stat_a3a3, null, null);
	...
	private void getScriptFromyyy(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//DataSet 객체 생성
			//ResultSet getJnspJipPatentTt 객체의 생성
			if(getJnspJipPatentTt==null){
				getJnspJipPatentTt = stat_getJnspJipPatentTt.executeQuery();
			}else{
				getJnspJipPatentTt.beforeFirst();
			}

			//데이터 fetch
			if(getJnspJipPatentTt.next()){
				setFieldVariableFromgetJnspJipPatentTt();	//ResultSet getJnspJipPatentTt에서 필드 값 설정
			}else{
				setFieldInitFromgetJnspJipPatentTt();	//ResultSet getJnspJipPatentTt의 필드 값 초기화
			}
			...
			//데이터 변수 할당
			sheet10_A1 = getJnspJipPatentTt_CNT;
		}    //end if(bIsFirst)
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		//DataSet 객체 생성
		//ResultSet getJnspJipPatentTb 객체의 생성
		if(getJnspJipPatentTb==null){
			getJnspJipPatentTb = stat_getJnspJipPatentTb.executeQuery();
		}else{
			getJnspJipPatentTb.beforeFirst();
		}
		...
		//--while Loop Start--##
		while(getJnspJipPatentTb.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromgetJnspJipPatentTb();	//RecordSet getJnspJipPatentTb에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet10_B23 = getJnspJipPatentTb_AREA;
			sheet10_N23 = getJnspJipPatentTb_CNT;
	...
	private void initSQLConst() throws Exception {
		...
		stat_a3a3 = initializer.configPreparedStatement("sql_a3a3", mapParam, conn_jnsp, null);
	...
	private void setFieldVariableFroma3() throws Exception{
		...
		a3_ORG_GRP_CD = GetB(a3.getString(3));
		a3_CNT = a3.getLong(4);
	}
	...
	private List<Object> getAIRowDataFroma3() throws Exception{
		...
		row.add(a3.getObject(3));
		row.add(a3.getLong(4));
	...
	//ResultSet a3a3 객체에서 필드 값 설정 함수
	private void setFieldVariableFroma3a3() throws Exception{
		a3a3_IDX = GetB(a3a3.getString(1));
		a3a3_AREA = GetB(a3a3.getString(2));
		a3a3_ORG_GRP_CD = GetB(a3a3.getString(3));
		a3a3_CNT = a3a3.getLong(4);
	}

	//ResultSet a3a3 객체의 필드 값 초기화 함수
	private void setFieldInitFroma3a3(){
		a3a3_IDX = "";
		a3a3_AREA = "";
		a3a3_ORG_GRP_CD = "";
		a3a3_CNT = 0L;
	...
	//ResultSet a3a3 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFroma3a3() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(a3a3.getObject(1));
		row.add(a3a3.getObject(2));
		row.add(a3a3.getObject(3));
		row.add(a3a3.getLong(4));
	...
	private void getChartDataAI_CHART_OBJ41( ) throws Exception{
		//DataSet 객체 생성
		//ResultSet getJnspJipPatent 객체의 생성
		if(getJnspJipPatent==null){
			getJnspJipPatent = stat_getJnspJipPatent.executeQuery();
		}else{
			getJnspJipPatent.beforeFirst();
		}
		if(!getJnspJipPatent.isBeforeFirst()){		//생성된 ResultSet에 레코드가 없으면
			return;
		}
		...
		while(getJnspJipPatent.next()){   //데이터 루프문
			//데이터 fetch
			setFieldVariableFromgetJnspJipPatent();   //RecordSet getJnspJipPatent에서 필드 값 설정

			//X축 레이블 필드 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + getJnspJipPatent_AREA + "\t";

			//데이터 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + getJnspJipPatent_CNT + "\r\n";
		}   //while end
	}
