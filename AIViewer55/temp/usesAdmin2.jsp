...
public void jspInit() {
	...
	sql_xxxx.append("GROUP BY C.OWN_ORG ");
	sql_xxxx.append("ORDER BY EQU_SUM_EARNINGS DESC ");
	sql_xxxx.append("limit 10; ");
	...
	sql_sss1.append("COUNT(DISTINCT(B.RND_EQU_IDX)) AS EQU_COUNT, ");
	sql_sss1.append("ROUND((SUM(B.TAKE_PRC) / 10000)) AS TAKE_PRC ");
	sql_sss1.append(" ");
	...
	sql_sss1.append("GROUP BY C.OWN_ORG ");
	sql_sss1.append("ORDER BY EQU_SUM_EARNINGS DESC ");
...
class ReportHandler{
	...
	private String xxxx_OWN_ORG_NM;
	...
	private String sss1_OWN_ORG_NM;
	private long sss1_EQU_SUM_EARNINGS;
	private long sss1_COUNT_USE_INSTITUTION;
	private long sss1_EQU_COUNT;
	private double sss1_TAKE_PRC;
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		//DataSet 객체 생성
		//ResultSet xxxx 객체의 생성
		if(xxxx==null){
			xxxx = stat_xxxx.executeQuery();
		}else{
			xxxx.beforeFirst();
		}
		...
		//--while Loop Start--##
		while(xxxx.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromxxxx();	//RecordSet xxxx에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet10_B23 = xxxx_OWN_ORG_NM;
			sheet10_H23 = xxxx_EQU_SUM_EARNINGS;
			sheet10_M23 = xxxx_COUNT_USE_INSTITUTION;
			sheet10_Q23 = xxxx_EQU_COUNT;
			sheet10_U23 = (long)xxxx_TAKE_PRC;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+29, 726, 358, AI_CHART_OBJ40, "AI_CHART_OBJ40", "draw_style_0");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_H22"), nYCurPos+mapTop.get("sheet10_H22"), mapWidth.get("sheet10_H22"), mapHeight.get("sheet10_H22"), sheet10_H22, "sheet10_H22", mapStyle.get("sheet10_H22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_M22"), nYCurPos+mapTop.get("sheet10_M22"), mapWidth.get("sheet10_M22"), mapHeight.get("sheet10_M22"), sheet10_M22, "sheet10_M22", mapStyle.get("sheet10_M22"));
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_H23"), nYCurPos+mapTop.get("sheet10_H23"), mapWidth.get("sheet10_H23"), mapHeight.get("sheet10_H23"), String.valueOf(sheet10_H23), "sheet10_H23", mapStyle.get("sheet10_H23"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_M23"), nYCurPos+mapTop.get("sheet10_M23"), mapWidth.get("sheet10_M23"), mapHeight.get("sheet10_M23"), String.valueOf(sheet10_M23), "sheet10_M23", mapStyle.get("sheet10_M23"));
	...
	private void setFieldVariableFromxxxx() throws Exception{
		xxxx_OWN_ORG_NM = GetB(xxxx.getString(1));
	...
	private void setFieldVariableFromsss1() throws Exception{
		sss1_OWN_ORG_NM = GetB(sss1.getString(1));
		sss1_EQU_SUM_EARNINGS = sss1.getLong(2);
		sss1_COUNT_USE_INSTITUTION = sss1.getLong(3);
		sss1_EQU_COUNT = sss1.getLong(4);
		sss1_TAKE_PRC = sss1.getDouble(5);
	}
	...
	private void getChartDataAI_CHART_OBJ40( ) throws Exception{
		...
		if(!xxxx.isBeforeFirst()){		//생성된 ResultSet에 레코드가 없으면
			return;
		}
		...
		while(xxxx.next()){   //데이터 루프문
			//데이터 fetch
			setFieldVariableFromxxxx();   //RecordSet xxxx에서 필드 값 설정

			//X축 레이블 필드 설정
			AI_CHART_OBJ40=AI_CHART_OBJ40 + xxxx_OWN_ORG_NM + "\t";

			//데이터 설정
			AI_CHART_OBJ40=AI_CHART_OBJ40 + xxxx_COUNT_USE_INSTITUTION + "\r\n";
		}   //while end
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 174, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_H22", 198, 0, 145, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_M22", 343, 0, 116, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_Q22", 459, 0, 112, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_U22", 571, 0, 140, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B23", 24, 0, 174, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_H23", 198, 0, 145, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_M23", 343, 0, 116, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_Q23", 459, 0, 112, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_U23", 571, 0, 140, 20, "cell_style_9");
