...
class ReportHandler{
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		while(ff.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B43 = ff_LOCATION_DTL;
			sheet10_G43 = ff_EQ_CNT;
			sheet10_L43 = ff_SCOPE_CNT;
			sheet10_Q43 = (long)ff_SM;
			sheet10_V43 = ff_USER_CNT;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos+1, nYCurPos+549, 723, 241, AI_CHART_OBJ38, "AI_CHART_OBJ38", "draw_style_0");
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+285, 722, 247, AI_CHART_OBJ39, "AI_CHART_OBJ39", "draw_style_1");
		objectWrite(DRAW_OBJECT, nXCurPos+3, nYCurPos+30, 723, 233, AI_CHART_OBJ40, "AI_CHART_OBJ40", "draw_style_2");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G42"), nYCurPos+mapTop.get("sheet10_G42"), mapWidth.get("sheet10_G42"), mapHeight.get("sheet10_G42"), sheet10_G42, "sheet10_G42", mapStyle.get("sheet10_G42"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_Q42"), nYCurPos+mapTop.get("sheet10_Q42"), mapWidth.get("sheet10_Q42"), mapHeight.get("sheet10_Q42"), sheet10_Q42, "sheet10_Q42", mapStyle.get("sheet10_Q42"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_V42"), nYCurPos+mapTop.get("sheet10_V42"), mapWidth.get("sheet10_V42"), mapHeight.get("sheet10_V42"), sheet10_V42, "sheet10_V42", mapStyle.get("sheet10_V42"));
	}
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G43"), nYCurPos+mapTop.get("sheet10_G43"), mapWidth.get("sheet10_G43"), mapHeight.get("sheet10_G43"), String.valueOf(sheet10_G43), "sheet10_G43", mapStyle.get("sheet10_G43"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_L43"), nYCurPos+mapTop.get("sheet10_L43"), mapWidth.get("sheet10_L43"), mapHeight.get("sheet10_L43"), String.valueOf(sheet10_L43), "sheet10_L43", mapStyle.get("sheet10_L43"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_Q43"), nYCurPos+mapTop.get("sheet10_Q43"), mapWidth.get("sheet10_Q43"), mapHeight.get("sheet10_Q43"), String.valueOf(sheet10_Q43), "sheet10_Q43", mapStyle.get("sheet10_Q43"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_V43"), nYCurPos+mapTop.get("sheet10_V43"), mapWidth.get("sheet10_V43"), mapHeight.get("sheet10_V43"), String.valueOf(sheet10_V43), "sheet10_V43", mapStyle.get("sheet10_V43"));
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B42", 24, 0, 145, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G42", 169, 0, 145, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_L42", 314, 0, 145, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_Q42", 459, 0, 140, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_V42", 599, 0, 112, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B43", 24, 0, 145, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_G43", 169, 0, 145, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_L43", 314, 0, 145, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_Q43", 459, 0, 140, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_V43", 599, 0, 112, 20, "cell_style_8");
	}
