...
public void jspInit() {
	...
	sql_jip1.append("		ORG_GRP_CD AS ORG_GRP_CD, ");
	...
	sql_jip1.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_jip1.append("ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_jip1.append("WHERE 1 = 1 ");
	sql_jip1.append("AND B.ORG_GRP_CD = '^orgcd^' ");
	sql_jip1.append("GROUP BY A.ORG_NM ");
	sql_jip1.append("ORDER BY CNT DESC ");
	...
	sql_ttt1.append("	( ");
	sql_ttt1.append("	SELECT ");
	sql_ttt1.append("	COUNT(0) ");
	sql_ttt1.append("	FROM TB_USER_COPY ");
	sql_ttt1.append("	WHERE A.DEPT_NM = TB_USER_COPY.DEPT_NM ");
	sql_ttt1.append("	) AS USER_CNT, ");
	sql_ttt1.append("	COUNT(0) AS CNT ");
	sql_ttt1.append("FROM( ");
	sql_ttt1.append("	SELECT ");
	sql_ttt1.append("		'1' AS IDX , ");
	...
	sql_ttt1.append("GROUP BY A.ORG_NM ");
	sql_ttt1.append("ORDER BY CNT DESC ");
	sql_ttt1.append("LIMIT 10; ");
...
class ReportHandler{
	...
	private String jip1_ORG_GRP_CD;
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		while(jip1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B23 = jip1_AREA;
			sheet10_K23 = jip1_CNT;
			sheet10_S23 = jip1_USER_CNT;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+36, 726, 362, AI_CHART_OBJ41, "AI_CHART_OBJ41", "draw_style_0");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_K22"), nYCurPos+mapTop.get("sheet10_K22"), mapWidth.get("sheet10_K22"), mapHeight.get("sheet10_K22"), sheet10_K22, "sheet10_K22", mapStyle.get("sheet10_K22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_S22"), nYCurPos+mapTop.get("sheet10_S22"), mapWidth.get("sheet10_S22"), mapHeight.get("sheet10_S22"), sheet10_S22, "sheet10_S22", mapStyle.get("sheet10_S22"));
	}
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_K23"), nYCurPos+mapTop.get("sheet10_K23"), mapWidth.get("sheet10_K23"), mapHeight.get("sheet10_K23"), String.valueOf(sheet10_K23), "sheet10_K23", mapStyle.get("sheet10_K23"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_S23"), nYCurPos+mapTop.get("sheet10_S23"), mapWidth.get("sheet10_S23"), mapHeight.get("sheet10_S23"), String.valueOf(sheet10_S23), "sheet10_S23", mapStyle.get("sheet10_S23"));
	}
	...
	private void setFieldVariableFromjip1() throws Exception{
		...
		jip1_ORG_GRP_CD = GetB(jip1.getString(4));
		jip1_ORG_GRP_NM = GetB(jip1.getString(5));
		jip1_USER_CNT = jip1.getLong(6);
		jip1_CNT = jip1.getLong(7);
	}
	...
	private List<Object> getAIRowDataFromjip1() throws Exception{
		...
		row.add(jip1.getObject(5));
		row.add(jip1.getLong(6));
		row.add(jip1.getLong(7));
	...
	private void setFieldVariableFromttt1() throws Exception{
		...
		ttt1_USER_CNT = ttt1.getLong(6);
		ttt1_CNT = ttt1.getLong(7);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 261, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_K22", 285, 0, 230, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_S22", 515, 0, 196, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B23", 24, 0, 261, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_K23", 285, 0, 230, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_S23", 515, 0, 196, 20, "cell_style_9");
