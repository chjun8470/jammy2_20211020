...
public void jspInit() {
	...
	sql_jipppppppp32.append(" ");
	sql_jipppppppp32.append("select ");
	sql_jipppppppp32.append("	C.JIP_USE_IDX, ");
	sql_jipppppppp32.append("	C.RIGHT_SECTION, ");
	sql_jipppppppp32.append("	C.REGIST_INFO, ");
	sql_jipppppppp32.append("	C.TRANSFER_SECTION, ");
	sql_jipppppppp32.append("	C.TRANSFER_PERSON, ");
	sql_jipppppppp32.append("	SUM(C.FLAT_SUM_SKILL_FEE) AS SM, ");
	sql_jipppppppp32.append("	SUM(C.ORDINARY_SKILL_FEE) AS SSM, ");
	sql_jipppppppp32.append("	A.USER_IDX, ");
	sql_jipppppppp32.append("	B.ORG_GRP_NM, ");
	sql_jipppppppp32.append("	A.DEPT_NM, ");
	sql_jipppppppp32.append("	count(*) AS CNT ");
	sql_jipppppppp32.append("from ");
	sql_jipppppppp32.append("	TB_USER_COPY AS A ");
	sql_jipppppppp32.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_jipppppppp32.append("	ON B.ORG_GRP_CD = A.ORG_GRP_CD ");
	sql_jipppppppp32.append("LEFT JOIN TB_JIP_USE_STATUS AS C ");
	sql_jipppppppp32.append("	ON C.REG_IDX = A.USER_IDX ");
	sql_jipppppppp32.append(" ");
	sql_jipppppppp32.append("WHERE 1=1 ");
	sql_jipppppppp32.append("	AND A.USER_IDX IN (select USER_IDX FROM TB_USER_COPY WHERE ORG_GRP_CD = '^orgcd^') ");
	sql_jipppppppp32.append("	AND A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_jipppppppp32.append("GROUP BY B.ORG_GRP_NM ");
...
class ReportHandler{
	...
	private String jipppppppp32_JIP_USE_IDX;
	private long jipppppppp32_RIGHT_SECTION;
	private String jipppppppp32_REGIST_INFO;
	private String jipppppppp32_TRANSFER_SECTION;
	private String jipppppppp32_TRANSFER_PERSON;
	private long jipppppppp32_SM;
	private double jipppppppp32_SSM;
	private long jipppppppp32_USER_IDX;
	private String jipppppppp32_ORG_GRP_NM;
	private String jipppppppp32_DEPT_NM;
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		while(jipppppppp32.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B22 = jipppppppp32_JIP_USE_IDX;
			sheet10_F22 = jipppppppp32_REGIST_INFO;
			sheet10_J22 = jipppppppp32_TRANSFER_PERSON;
			sheet10_P22 = jipppppppp32_SM;
			sheet10_U22 = jipppppppp32_SSM;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+34, 726, 358, AI_CHART_OBJ41, "AI_CHART_OBJ41", "draw_style_0");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_J21"), nYCurPos+mapTop.get("sheet10_J21"), mapWidth.get("sheet10_J21"), mapHeight.get("sheet10_J21"), sheet10_J21, "sheet10_J21", mapStyle.get("sheet10_J21"));
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_F22"), nYCurPos+mapTop.get("sheet10_F22"), mapWidth.get("sheet10_F22"), mapHeight.get("sheet10_F22"), sheet10_F22, "sheet10_F22", mapStyle.get("sheet10_F22"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_P22"), nYCurPos+mapTop.get("sheet10_P22"), mapWidth.get("sheet10_P22"), mapHeight.get("sheet10_P22"), String.valueOf(sheet10_P22), "sheet10_P22", mapStyle.get("sheet10_P22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_U22"), nYCurPos+mapTop.get("sheet10_U22"), mapWidth.get("sheet10_U22"), mapHeight.get("sheet10_U22"), String.valueOf(sheet10_U22), "sheet10_U22", mapStyle.get("sheet10_U22"));
	}
	...
	private void setFieldVariableFromjipppppppp32() throws Exception{
		jipppppppp32_JIP_USE_IDX = GetB(jipppppppp32.getString(1));
		jipppppppp32_RIGHT_SECTION = jipppppppp32.getLong(2);
		jipppppppp32_REGIST_INFO = GetB(jipppppppp32.getString(3));
		jipppppppp32_TRANSFER_SECTION = GetB(jipppppppp32.getString(4));
		jipppppppp32_TRANSFER_PERSON = GetB(jipppppppp32.getString(5));
		jipppppppp32_SM = jipppppppp32.getLong(6);
		jipppppppp32_SSM = jipppppppp32.getDouble(7);
		jipppppppp32_USER_IDX = jipppppppp32.getLong(8);
		jipppppppp32_ORG_GRP_NM = GetB(jipppppppp32.getString(9));
		jipppppppp32_DEPT_NM = GetB(jipppppppp32.getString(10));
		jipppppppp32_CNT = jipppppppp32.getLong(11);
	}

	//ResultSet jipppppppp32 객체의 필드 값 초기화 함수
	private void setFieldInitFromjipppppppp32(){
		jipppppppp32_JIP_USE_IDX = "";
		jipppppppp32_RIGHT_SECTION = 0L;
		jipppppppp32_REGIST_INFO = "";
		jipppppppp32_TRANSFER_SECTION = "";
		jipppppppp32_TRANSFER_PERSON = "";
		jipppppppp32_SM = 0L;
		jipppppppp32_SSM = 0;
		jipppppppp32_USER_IDX = 0L;
		jipppppppp32_ORG_GRP_NM = "";
		jipppppppp32_DEPT_NM = "";
		jipppppppp32_CNT = 0L;
	}
	...
	private List<Object> getAIRowDataFromjipppppppp32() throws Exception{
		...
		row.add(jipppppppp32.getObject(1));
		row.add(jipppppppp32.getLong(2));
		row.add(jipppppppp32.getObject(3));
		row.add(jipppppppp32.getObject(4));
		row.add(jipppppppp32.getObject(5));
		row.add(jipppppppp32.getLong(6));
		row.add(jipppppppp32.getDouble(7));
		row.add(jipppppppp32.getLong(8));
		row.add(jipppppppp32.getObject(9));
		row.add(jipppppppp32.getObject(10));
		row.add(jipppppppp32.getLong(11));
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 116, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_F21", 140, 0, 116, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_J21", 256, 0, 174, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_P21", 430, 0, 141, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_U21", 571, 0, 140, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 116, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_F22", 140, 0, 116, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_J22", 256, 0, 174, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_P22", 430, 0, 141, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_U22", 571, 0, 140, 20, "cell_style_9");
	}
