...
public void jspInit() {
	...
	sql_jip1.append("AND B.USER_IDX = '^userIdx^' ");
	sql_jip1.append("GROUP BY A.DEPT_NM ");
	...
	//sql_jip2
	StringBuilder sql_jip2 = new StringBuilder();
	sql_jip2.setLength(0);
	sql_jip2.append("SELECT ");
	sql_jip2.append("	A.IDX, ");
	sql_jip2.append("	A.NM, ");
	sql_jip2.append("	A.ORG_NM AS AREA, ");
	sql_jip2.append("	A.DEPT_NM , ");
	sql_jip2.append("	B.ORG_GRP_NM, ");
	sql_jip2.append("	COUNT(0) AS CNT ");
	sql_jip2.append("FROM( ");
	sql_jip2.append("	SELECT ");
	sql_jip2.append("		'1' AS IDX , ");
	sql_jip2.append("		( ");
	sql_jip2.append("			select ");
	sql_jip2.append("				CODE_NM ");
	sql_jip2.append("			from ");
	sql_jip2.append("				TB_CODE ");
	sql_jip2.append("			where CODE_CD = '1' ");
	sql_jip2.append("				and CODE_GRP_CD = 'JIPCD' ");
	sql_jip2.append("		) AS NM, ");
	sql_jip2.append("		INTRL_APLC_NO AS APLC_NO, ");
	sql_jip2.append("		OWN_ORG_NM AS ORG_NM, ");
	sql_jip2.append("		OWN_DEPT_NM AS DEPT_NM ");
	sql_jip2.append("	FROM TB_SEARCH_BRAND ");
	sql_jip2.append("	UNION ALL ");
	sql_jip2.append("	SELECT ");
	sql_jip2.append("		'2' AS IDX , ");
	sql_jip2.append("		( ");
	sql_jip2.append("			select ");
	sql_jip2.append("				CODE_NM ");
	sql_jip2.append("			from ");
	sql_jip2.append("				TB_CODE ");
	sql_jip2.append("			where CODE_CD = '2' ");
	sql_jip2.append("				and CODE_GRP_CD = 'JIPCD' ");
	sql_jip2.append("		) AS NM, ");
	sql_jip2.append("		APLC_NO AS APLC_NO, ");
	sql_jip2.append("		OWN_ORG_NM AS ORG_NM, ");
	sql_jip2.append("		OWN_DEPT_NM AS DEPT_NM ");
	sql_jip2.append("	FROM TB_SEARCH_DESIGN ");
	sql_jip2.append("	UNION ALL ");
	sql_jip2.append("	SELECT ");
	sql_jip2.append("		'3' AS IDX , ");
	sql_jip2.append("		( ");
	sql_jip2.append("			select ");
	sql_jip2.append("				CODE_NM ");
	sql_jip2.append("			from ");
	sql_jip2.append("				TB_CODE ");
	sql_jip2.append("			where CODE_CD = '3' ");
	sql_jip2.append("				and CODE_GRP_CD = 'JIPCD' ");
	sql_jip2.append("		) AS NM, ");
	sql_jip2.append("		KNOW_HOW_NO AS APLC_NO, ");
	sql_jip2.append("		ORG_NM AS ORG_NM, ");
	sql_jip2.append("		DEPT_NM AS DEPT_NM ");
	sql_jip2.append("	FROM TB_SEARCH_KNOW_HOW ");
	sql_jip2.append("	UNION ALL ");
	sql_jip2.append("	SELECT ");
	sql_jip2.append("		'4' AS IDX , ");
	sql_jip2.append("		( ");
	sql_jip2.append("			select ");
	sql_jip2.append("				CODE_NM ");
	sql_jip2.append("			from ");
	sql_jip2.append("				TB_CODE ");
	sql_jip2.append("			where CODE_CD = '4' ");
	sql_jip2.append("				and CODE_GRP_CD = 'JIPCD' ");
	sql_jip2.append("		) AS NM, ");
	sql_jip2.append("		APLC_NO AS APLC_NO, ");
	sql_jip2.append("		OWN_ORG_NM AS ORG_NM, ");
	sql_jip2.append("		OWN_DEPT_NM AS DEPT_NM ");
	sql_jip2.append("	FROM TB_SEARCH_PATENT_UTILITY_MODEL ");
	sql_jip2.append("	UNION ALL ");
	sql_jip2.append("	SELECT ");
	sql_jip2.append("		'5' AS IDX , ");
	sql_jip2.append("		( ");
	sql_jip2.append("			select ");
	sql_jip2.append("				CODE_NM ");
	sql_jip2.append("			from ");
	sql_jip2.append("				TB_CODE ");
	sql_jip2.append("			where CODE_CD = '5' ");
	sql_jip2.append("				and CODE_GRP_CD = 'JIPCD' ");
	sql_jip2.append("		) AS NM, ");
	sql_jip2.append("		REG_NO AS APLC_NO, ");
	sql_jip2.append("		OWN_ORG_NM AS ORG_NM, ");
	sql_jip2.append("		OWN_DEPT_NM AS DEPT_NM ");
	sql_jip2.append("	FROM TB_SEARCH_PROGRAM ");
	sql_jip2.append(") AS A ");
	sql_jip2.append("INNER JOIN TB_ORG_GRP AS B ");
	sql_jip2.append("ON A.ORG_NM = B.ORG_GRP_NM ");
	sql_jip2.append("WHERE 1 = 1 ");
	sql_jip2.append("AND B.USER_IDX = '^userIdx^' ");
	sql_jip2.append("GROUP BY A.IDX ");
	initializer.prepareQuery("sql_jip2", sql_jip2.toString());

	//sql_jippppp
	StringBuilder sql_jippppp = new StringBuilder();
	sql_jippppp.setLength(0);
	sql_jippppp.append(" ");
	sql_jippppp.append("select ");
	sql_jippppp.append("	C.JIP_USE_IDX, ");
	sql_jippppp.append("	C.REGIST_INFO, ");
	sql_jippppp.append("	C.TRANSFER_SECTION, ");
	sql_jippppp.append("	C.TRANSFER_PERSON, ");
	sql_jippppp.append("	SUM(C.FLAT_SUM_SKILL_FEE) AS SM, ");
	sql_jippppp.append("	SUM(C.ORDINARY_SKILL_FEE) AS SSM, ");
	sql_jippppp.append("	A.USER_IDX, ");
	sql_jippppp.append("	A.DEPT_NM, ");
	sql_jippppp.append("	count(*) AS CNT ");
	sql_jippppp.append("from ");
	sql_jippppp.append("	TB_USER_COPY AS A ");
	sql_jippppp.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_jippppp.append("	ON B.ORG_GRP_CD = A.ORG_GRP_CD ");
	sql_jippppp.append("LEFT JOIN TB_JIP_USE_STATUS AS C ");
	sql_jippppp.append("	ON C.REG_IDX = A.USER_IDX ");
	sql_jippppp.append("WHERE 1=1 ");
	sql_jippppp.append("	AND A.USER_IDX IN (select USER_IDX FROM TB_USER_COPY WHERE ORG_GRP_CD = '^orgcd^') ");
	sql_jippppp.append("	AND A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_jippppp.append("GROUP BY A.USER_IDX ");
	sql_jippppp.append("limit 10; ");
	sql_jippppp.append(" ");
	sql_jippppp.append(" ");
	initializer.prepareQuery("sql_jippppp", sql_jippppp.toString());

	//sql_jipppppppp32
	StringBuilder sql_jipppppppp32 = new StringBuilder();
	sql_jipppppppp32.setLength(0);
	sql_jipppppppp32.append("SELECT ");
	sql_jipppppppp32.append("	COUNT(0) AS CNT, ");
	sql_jipppppppp32.append("	A.REGIST_INFO, ");
	sql_jipppppppp32.append("	A.TRANSFER_PERSON, ");
	sql_jipppppppp32.append("	ROUND((SUM(A.FLAT_SUM_SKILL_FEE) / 10000)) AS FLAT_SUM, ");
	sql_jipppppppp32.append("	ROUND((SUM(A.ORDINARY_SKILL_FEE) / 10000)) AS ORDINARY_SUM, ");
	sql_jipppppppp32.append("	A.STATE, ");
	sql_jipppppppp32.append("	A.ORG_GRP_CD, ");
	sql_jipppppppp32.append("	B.ORG_GRP_NM ");
	sql_jipppppppp32.append("FROM TB_JIP_USE_STATUS AS A ");
	sql_jipppppppp32.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_jipppppppp32.append("ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_jipppppppp32.append("WHERE A.STATE = '2' ");
	sql_jipppppppp32.append("GROUP BY B.ORG_GRP_NM , A.TRANSFER_PERSON ");
	sql_jipppppppp32.append("ORDER BY CNT DESC ");
	sql_jipppppppp32.append("LIMIT 10; ");
	initializer.prepareQuery("sql_jipppppppp32", sql_jipppppppp32.toString());

	//sql_TTT1
	StringBuilder sql_TTT1 = new StringBuilder();
	sql_TTT1.setLength(0);
	sql_TTT1.append("SELECT ");
	sql_TTT1.append("	COUNT(0) AS CNT, ");
	sql_TTT1.append("	A.REGIST_INFO, ");
	sql_TTT1.append("	A.TRANSFER_PERSON, ");
	sql_TTT1.append("	ROUND((SUM(A.FLAT_SUM_SKILL_FEE) / 10000)) AS FLAT_SUM, ");
	sql_TTT1.append("	ROUND((SUM(A.ORDINARY_SKILL_FEE) / 10000)) AS ORDINARY_SUM, ");
	sql_TTT1.append("	A.STATE, ");
	sql_TTT1.append("	A.ORG_GRP_CD, ");
	sql_TTT1.append("	B.ORG_GRP_NM ");
	sql_TTT1.append("FROM TB_JIP_USE_STATUS AS A ");
	sql_TTT1.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_TTT1.append("ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_TTT1.append("WHERE A.STATE = '2' ");
	sql_TTT1.append("GROUP BY B.ORG_GRP_NM , A.TRANSFER_PERSON ");
	initializer.prepareQuery("sql_TTT1", sql_TTT1.toString());

	//sql_sss1
	StringBuilder sql_sss1 = new StringBuilder();
	sql_sss1.setLength(0);
	sql_sss1.append("SELECT ");
	sql_sss1.append("	COUNT(0) AS CNT, ");
	sql_sss1.append("	A.REGIST_INFO, ");
	sql_sss1.append("	A.TRANSFER_PERSON, ");
	sql_sss1.append("	ROUND((SUM(A.FLAT_SUM_SKILL_FEE) / 10000)) AS FLAT_SUM, ");
	sql_sss1.append("	ROUND((SUM(A.ORDINARY_SKILL_FEE) / 10000)) AS ORDINARY_SUM, ");
	sql_sss1.append("	A.STATE, ");
	sql_sss1.append("	A.ORG_GRP_CD, ");
	sql_sss1.append("	B.ORG_GRP_NM ");
	sql_sss1.append("FROM TB_JIP_USE_STATUS AS A ");
	sql_sss1.append("LEFT JOIN TB_ORG_GRP AS B ");
	sql_sss1.append("ON A.ORG_GRP_CD = B.ORG_GRP_CD ");
	sql_sss1.append("WHERE A.STATE = '2' ");
	sql_sss1.append("GROUP BY B.ORG_GRP_NM , A.TRANSFER_PERSON ");
	sql_sss1.append("ORDER BY CNT DESC ");
...
class ReportHandler{
	...
	private java.sql.PreparedStatement stat_jip2;		//ResultSet jip2 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet jip2;		//ResultSet jip2 객체
	private java.sql.PreparedStatement stat_jippppp;		//ResultSet jippppp 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet jippppp;		//ResultSet jippppp 객체
	private java.sql.PreparedStatement stat_jipppppppp32;		//ResultSet jipppppppp32 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet jipppppppp32;		//ResultSet jipppppppp32 객체
	private java.sql.PreparedStatement stat_TTT1;		//ResultSet TTT1 객체를 생성하기 위한 PreparedStatement 객체
	private ResultSet TTT1;		//ResultSet TTT1 객체
	...
	private StringBuilder sql_jip2 = new StringBuilder();		//ResultSet jip2 객체를 생성하기 위한 쿼리문 저장
	private StringBuilder sql_jippppp = new StringBuilder();		//ResultSet jippppp 객체를 생성하기 위한 쿼리문 저장
	private StringBuilder sql_jipppppppp32 = new StringBuilder();		//ResultSet jipppppppp32 객체를 생성하기 위한 쿼리문 저장
	private StringBuilder sql_TTT1 = new StringBuilder();		//ResultSet TTT1 객체를 생성하기 위한 쿼리문 저장
	...
	//ResultSet jip2 객체에서 필드 값을 받는 쿼리 필드 변수
	private String jip2_IDX;
	private String jip2_NM;
	private String jip2_AREA;
	private String jip2_DEPT_NM;
	private String jip2_ORG_GRP_NM;
	private long jip2_CNT;

	//ResultSet jippppp 객체에서 필드 값을 받는 쿼리 필드 변수
	private String jippppp_JIP_USE_IDX;
	private String jippppp_REGIST_INFO;
	private String jippppp_TRANSFER_SECTION;
	private String jippppp_TRANSFER_PERSON;
	private long jippppp_SM;
	private long jippppp_SSM;
	private long jippppp_USER_IDX;
	private String jippppp_DEPT_NM;
	private long jippppp_CNT;

	//ResultSet jipppppppp32 객체에서 필드 값을 받는 쿼리 필드 변수
	private long jipppppppp32_CNT;
	private String jipppppppp32_REGIST_INFO;
	private String jipppppppp32_TRANSFER_PERSON;
	private long jipppppppp32_FLAT_SUM;
	private double jipppppppp32_ORDINARY_SUM;
	private String jipppppppp32_STATE;
	private String jipppppppp32_ORG_GRP_CD;
	private String jipppppppp32_ORG_GRP_NM;

	//ResultSet TTT1 객체에서 필드 값을 받는 쿼리 필드 변수
	private long TTT1_CNT;
	private String TTT1_REGIST_INFO;
	private String TTT1_TRANSFER_PERSON;
	private long TTT1_FLAT_SUM;
	private double TTT1_ORDINARY_SUM;
	private String TTT1_STATE;
	private String TTT1_ORG_GRP_CD;
	private String TTT1_ORG_GRP_NM;

	//ResultSet sss1 객체에서 필드 값을 받는 쿼리 필드 변수
	private long sss1_CNT;
	private String sss1_REGIST_INFO;
	private String sss1_TRANSFER_PERSON;
	private long sss1_FLAT_SUM;
	private double sss1_ORDINARY_SUM;
	private String sss1_STATE;
	private String sss1_ORG_GRP_CD;
	private String sss1_ORG_GRP_NM;
	...
	void service(JspWriter out) throws Exception{
		try{    //try 구문
			...
			cleanup(TTT1, stat_TTT1, null, null);
			cleanup(jipppppppp32, stat_jipppppppp32, null, null);
			cleanup(jippppp, stat_jippppp, null, null);
			cleanup(jip2, stat_jip2, null, null);
	...
	private void getScriptFromviewList(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet10_B22="등록정보";
			sheet10_I22="실시권자";
			sheet10_O22="정액기술료 (만 원)";
			sheet10_T22="경상기술료 (만 원)";
		}    //end if(bIsFirst)
	...
	private void getScriptFromTbList(boolean bIsPrint) throws Exception{
		...
		//DataSet 객체 생성
		//ResultSet jipppppppp32 객체의 생성
		if(jipppppppp32==null){
			jipppppppp32 = stat_jipppppppp32.executeQuery();
		}else{
			jipppppppp32.beforeFirst();
		}

		//--while Loop Start--##
		while(jipppppppp32.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromjipppppppp32();	//RecordSet jipppppppp32에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet10_B23 = jipppppppp32_REGIST_INFO;
			sheet10_I23 = jipppppppp32_TRANSFER_PERSON;
			sheet10_O23 = jipppppppp32_FLAT_SUM;
			sheet10_T23 = (long)jipppppppp32_ORDINARY_SUM;
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+31, 726, 358, AI_CHART_OBJ41, "AI_CHART_OBJ41", "draw_style_0");
	}
	...
	private void writeScriptviewList( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_I22"), nYCurPos+mapTop.get("sheet10_I22"), mapWidth.get("sheet10_I22"), mapHeight.get("sheet10_I22"), sheet10_I22, "sheet10_I22", mapStyle.get("sheet10_I22"));
	...
	private void writeScriptTbList(  ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_I23"), nYCurPos+mapTop.get("sheet10_I23"), mapWidth.get("sheet10_I23"), mapHeight.get("sheet10_I23"), sheet10_I23, "sheet10_I23", mapStyle.get("sheet10_I23"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_O23"), nYCurPos+mapTop.get("sheet10_O23"), mapWidth.get("sheet10_O23"), mapHeight.get("sheet10_O23"), String.valueOf(sheet10_O23), "sheet10_O23", mapStyle.get("sheet10_O23"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_T23"), nYCurPos+mapTop.get("sheet10_T23"), mapWidth.get("sheet10_T23"), mapHeight.get("sheet10_T23"), String.valueOf(sheet10_T23), "sheet10_T23", mapStyle.get("sheet10_T23"));
	}
	...
	private void initSQLConst() throws Exception {
		...
		stat_jip2 = initializer.configPreparedStatement("sql_jip2", mapParam, conn_jnsp, null);

		stat_jippppp = initializer.configPreparedStatement("sql_jippppp", mapParam, conn_jnsp, null);

		stat_jipppppppp32 = initializer.configPreparedStatement("sql_jipppppppp32", mapParam, conn_jnsp, null);

		stat_TTT1 = initializer.configPreparedStatement("sql_TTT1", mapParam, conn_jnsp, null);
	...
	//ResultSet jip2 객체에서 필드 값 설정 함수
	private void setFieldVariableFromjip2() throws Exception{
		jip2_IDX = GetB(jip2.getString(1));
		jip2_NM = GetB(jip2.getString(2));
		jip2_AREA = GetB(jip2.getString(3));
		jip2_DEPT_NM = GetB(jip2.getString(4));
		jip2_ORG_GRP_NM = GetB(jip2.getString(5));
		jip2_CNT = jip2.getLong(6);
	}

	//ResultSet jip2 객체의 필드 값 초기화 함수
	private void setFieldInitFromjip2(){
		jip2_IDX = "";
		jip2_NM = "";
		jip2_AREA = "";
		jip2_DEPT_NM = "";
	...
	//ResultSet jip2 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromjip2() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(jip2.getObject(1));
		row.add(jip2.getObject(2));
		row.add(jip2.getObject(3));
		row.add(jip2.getObject(4));
		row.add(jip2.getObject(5));
		row.add(jip2.getLong(6));

		return row;
	}

	//ResultSet jippppp 객체에서 필드 값 설정 함수
	private void setFieldVariableFromjippppp() throws Exception{
		jippppp_JIP_USE_IDX = GetB(jippppp.getString(1));
		jippppp_REGIST_INFO = GetB(jippppp.getString(2));
		jippppp_TRANSFER_SECTION = GetB(jippppp.getString(3));
		jippppp_TRANSFER_PERSON = GetB(jippppp.getString(4));
		jippppp_SM = jippppp.getLong(5);
		jippppp_SSM = jippppp.getLong(6);
		jippppp_USER_IDX = jippppp.getLong(7);
		jippppp_DEPT_NM = GetB(jippppp.getString(8));
		jippppp_CNT = jippppp.getLong(9);
	}

	//ResultSet jippppp 객체의 필드 값 초기화 함수
	private void setFieldInitFromjippppp(){
		jippppp_JIP_USE_IDX = "";
		jippppp_REGIST_INFO = "";
		jippppp_TRANSFER_SECTION = "";
		jippppp_TRANSFER_PERSON = "";
		jippppp_SM = 0L;
		jippppp_SSM = 0L;
		jippppp_USER_IDX = 0L;
		jippppp_DEPT_NM = "";
	...
	//ResultSet jippppp 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromjippppp() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(jippppp.getObject(1));
		row.add(jippppp.getObject(2));
		row.add(jippppp.getObject(3));
		row.add(jippppp.getObject(4));
		row.add(jippppp.getLong(5));
		row.add(jippppp.getLong(6));
		row.add(jippppp.getLong(7));
		row.add(jippppp.getObject(8));
		row.add(jippppp.getLong(9));

		return row;
	}

	//ResultSet jipppppppp32 객체에서 필드 값 설정 함수
	private void setFieldVariableFromjipppppppp32() throws Exception{
		jipppppppp32_CNT = jipppppppp32.getLong(1);
		jipppppppp32_REGIST_INFO = GetB(jipppppppp32.getString(2));
		jipppppppp32_TRANSFER_PERSON = GetB(jipppppppp32.getString(3));
		jipppppppp32_FLAT_SUM = jipppppppp32.getLong(4);
		jipppppppp32_ORDINARY_SUM = jipppppppp32.getDouble(5);
		jipppppppp32_STATE = GetB(jipppppppp32.getString(6));
		jipppppppp32_ORG_GRP_CD = GetB(jipppppppp32.getString(7));
		jipppppppp32_ORG_GRP_NM = GetB(jipppppppp32.getString(8));
	}

	//ResultSet jipppppppp32 객체의 필드 값 초기화 함수
	private void setFieldInitFromjipppppppp32(){
		jipppppppp32_CNT = 0L;
		jipppppppp32_REGIST_INFO = "";
		jipppppppp32_TRANSFER_PERSON = "";
		jipppppppp32_FLAT_SUM = 0L;
		jipppppppp32_ORDINARY_SUM = 0;
		jipppppppp32_STATE = "";
		jipppppppp32_ORG_GRP_CD = "";
		jipppppppp32_ORG_GRP_NM = "";
	}

	//ResultSet jipppppppp32 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromjipppppppp32() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(jipppppppp32.getLong(1));
		row.add(jipppppppp32.getObject(2));
		row.add(jipppppppp32.getObject(3));
		row.add(jipppppppp32.getLong(4));
		row.add(jipppppppp32.getDouble(5));
		row.add(jipppppppp32.getObject(6));
		row.add(jipppppppp32.getObject(7));
		row.add(jipppppppp32.getObject(8));

		return row;
	}

	//ResultSet TTT1 객체에서 필드 값 설정 함수
	private void setFieldVariableFromTTT1() throws Exception{
		TTT1_CNT = TTT1.getLong(1);
		TTT1_REGIST_INFO = GetB(TTT1.getString(2));
		TTT1_TRANSFER_PERSON = GetB(TTT1.getString(3));
		TTT1_FLAT_SUM = TTT1.getLong(4);
		TTT1_ORDINARY_SUM = TTT1.getDouble(5);
		TTT1_STATE = GetB(TTT1.getString(6));
		TTT1_ORG_GRP_CD = GetB(TTT1.getString(7));
		TTT1_ORG_GRP_NM = GetB(TTT1.getString(8));
	}

	//ResultSet TTT1 객체의 필드 값 초기화 함수
	private void setFieldInitFromTTT1(){
		TTT1_CNT = 0L;
		TTT1_REGIST_INFO = "";
		TTT1_TRANSFER_PERSON = "";
		TTT1_FLAT_SUM = 0L;
		TTT1_ORDINARY_SUM = 0;
		TTT1_STATE = "";
		TTT1_ORG_GRP_CD = "";
	...
	//ResultSet TTT1 객체에서 RowData 획득함수
	private List<Object> getAIRowDataFromTTT1() throws Exception{
		List<Object> row = new ArrayList<Object>();

		row.add(TTT1.getLong(1));
		row.add(TTT1.getObject(2));
		row.add(TTT1.getObject(3));
		row.add(TTT1.getLong(4));
		row.add(TTT1.getDouble(5));
		row.add(TTT1.getObject(6));
		row.add(TTT1.getObject(7));
		row.add(TTT1.getObject(8));
	...
	private void setFieldVariableFromsss1() throws Exception{
		sss1_CNT = sss1.getLong(1);
		sss1_REGIST_INFO = GetB(sss1.getString(2));
		sss1_TRANSFER_PERSON = GetB(sss1.getString(3));
		sss1_FLAT_SUM = sss1.getLong(4);
		sss1_ORDINARY_SUM = sss1.getDouble(5);
		sss1_STATE = GetB(sss1.getString(6));
		sss1_ORG_GRP_CD = GetB(sss1.getString(7));
		sss1_ORG_GRP_NM = GetB(sss1.getString(8));
	}
	...
	private List<Object> getAIRowDataFromsss1() throws Exception{
		...
		row.add(sss1.getLong(1));
		row.add(sss1.getObject(2));
		row.add(sss1.getObject(3));
		row.add(sss1.getLong(4));
		row.add(sss1.getDouble(5));
		row.add(sss1.getObject(6));
		row.add(sss1.getObject(7));
		row.add(sss1.getObject(8));
	...
	private void getChartDataAI_CHART_OBJ41( ) throws Exception{
		...
		if(!jipppppppp32.isBeforeFirst()){		//생성된 ResultSet에 레코드가 없으면
			return;
		}
		...
		while(jipppppppp32.next()){   //데이터 루프문
			//데이터 fetch
			setFieldVariableFromjipppppppp32();   //RecordSet jipppppppp32에서 필드 값 설정

			//X축 레이블 필드 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + jipppppppp32_ORG_GRP_NM + "\t";

			//데이터 설정
			AI_CHART_OBJ41=AI_CHART_OBJ41 + jipppppppp32_CNT + "\r\n";
		}   //while end
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 203, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_I22", 227, 0, 174, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_O22", 401, 0, 142, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_T22", 543, 0, 168, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B23", 24, 0, 203, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_I23", 227, 0, 174, 20, "cell_style_8");
		setCellInfoMap_Internal("sheet10_O23", 401, 0, 142, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet10_T23", 543, 0, 168, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet10_B24", 24, 0, 29, 20, "cell_style_11");
	}
