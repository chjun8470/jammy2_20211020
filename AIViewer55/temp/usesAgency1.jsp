...
class ReportHandler{
	...
	private void writeScriptview( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, nXCurPos, nYCurPos+32, 726, 358, AI_CHART_OBJ40, "AI_CHART_OBJ40", "draw_style_0");
	}
	...
	private void getChartDataAI_CHART_OBJ40( ) throws Exception{
		...
		//계열(Series) 필드 설정
		AI_CHART_OBJ40="\t";
		AI_CHART_OBJ40=AI_CHART_OBJ40 + "EQU_SUM_EARNINGS\r\n";
		...
		while(xxx.next()){   //데이터 루프문
			...
			//데이터 설정
			AI_CHART_OBJ40=AI_CHART_OBJ40 + xxx_EQU_SUM_EARNINGS + "\r\n";
		}   //while end
	}
