...
************************************************************************************
보고서 제목 : 보고서 (2013/4/16 18:58:47)
작성일 : 2013년4월16일 18시58분47초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("testchart.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptVoidBand100( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+83, nYCurPos+186, 254, 220, AI_CHART_OBJ1, "AI_CHART_OBJ1", "draw_style_0");
		//propertyWrite(DRAW_OBJECT, "AI_CHART_OBJ1", "chartXyInterChange", "y");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|testchart.style|보고서 (2013/4/16 18:58:47)", false);
