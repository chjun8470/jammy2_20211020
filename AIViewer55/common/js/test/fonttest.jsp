...
************************************************************************************
보고서 제목 : 보고서 (2013/2/14 9:12:23)
작성일 : 2013년2월14일 9시12분23초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("fonttest.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, nXCurPos+160, nYCurPos+80, 80, 20, sheet10_C5, "sheet10_C5", "cell_style_0");
		//objectWrite(CELL_OBJECT, nXCurPos+160, nYCurPos+120, 80, 20, sheet10_C7, "sheet10_C7", "cell_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|fonttest.style|보고서 (2013/2/14 9:12:23)", false);
