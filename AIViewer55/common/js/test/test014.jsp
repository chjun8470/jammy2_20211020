...
************************************************************************************
보고서 제목 : 보고서 (2013/2/7 9:35:59)
작성일 : 2013년2월7일 9시35분59초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("test014.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptVoidBand100( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, nXCurPos+80, nYCurPos+60, 80, 20, sheet10_B4, "sheet10_B4", "cell_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|test014.style|보고서 (2013/2/7 9:35:59)", false);
