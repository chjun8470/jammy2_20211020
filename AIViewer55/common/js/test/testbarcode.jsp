...
<%!
private Logger logger = Logger.getLogger("testbarcode.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptVoidBand100( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+54, nYCurPos+142, 293, 80, AI_BARCODE_OBJ1, "AI_BARCODE_OBJ1", "draw_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|testbarcode.style|보고서 (2013/4/17 15:49:39)", false);
