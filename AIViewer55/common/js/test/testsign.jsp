...
************************************************************************************
보고서 제목 : 보고서 (2013/4/25 17:40:27)
작성일 : 2013년4월25일 17시40분27초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("testsign.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+63, nYCurPos+89, 275, 131, "http://192.168.0.27:8080/springViewer/signature-images/aireport-sign.png", "AI_IMAGE_OBJ1", "draw_style_0");
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|testsign.style|보고서 (2013/4/25 17:40:27)", false);
