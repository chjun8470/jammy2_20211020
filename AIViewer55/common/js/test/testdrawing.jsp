...
************************************************************************************
보고서 제목 : 보고서 (2013/4/17 15:49:39)
작성일 : 2013년4월17일 15시49분39초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("testdrawing.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptVoidBand100( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+83, nYCurPos+47, 275, 89, "", "AI_BOX_OBJ2", "draw_style_0");
		objectWrite(DRAW_OBJECT, nXCurPos+108, nYCurPos+174, 218, 63, "", "AI_ROUNDBOX_OBJ3", "draw_style_1");
		objectWrite(DRAW_OBJECT, nXCurPos+159, nYCurPos+303, 108, 91, "", "AI_CIRCLE_OBJ4", "draw_style_2");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|2|testdrawing.style|보고서 (2013/4/17 15:49:39)", false);
