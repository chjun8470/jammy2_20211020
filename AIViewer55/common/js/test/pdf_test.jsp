...
************************************************************************************
보고서 제목 : 보고서 (2013/10/9 12:33:30)
작성일 : 2013년10월9일 12시33분30초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("pdf_test.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void executeSheet10( ) throws Exception{
		...
		initSheetVariant(74, 89, 523, 759, true);
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos, 205, 61, sheet10_A1, "sheet10_A1", "cell_style_0");
		if(true)
		{
			propertyWrite(CELL_OBJECT, "sheet10_A1", "fontColor[@FIND:양하지 :]", "RGB[102,153,255]");
		}

		objectWrite(CELL_OBJECT, nXCurPos+205, nYCurPos, 148, 61, sheet10_B1, "sheet10_B1", "cell_style_1");
	}
	...
	private void initConstVarientEx(){
		sheet10_A1="양하지 : ABCDEFGHIJKLMNOPQRSTUVWXYZ\n\n離聲畵";
		sheet10_B1="ABCDEFGHIJKLMNO\n假喇\nABCDEFGHIJKLMNO";
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|pdf_test.style|보고서 (2013/10/9 12:33:30)", false);
