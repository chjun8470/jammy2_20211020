...
************************************************************************************
보고서 제목 : 보고서 (2013/2/15 11:51:25)
작성일 : 2013년2월15일 11시51분25초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("TBarcode.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void executeSheet10( ) throws Exception{
		...
		//밴드 함수 호출
		getScriptFromaaa(true, true);    //Void 밴드 호출
	...
	private void getScriptFromaaa(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	private void writeScriptaaa( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+84, nYCurPos+44, 231, 105, AI_BARCODE_OBJ1, "AI_BARCODE_OBJ1", "draw_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|TBarcode.style|보고서 (2013/2/15 11:51:25)", false);
