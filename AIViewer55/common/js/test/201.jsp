...
<%!
private Logger logger = Logger.getLogger("201.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|201.style|보고서 (2013/4/17 21:20:13)", false);
