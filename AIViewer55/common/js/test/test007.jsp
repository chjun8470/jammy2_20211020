...
class ReportHandler{
	...
	private void getScriptFromsample(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet10_A87="http://solbitech.com";
		}    //end if(bIsFirst)
	...
	private void writeScriptsample( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+60, 47, 30, sheet10_C5, "sheet10_C5", "cell_style_2");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+60, 105, 30, sheet10_D5, "sheet10_D5", "cell_style_2");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+90, 47, 18, sheet10_C6, "sheet10_C6", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+90, 77, 4, "", "sheet10_D6", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+90, 28, 18, sheet10_P6, "sheet10_P6", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+94, 77, 10, sheet10_D7, "sheet10_D7", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+104, 77, 4, "", "sheet10_D8", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+108, 50, 18, sheet10_A9, "sheet10_A9", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+108, 47, 18, sheet10_C9, "sheet10_C9", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+108, 77, 4, "", "sheet10_D9", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+108, 28, 18, sheet10_P9, "sheet10_P9", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+112, 17, 10, sheet10_D10, "sheet10_D10", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+122, 77, 4, "", "sheet10_D11", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+126, 50, 18, sheet10_A12, "sheet10_A12", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+126, 47, 18, sheet10_C12, "sheet10_C12", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+126, 77, 4, "", "sheet10_D12", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+126, 28, 18, sheet10_P12, "sheet10_P12", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+130, 17, 10, sheet10_D13, "sheet10_D13", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+164, nYCurPos+130, 3, 10, "", "sheet10_H13", "cell_style_12");
		objectWrite(CELL_OBJECT, nXCurPos+167, nYCurPos+130, 0, 10, "", "sheet10_I13", "cell_style_12");
		objectWrite(CELL_OBJECT, nXCurPos+167, nYCurPos+130, 5, 10, "", "sheet10_J13", "cell_style_13");
		objectWrite(CELL_OBJECT, nXCurPos+172, nYCurPos+130, 0, 10, "", "sheet10_K13", "cell_style_12");
		objectWrite(CELL_OBJECT, nXCurPos+172, nYCurPos+130, 5, 10, "", "sheet10_L13", "cell_style_13");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+140, 77, 4, "", "sheet10_D14", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+144, 50, 18, sheet10_A15, "sheet10_A15", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+144, 47, 18, sheet10_C15, "sheet10_C15", "cell_style_4");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+144, 77, 4, "", "sheet10_D15", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+144, 28, 18, sheet10_P15, "sheet10_P15", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+148, 77, 10, sheet10_D16, "sheet10_D16", "cell_style_9");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+187, 47, 18, sheet10_C19, "sheet10_C19", "cell_style_19");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+187, 28, 18, sheet10_P19, "sheet10_P19", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+191, 17, 10, sheet10_D20, "sheet10_D20", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+201, 77, 4, "", "sheet10_D21", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+205, 50, 18, sheet10_A22, "sheet10_A22", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+205, 47, 18, sheet10_C22, "sheet10_C22", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+205, 77, 4, "", "sheet10_D22", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+205, 28, 18, sheet10_P22, "sheet10_P22", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+209, 25, 10, sheet10_D23, "sheet10_D23", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+219, 77, 4, "", "sheet10_D24", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+223, 50, 18, sheet10_A25, "sheet10_A25", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+223, 47, 18, sheet10_C25, "sheet10_C25", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+223, 77, 4, "", "sheet10_D25", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+223, 28, 18, sheet10_P25, "sheet10_P25", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+227, 12, 10, "", "sheet10_D26", "cell_style_20");
		objectWrite(CELL_OBJECT, nXCurPos+159, nYCurPos+227, 2, 10, "", "sheet10_E26", "cell_style_21");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+237, 77, 4, "", "sheet10_D27", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+241, 50, 18, sheet10_A28, "sheet10_A28", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+241, 47, 18, sheet10_C28, "sheet10_C28", "cell_style_4");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+241, 77, 4, "", "sheet10_D28", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+241, 28, 18, sheet10_P28, "sheet10_P28", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+245, 12, 10, "", "sheet10_D29", "cell_style_20");
		objectWrite(CELL_OBJECT, nXCurPos+159, nYCurPos+245, 2, 10, "", "sheet10_E29", "cell_style_21");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+284, 47, 18, sheet10_C32, "sheet10_C32", "cell_style_19");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+284, 28, 18, sheet10_P32, "sheet10_P32", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+288, 25, 10, sheet10_D33, "sheet10_D33", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+298, 77, 4, sheet10_D34, "sheet10_D34", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+302, 50, 18, sheet10_A35, "sheet10_A35", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+302, 47, 18, sheet10_C35, "sheet10_C35", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+302, 77, 4, "", "sheet10_D35", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+302, 28, 18, sheet10_P35, "sheet10_P35", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+306, 30, 10, sheet10_D36, "sheet10_D36", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+316, 77, 4, "", "sheet10_D37", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+320, 50, 18, sheet10_A38, "sheet10_A38", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+320, 47, 18, sheet10_C38, "sheet10_C38", "cell_style_4");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+320, 77, 4, "", "sheet10_D38", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+320, 28, 18, sheet10_P38, "sheet10_P38", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+324, 32, 10, "", "sheet10_D39", "cell_style_9");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+363, 47, 18, sheet10_C42, "sheet10_C42", "cell_style_19");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+363, 28, 18, sheet10_P42, "sheet10_P42", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+367, 25, 10, sheet10_D43, "sheet10_D43", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+377, 77, 4, "", "sheet10_D44", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+381, 50, 18, sheet10_A45, "sheet10_A45", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+381, 47, 18, sheet10_C45, "sheet10_C45", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+381, 77, 4, "", "sheet10_D45", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+381, 28, 18, sheet10_P45, "sheet10_P45", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+385, 17, 10, "", "sheet10_D46", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+395, 77, 4, "", "sheet10_D47", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+399, 50, 18, sheet10_A48, "sheet10_A48", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+399, 47, 18, sheet10_C48, "sheet10_C48", "cell_style_4");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+399, 77, 4, "", "sheet10_D48", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+399, 28, 18, sheet10_P48, "sheet10_P48", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+403, 12, 10, "", "sheet10_D49", "cell_style_9");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+442, 47, 18, sheet10_C52, "sheet10_C52", "cell_style_19");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+442, 28, 18, sheet10_P52, "sheet10_P52", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+446, 20, 10, sheet10_D53, "sheet10_D53", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+456, 77, 4, "", "sheet10_D54", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+460, 50, 18, sheet10_A55, "sheet10_A55", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+460, 47, 18, sheet10_C55, "sheet10_C55", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+460, 77, 4, "", "sheet10_D55", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+460, 28, 18, sheet10_P55, "sheet10_P55", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+464, 12, 10, "", "sheet10_D56", "cell_style_20");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+474, 77, 4, "", "sheet10_D57", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+478, 50, 18, sheet10_A58, "sheet10_A58", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+478, 47, 18, sheet10_C58, "sheet10_C58", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+478, 77, 4, "", "sheet10_D58", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+478, 28, 18, sheet10_P58, "sheet10_P58", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+482, 25, 10, sheet10_D59, "sheet10_D59", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+492, 77, 4, "", "sheet10_D60", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+496, 50, 18, sheet10_A61, "sheet10_A61", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+496, 47, 18, sheet10_C61, "sheet10_C61", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+496, 77, 4, "", "sheet10_D61", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+496, 28, 18, sheet10_P61, "sheet10_P61", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+500, 30, 10, sheet10_D62, "sheet10_D62", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+510, 77, 4, "", "sheet10_D63", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+514, 50, 18, sheet10_A64, "sheet10_A64", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+514, 47, 18, sheet10_C64, "sheet10_C64", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+514, 77, 4, "", "sheet10_D64", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+514, 28, 18, sheet10_P64, "sheet10_P64", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+518, 35, 10, sheet10_D65, "sheet10_D65", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+528, 77, 4, "", "sheet10_D66", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+532, 50, 18, sheet10_A67, "sheet10_A67", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+532, 47, 18, sheet10_C67, "sheet10_C67", "cell_style_5");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+532, 77, 4, "", "sheet10_D67", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+532, 28, 18, sheet10_P67, "sheet10_P67", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+536, 25, 10, sheet10_D68, "sheet10_D68", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+546, 77, 4, "", "sheet10_D69", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+550, 50, 18, sheet10_A70, "sheet10_A70", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+550, 47, 18, sheet10_C70, "sheet10_C70", "cell_style_4");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+550, 77, 4, "", "sheet10_D70", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+550, 28, 18, sheet10_P70, "sheet10_P70", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+554, 17, 10, "", "sheet10_D71", "cell_style_9");
		...
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+593, 47, 18, sheet10_C74, "sheet10_C74", "cell_style_17");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+593, 28, 18, sheet10_P74, "sheet10_P74", "cell_style_7");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+597, 20, 10, sheet10_D75, "sheet10_D75", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+607, 77, 4, "", "sheet10_D76", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+611, 50, 18, sheet10_A77, "sheet10_A77", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+611, 47, 18, sheet10_C77, "sheet10_C77", "cell_style_3");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+611, 77, 4, "", "sheet10_D77", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+611, 28, 18, sheet10_P77, "sheet10_P77", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+615, 14, 10, "", "sheet10_D78", "cell_style_20");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+625, 77, 4, "", "sheet10_D79", "cell_style_10");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+629, 50, 18, sheet10_A80, "sheet10_A80", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+100, nYCurPos+629, 47, 18, sheet10_C80, "sheet10_C80", "cell_style_14");
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+629, 77, 4, "", "sheet10_D80", "cell_style_6");
		objectWrite(CELL_OBJECT, nXCurPos+224, nYCurPos+629, 28, 18, sheet10_P80, "sheet10_P80", "cell_style_11");
		...
		objectWrite(CELL_OBJECT, nXCurPos+147, nYCurPos+633, 17, 10, sheet10_D81, "sheet10_D81", "cell_style_9");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+647, 252, 25, sheet10_A83, "sheet10_A83", "cell_style_16");
		objectWrite(CELL_OBJECT, nXCurPos+252, nYCurPos+647, 65, 25, sheet10_Q83, "sheet10_Q83", "cell_style_22");
		...
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+672, 252, 24, sheet10_A84, "sheet10_A84", "cell_style_23");
		objectWrite(CELL_OBJECT, nXCurPos+252, nYCurPos+672, 65, 24, sheet10_Q84, "sheet10_Q84", "cell_style_24");
		objectWrite(CELL_OBJECT, nXCurPos+317, nYCurPos+672, 94, 24, sheet10_R84, "sheet10_R84", "cell_style_23");
		objectWrite(CELL_OBJECT, nXCurPos+411, nYCurPos+672, 94, 24, sheet10_S84, "sheet10_S84", "cell_style_23");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+705, 411, 13, sheet10_A86, "sheet10_A86", "cell_style_25");
		objectWrite(CELL_OBJECT, nXCurPos+411, nYCurPos+705, 94, 26, sheet10_S86, "sheet10_S86", "cell_style_26");
		objectWrite(CELL_OBJECT, nXCurPos, nYCurPos+718, 411, 13, sheet10_A87, "sheet10_A87", "cell_style_27");
	...
	private void initConstVarientEx(){
		...
		sheet10_A86="HTML VIVEWER SAMPLE PAGE";
		sheet10_S86="#PAGE";
	}
