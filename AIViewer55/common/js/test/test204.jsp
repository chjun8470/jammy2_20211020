...
<%!
private Logger logger = Logger.getLogger("test204.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+80, nYCurPos+126, 268, 166, "", "AI_IMAGE_OBJ2", "draw_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|4|test204.style|보고서 (2013/5/6 19:31:31)", false);
