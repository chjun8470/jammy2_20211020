...
<%!
private Logger logger = Logger.getLogger("test202.jsp");
class ReportHandler{
	//공통 변수 선언
		...
		while(SQL_Table1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_r1[0]=0;
					nAutoHeight_r1[0]=manager.scriptObject.HtmlDataPrintHeightEx(nYEndPos-nYCurPos, nAutoHeight_r1[0], sheet10_B1_Split, "sheet10_B1");
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|2|test202.style|보고서 (2013/4/17 21:20:13)", false);
