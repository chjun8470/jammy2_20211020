...
<%!
private Logger logger = Logger.getLogger("test206.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptVoidBand100( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+51, nYCurPos+28, 358, 575, "", "AI_IMAGE_OBJ6", "draw_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|6|test206.style|보고서 (2013/5/6 19:31:31)", false);
