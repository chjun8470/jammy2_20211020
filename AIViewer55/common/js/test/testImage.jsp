...
************************************************************************************
보고서 제목 : 보고서 (2013/4/23 15:3:24)
작성일 : 2013년4월23일 15시3분24초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("testImage.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+51, nYCurPos+73, 320, 199, "", "AI_IMAGE_OBJ1", "draw_style_0");
		objectWrite(DRAW_OBJECT, nXCurPos+63, nYCurPos+330, 306, 136, "", "AI_IMAGE_OBJ2", "draw_style_1");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|1|testImage.style|보고서 (2013/4/23 15:3:24)", false);
