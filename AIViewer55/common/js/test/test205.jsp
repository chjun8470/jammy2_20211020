...
************************************************************************************
보고서 제목 : 보고서 (2013/5/6 19:31:31)
작성일 : 2013년5월6일 19시31분31초
작성자 :
************************************************************************************/
%>
...
<%!
private Logger logger = Logger.getLogger("test205.jsp");
class ReportHandler{
	//공통 변수 선언
	...
	private void writeScriptv1( ) throws Exception{
		//스크립트문 생성
		objectWrite(DRAW_OBJECT, nXCurPos+107, nYCurPos+124, 208, 118, AI_BARCODE_OBJ4, "AI_BARCODE_OBJ4", "draw_style_0");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|5|test205.style|보고서 (2013/5/6 19:31:31)", false);
