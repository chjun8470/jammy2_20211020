...
{
    if (e.origin == "http://localhost:8085" || e.origin == "http://192.168.0.27:8085" || e.origin.indexOf("file:") > -1)
    {
        var jsonObject = null;
...
function contentDocument(eid, command)
{
	...
	parent.contentWindow.postMessage(JSON.stringify(jsonObject), "http://192.168.0.27:8085");
}
