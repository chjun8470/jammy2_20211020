					...
					<div class="search_box" style="padding:10px">
						<div class="board-search">
							<select name="searchType" id="searchType" class="select">
								<option value="LEGALNM" <%if(util.getStr(paramMap.get("searchType")).equals("LEGALNM")) { %> selected="selected" <% } %>>법정검사명</option>
								<option value="USER" <%if(util.getStr(paramMap.get("searchType")).equals("USER")) { %> selected="selected" <% } %>>신청자</option>
								<option value="CORP" <%if(util.getStr(paramMap.get("searchType")).equals("CORP")) { %> selected="selected" <% } %>>기관명</option>
								<option value="type1" <%if(util.getStr(paramMap.get("searchType")).equals("type1")) { %> selected="selected" <% } %>>등록자</option>
								<option value="type2" <%if(util.getStr(paramMap.get("searchType")).equals("type2")) { %> selected="selected" <% } %>>등록기관</option>
								<option value="type3" <%if(util.getStr(paramMap.get("searchType")).equals("type3")) { %> selected="selected" <% } %>>등록부서</option>
							</select>
							<!-- 키워드 -->
