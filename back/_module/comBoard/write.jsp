	          ...
	          <tbody>
	            ...
	            <tr>
	              ...
	              <td class="con-txt">
	              	...
	              	<textarea name="contents" id="contents" style="width:100%;height:350px;display:none;"></textarea>
	              </td>
	            </tr>
					...
					for(HashMap rs:fileList){ %>
						<%String fileParam = "?dataGrp="+util.getStr(rs.get("DATA_GRP"))
                  		...
                  		<li class="text">
                  			...
                  			<a href="/biz/cmm/fms/ComFileDown.do<%=fileParam%>"><%=util.deStr(rs.get("FILE_ORGN_NM")) %> (<%=util.getStr(rs.get("FILE_SIZE")) %> Byte)</a>
