		...
		<table class="skin_basic_write" summary="작성하기로  제목, 태그, 첨부파일, 시스템설명(툴팁)을 제공합니다.">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="subject" id="subject" value="" class="inp_text" style="width: 95%;" maxlength="100" />
					</td>
				</tr>
				<tr>
					<th class="tit">
					...
					<td>
						<input type="text" name="proExpense" id="proExpense" value="" class="inp_text" style="width: 95%;" maxlength="10" />
					</td>
				</tr>
				<tr>
					<th class="tit">
					...
					<td>
						<input type="text" name="recStDt" id="recStDt" class="inp_text" value="" /> ~
						<input type="text" name="recEdDt" id="recEdDt" class="inp_text" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="proStDt" id="proStDt" class="inp_text" value="" /> ~
						<input type="text" name="proEdDt" id="proEdDt" class="inp_text" value="" />
					</td>
				</tr>
				<tr>
					<th class="col">
					...
					<td class="r_line_none p_top_btm_6">
						<input type="text" name="supportPlace" id="supportPlace" value="" class="inp_text b_txtbox1" />
					</td>
				</tr>
				<tr>
					...
					<td class="r_line_none p_top_btm_6">
						<span id="orgGroupTd">
							<input type="text" name="OwnOrgNm" id="OwnOrgNm" value="<%=util.getStr(loginVO.getOrgNm())%>" class="inp_text b_txtbox1" style="width:30%;" placeholder=" 기관검색버튼을 클릭해주세요."/>&nbsp;
							<input type="hidden" name="OwnOrg" id="OwnOrg" value="<%=util.getStr(loginVO.getOrgGrpCd())%>"/>
						...
						<span>
							<input type="text" name="OwnDeptNm" id="OwnDeptNm" value="" class="inp_text b_txtbox1" style="width:30%;" placeholder=" 부서검색버튼을 클릭해주세요."/>&nbsp;
				...
				<tr>
					...
					<td class="r_line_none p_top_btm_6">
						<table>
							<tr><th>성       명</th><td><input type="text" name="proChargeNm" id="proChargeNm" value="" class="inp_text b_txtbox1" /></td></tr>
							<tr><th>직       위</th><td><input type="text" name="proChargePosition" id="proChargePosition" value="" class="inp_text b_txtbox1" /></td></tr>
							<tr><th>전       화</th><td><input type="text" name="proChargeTel" id="proChargeTel" value="" class="inp_text b_txtbox1" maxlength="11"/></td></tr>
							<tr><th>이  메  일</th><td><input type="text" name="proChargeEmail" id="proChargeEmail" value="" class="inp_text b_txtbox1" /></td></tr>
						</table>
					</td>
				</tr>
				<tr>
