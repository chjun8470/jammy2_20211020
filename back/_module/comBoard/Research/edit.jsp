	          ...
	          <tbody>
	            ...
	            <tr>
	              ...
	              <td>
	              	...
	              	<br/>
	              	<br/>
	              	EMAIL : <input type="text" name="email01" id="email01" value="<%=util.getStr(dataMap.get("DATA08")) %>" style="width:15%;" maxlength="100" title="이메일 입력" /> @ <input type="text" name="email02" id="email02" style="width:150px;" value="<%=util.getStr(dataMap.get("DATA09")) %>">
	            ...
	            <tr>
	              <th scope="row" class="tit"><span style="color:red;"> * </span><label for="pollstart">기간</label></th>
	              <td>
