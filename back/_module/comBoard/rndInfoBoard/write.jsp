		...
		<table class="skin_basic_write">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="b_type" id="b_type1" value="1" checked />정부R&D</label>
						<label><input type="radio" name="b_type" id="b_type2" value="2" />전남R&D</label>
					</td>
				</tr>
				<tr>
					<th scope="row" class="tit"><span
				...
				<tr>
					<th scope="row" class="tit"><span
						style="color: red; font-size: 11pt;">*</span> <label for="sdate">접수일정</label>
					</th>
					<td>
				...
				<tr class="hidetr hide2" style="display:none;">
					<th scope="row" class="tit"><span
						style="color: red; font-size: 11pt;">*</span> <label for="b_part">지원기관</label>
					</th>
					<td>
				...
				<tr>
					<th scope="row" class="tit"><label for="subject">지원대상 기업업력</label>
					</th>
					<td>
