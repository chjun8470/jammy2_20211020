				...
				<div class="box_in" style="width:100%;">
					<table id="step1" summary="연구장비의 상세정보입력" class="skin_basic_write">
                		...
                		<tr style="display:none" id="warrantyTR">
                			...
                			<td>
                				<input class="inp_txt" type="text" id="equipWarranty" name="equipWarranty" value="" maxlength="10"/> 년
                			</td>
                		</tr>
	                ...
	                <table id ="step2" summary="연구장비의 상세정보입력" class="skin_basic_write">
						...
						<tr>
							...
							<td>
								...
								<select class="p_select" name="areaSigungu1" id="utilitysearchArea1">
								...
								<select class="p_select" name="areaSigungu2" id="utilitysearchArea2" style="display:none;">
									<option value="">선택하세요</option>
									<%
                		...
                		<tr>
                			...
                			<td>
	                			<div>
									<input class="inp_txt" type="text" value="" name = "location" id = "location" style="width:255px;" maxlength="100" readonly="readonly" />
	                				<input class="inp_txt" type="text" value="" name = "locationDtl" id = "locationDtl" style="width:255px;" maxlength="100" />
						...
						<tr>
							...
							<td>
								...
								<input readonly="readonly" class="inp_txt" type="text" name="ownOrgNm" id="orgNm" style="width:30%;" maxlength="20" onkeydown='$("#orgGrpCd").val("")'/>
								<input type="button" name="orgData" id="orgData" class="btn_inp_g_01" value="보유기관 조회" onclick="popupWindow('orgManagePop')">
								<% } else { %>
								<input class="inp_txt" type="hidden" name="ownOrg" id="orgGrpCd" maxlength="20" value="<%=util.getStr(loginVO.getOrgGrpCd()) %>" />
								<input readonly="readonly" class="inp_txt" type="text" name="ownOrgNm" id="orgNm" style="width:30%;" maxlength="20" onkeydown='$("#orgGrpCd").val("")' value="<%=util.getStr(loginVO.getOrgNm()) %>"/>
								<% } %>
						...
						<tr>
							...
							<td>
								...
								<input readonly="readonly" class="inp_txt" type="text" name="ownOrgSubNm" id="orgSubNm" style="width:30%;" maxlength="20" onkeydown='$("#orgSubGrpCd").val("")'/>
								<input type="button" name="orgSubData" id="orgSubData" class="btn_inp_g_01" value="보유부서 조회" onclick="popupWindow('orgSubManagePop')">
								<% } else { %>
								<input class="inp_txt" type="hidden" name="ownOrgSub" id="orgSubGrpCd" maxlength="20" value="<%=loginVO.getOrgGrpSubCd() %>" />
									<%if(loginVO.getOrgGrpSubCd().contains("ORG")) { %>
								<input readonly="readonly" class="inp_txt" type="text" name="ownOrgSubNm" id="orgSubNm" style="width:30%;" maxlength="20" onkeydown='$("#orgSubGrpCd").val("")' value="<%=loginVO.getAuthOrgNm() %>"/>
									<% } else { %>
								<input readonly="readonly" class="inp_txt" type="text" name="ownOrgSubNm" id="orgSubNm" style="width:30%;" maxlength="20" onkeydown='$("#orgSubGrpCd").val("")' value="<%=loginVO.getAuthSubOrgNm() %>"/>
									<% } %>
								<% } %>
 								<!--<input type="text" name = "ownOrg" id = "ownOrg" maxlength="20"/> -->
							</td>
                			...
                			<td>
	                			...
	                			<table class="skin_basic_write">
	                				<tr>
	                					...
	                					<td style="width:200px;">
	                						<input class="inp_txt" type="text" name="operOrgGrpSub" id="operDeptTd"value="<%=deptNm%>" style="border-width:0px; width:200px;" readonly>
	                					</td>
	                				</tr>
	                				<tr>
	               ...
	               <table id ="step3" summary="연구장비의 상세정보입력" class="skin_basic_write">
						...
						<tr>
							...
							<td>
								<textarea id="howUse" name="howUse" title="이용안내" style="width:100%;" rows="10" cols="10" ></textarea>
							</td>
						</tr>
						<tr>
							<th scope="row">
