				...
				<div class="fr">
					...
					<table class="skin_basic_write">
						...
						<tbody>
							...
							<tr>
								<th scope="col">
									<label for="orgGrpNm"><span class="required">*</span>기업명(국문)</label>
								</th>
							...
							<tr>
								<th scope="col"><label for="corpNum2">법인등록번호</th>
							...
							<tr>
								<th scope="col"><label for="<%=fileFullGrp%>File1">기업 소개자료</label></th>
								<td colspan="3">
