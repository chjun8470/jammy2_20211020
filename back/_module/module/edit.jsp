	  ...
	  <form name="fedit" id="fedit" action="./moduleProc.do" method="post" enctype="multipart/form-data" onsubmit="return submitGo();" >
		...
		<div class="skin_bbs_write" style="margin-top:30px">
			...
			<tr>
				...
				<td scope="col"><input class="inp_text" type="text" name="mbNm" id="mbNm" value="<%=util.getStr(dataMap.get("MB_NM")) %>" size="50"/></td>
			</tr>
			<tr>
				<th scope="col"><label for="mbUrl">주소(URL)</label></th>
				<td><input type="text" class="inp_text" name="mbUrl" id="mbUrl" value="<%=util.getStr(dataMap.get("MB_URL")) %>" size="50"/></td>
			</tr>
			<tr>
