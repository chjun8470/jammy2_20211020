...
<form name="fwrite" id="fwrite" action="<%=myPage%>" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="orgGrpCd" id="orgGrpCd" value="<%=util.getStr(loginVO.getOrgGrpCd())%>" onChange="orgInfo()" />
		...
		<table class="skin_basic_write">
			...
			<tbody>
				...
				<tr>
					...
					<th class="th" style="align: center; valign: middle">
						<span style="color: red; font-size: 10pt;">*</span>
						 외국인여부
					</th>
					<td class="td">
				...
				<tr>
					...
					<td class="td" colspan="3">
						<input type="hidden" name="userId" maxlength="20" value="" id="userId" class="inp_txt" title="사용자ID" readonly="readonly">
						...
						<input type="button" id="btnCheckUserId" class="btn_inp_b_01" value="중복확인" onclick="userCheck()" title="아이디 중복 확인">
						<br />
				...
				<tr>
					...
					<td class="td">
						<span id="inTel">
							...
							<input type="text" name="telNo2" style="width: 50px" maxlength="4" value="" id="telNo2" class="inp_txt" title="사무실전화 앞번호">
							-
							<input type="text" name="telNo3" style="width: 50px" maxlength="4" value="" id="telNo3"	class="inp_txt" title="사무실전화 뒷번호">
						</span>
					</td>
					<th class="th">
						<span style="color: red; font-size: 10pt;">*</span>
					...
					<td class="td">
						<span id="inCp">
							...
							<input type="text" name="cpNo2" style="width: 50px" maxlength="4" value="" id="cpNo2" class="inp_txt" title="휴대폰 앞번호">
								-
							<input type="text" name="cpNo3" style="width: 50px" maxlength="4" value="" id="cpNo3" class="inp_txt" title="휴대폰 뒷번호">
						</span>
					</td>
				</tr>
				<tr>
 ...
 %>
				...
				<tr id="orgInfo1">
					...
					<td class="td" colspan="3">
						<input type="text" id="orgGrpNm" name="orgGrpNm" class="inp_txt" value="<%=util.getStr(loginVO.getOrgNm())%>" title="기관명" style="width: 80%;" readonly="readonly">
					</td>
				</tr>
				<tr id="orgInfo2">
					<th class="th" id="deptNmTh">
						<span style="color: red; font-size: 10pt;">*</span>
						부서명
					</th>
					<td id="deptNmTd">
					...
					<td class="td">
						<input type="text" name="positionNm" id="positionNm" class="inp_txt" title="직위" maxlength="10" />
					</td>
				</tr>
			</tbody>
		</table>
