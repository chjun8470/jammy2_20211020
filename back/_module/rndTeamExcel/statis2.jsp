...
<%
	...
	for(HashMap rs:rndSumPriceList3) {
		...
		data += "{";
		data += "name:'"+util.getStr(rs.get("T6_TYPE1"))+"',";
		data += "y:"+util.getStr(rs.get("TOTAL_PRICE"))+"";
		data += "}";
		
		category += " '"+util.getStr(rs.get("T6_TYPE1"))+"'";
...
<div>
	<a href="/sys/sys_smb_statis.do?mode=statis">과학기술표준분류</a>
	<a href="/sys/sys_smb_statis.do?mode=statis1">중점과학기술분류</a>
	<a href="/sys/sys_smb_statis.do?mode=statis2">6T관련기술분류--**</a>
</div>
