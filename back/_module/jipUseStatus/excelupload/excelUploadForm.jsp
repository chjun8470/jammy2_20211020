...
<hr/>
	<div class="search-box" style="margin-top: 10px;">
		...
		<div style="float: right">
			...
			<input type="button" class="btn_inp_b_01" onclick ="location.href='./getJipTemPlateFile.do'" value="입력양식다운로드" title="입력양식다운로드">
		</div>
		</fieldset>
	</div>
<br />
...
<div align="right">
	<input type="button" class="btn_inp_w_01" onclick ="location.href='./sys_jip_status.do'" value="목록" title="목록">
</div>
