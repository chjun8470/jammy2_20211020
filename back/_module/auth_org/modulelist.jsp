...
<%
	...
	%>
		...
		<div class="menuRows_1"  style="position:relative;">
			<input type="button" value="&gt;" class="btn_y_01" onclick="orgModuleDel('<%=util.getStr(rs.get("MODULE_INFO_IDX"))%>')" style="position:absolute;top:20px;right:10px;width:30px;min-width:30px;z-index:8;"/>
			&nbsp;
