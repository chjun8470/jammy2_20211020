		...
		<div class="skin_bbs_write" style="margin-top:30px">
                			...
                			<td scope="col" colspan="3" id="sampleBox" >
		                			...
		                			%>
										<div id="sampleItem<%=i%>" >
											...
											<% if( i == 1 ){ %>
												<button class="b_btn_00401" type="button" onclick="sampleBox('p');" title="시료항목 추가"><img src="/img/board/btn_plus.gif" style="width:20px;" /></button>
												<button class="b_btn_00401" type="button" onclick="sampleBox('m');" title="시료항목 감소"><img src="/img/board/btn_del.gif" style="width:20px;" /></button>
											<% } %>
										</div>
									<% } %>
							</td>
	        ...
	        <div class="btn_box">
	        	<div class="btn_right_box">
		        	<input type="button" class="btn_inp_b_01" value="이용승인" id="btn_submit"  class="btn_submit" style="cursor: pointer;" onclick="reservationGo()"/>
