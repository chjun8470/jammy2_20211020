	...
	<table class="skin_basic_write" >
        ...
        <tbody>
           	...
           	<tr>
           		...
           		<td colspan="3">
           			<label><input type="radio" name="typeA" value="주요R&D" checked="checked"> 주요R&D</label>
           			<label><input type="radio" name="typeA" value="일반R&D"> 일반R&D</label>
           			<label><input type="radio" name="typeA" value="순도비R&D"> 순도비R&D</label>
           		</td>
           	</tr>
           	<tr>
           	...
           	<tr>
           		...
           		<td colspan="3">
           			시작 : <input type="text" name="sdate" id="S_DATE" class="inp_txt read_only" readonly value=""/>
           			종료 : <input type="text" name="edate" id="E_DATE" class="inp_txt read_only" readonly value=""/>
           		</td>
           	</tr>
           	<tr>
           		<th scope="row" class="tit"><span style="color:red;" >*</span> 총사업비</th>
           		<td colspan="3">
           			<input type="text" name="btprice" id="B_TPRICE" class="inp_txt" value=""/>(단위:100만원)
           		</td>
           	</tr>
           	<tr>
           		<th scope="row" class="tit"><span style="color:red;" >*</span> 연차계속</th>
           		<td>
           			<label><input type="radio" name="yeartype" value="단년사업" checked="checked"> 단년사업</label>
           			<label><input type="radio" name="yeartype" value="연차사업"> 연차사업</label>
           			<label><input type="radio" name="yeartype" value="연차계속사업"> 연차계속사업</label>
           		</td>
           	</tr>
           	<tr>
           		<th scope="row" class="tit"><span style="color:red;" >*</span> 사업(과제)정보출처</th>
           		<td colspan="3">
           			<label><input type="checkbox" name="bch1" value="시행계획"> 시행계획</label>
           			<label><input type="checkbox" name="bch2" value="NTIS"> NTIS</label>
           			<label><input type="checkbox" name="bch3" value="연지단"> 연지단</label>
           			<label><input type="checkbox" name="bch4" value="전남도"> 전남도</label>
           		</td>
           	</tr>
           	<tr>
           		<th scope="row" class="tit"><span style="color:red;" >*</span> 사업(과제)정보확정</th>
           		<td colspan="3">
           			입력 : <input type="text" name="bsd" id="B_SD" class="inp_txt read_only" readonly value=""/>
           			확정 : <input type="text" name="bed" id="B_ED" class="inp_txt read_only" readonly value=""/>
           		</td>
           	</tr>
           	<tr>
			...
			<tbody>
	            <tr >
	         	...
	         	<tr>
	         		...
	         		<td>
	         			시작 : <input type="text" name="bissdate" id="BIS_SDATE_<%=scCnt%>" class="inp_txt read_only" readonly value=""/>
	          			종료 : <input type="text" name="bisedate" id="BIS_EDATE_<%=scCnt%>" class="inp_txt read_only" readonly value=""/>
	         		</td>
	         	</tr>
	         	<tr>
	         		<th scope="row" class="tit"><span style="color:red;" >*</span> 재원구분</th>
	         		<td>
	         			<label><input type="radio" name="bistype_<%=scCnt%>" id="" value="일반회계" checked="checked"> 일반회계</label>
	           			<label><input type="radio" name="bistype_<%=scCnt%>" id="" value="특별회계"> 특별회계</label>
	           			<label><input type="radio" name="bistype_<%=scCnt%>" id="" value="기금"> 기금</label>
	         		</td>
	         	</tr>
	         	<tr>
	         		<th scope="row" class="tit"><span style="color:red;" >*</span> 당해년도 사업비</th>
	         		<td class="padding_none">
	         			<p><span>국비 : </span><input type="number" name="bisprice_1" class="inp_txt"> (단위:100만원)</p>
	         			<p><span>지방비 : </span><input type="number" name="bisprice_2" class="inp_txt"> (단위:100만원)</p>
	         			<p><span>기타 : </span><input type="number" name="bisprice_3" class="inp_txt"> (단위:100만원)</p>
	         			<p><span>합계 : </span><input type="number" name="bisprice_4" class="inp_txt read_only" readonly> (단위:100만원)</p>
	         		</td>
	         	</tr>
	   		</tbody>
		</table>
	...
	<table class="skin_basic_write" >
        ...
        <tbody>
           	...
           	<tr>
           		...
           		<td colspan="3">
           			<label><input type="radio" name="deptype" value="1" checked="checked" onclick="areaClick('depcode','1')"> 광역지자체</label>
           			<label><input type="radio" name="deptype" value="2" onclick="areaClick('depcode','2')"> 전라남도</label>
           	...
           	<tr>
           		...
           		<td colspan="3">
           			<label><input type="radio" name="busimptype" value="1" checked="checked" onclick="areaClick('busimpcode','1')"> 광역지자체</label>
           			<label><input type="radio" name="busimptype" value="2" onclick="areaClick('busimpcode','2')"> 전라남도</label>
           	...
           	<tr>
           		...
           		<td colspan="3">
           			<input type="text" name="mail1" id="mail1" value="" class="inp_txt" style="width:15%"  maxlength="20" title="이메일아이디"> @
					<input type="text" name="mail2" id="mail2" value="" class="inp_txt" style="width:15%"  maxlength="50" title="이메일도메인">
