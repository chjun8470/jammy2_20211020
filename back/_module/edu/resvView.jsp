...
<form id = "fview" name = "fview" method="post" action="/sys/sys_edu.do" enctype="multipart/form-data">
				...
				<div class="box_in" style="width:80%">
					...
					<table id="step1" class="skin_basic_write">
						...
						<tr>
							...
							<td class="top_sell brn">
								<%=util.getStr(userDataMap.get("PSN_NM"))%>
							</td>
							<th scope="col" class="top_sell bln">성별</th>
							<td class="top_sell brn">
								<%=util.getStr(userDataMap.get("GENDER_TYPE_CD"))%>
							</td>
						</tr>
						<tr>
