						...
						<tbody>
							...
							<tr>
								...
								<td scope="col" id="orgTd1" colspan="3">
									...
									<input type="text" class="inp_txt" id="orgGrpNm" name="orgGrpNm" maxlength="30" style="width:70%;"/>
							...
							<tr>
								<th scope="col" id="orgTd2" style="display: none;">
									<label for="orgEngNm">기관명(영문)</label>
								</th>
								<td colspan="3" id="orgTd3" style="display: none;">
									<input type="text" class="inp_txt" id="orgEngNm" name="orgEngNm" maxlength="30" style="width:90%;"/>
								</td>
							</tr>
							<!--
							<tr>
								<th scope="col"><label for="orgGrpNm"><span class="required">*</span>기업/기관명</label></th>
								<td scope="col"><input type="text" class="inp_txt" id="orgGrpNm" name="orgGrpNm" maxlength="30" size="30"></td>
								<th scope="col" style="display: none;" id="orgEngNmLine"><label for="orgEngNm">기관명(영문)</label></th>
								<td scope="col" id="orgEngNmILine" style="display: none;"><input type="text" class="inp_txt" id="orgEngNm" name="orgEngNm" maxlength="30" size="30"></td>
							</tr>
							-->
							<tr>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="inp_txt" id="ornerNm" name="ornerNm" maxlength="10" style="width:35%;"/></td>
							</tr>

							<tr>
								<th scope="col"><label for="corpNum1"><span class="required">*</span>사업자등록번호</label></th>
								<td scope="col" id="corpTd1" colspan="3">
									<input type="hidden" class="inp_txt" id="corpNum1" name="corpNum1" maxlength="20" readonly="readonly"/>
									<input type="hidden" id="checkCorpNum1R" name="checkCorpNum1R" />
									<input type="text" class="inp_txt" id="corpNum1Part1" name="corpNum1Part1" maxlength="3" /> -
									<input type="text" class="inp_txt" id="corpNum1Part2" name="corpNum1Part1" maxlength="2" /> -
									<input type="text" class="inp_txt" id="corpNum1Part3" name="corpNum1Part1" maxlength="5" />
									<input type="button" class="btn_inp_b_01" value="중복체크" onclick="checkCorpNum1()" />
								</td>
							</tr>
							<tr>
								<th scope="col"><label for="corpNum2">법인등록번호</label></th>
								<td scope="col" id="corpTd4" colspan="3">
									<input type="text" class="inp_txt" id="corpNum2" name="corpNum2" maxlength="20" style="width:260px;"/>
								</td>
							</tr>
							<tr>
								<th scope="col">
								...
								<td colspan="3">
									<input type="text" id="dateOfFoundation" name="dateOfFoundation" class="inp_txt" value="" readonly="readonly" />
								</td>
							</tr>
							<tr>
								<th scope="col" id="corpTd2"><label for="workType">업종</label></th>
								<td scope="col" id="corpTd3">
									<input type="text" class="inp_txt" id="workType" name="workType" maxlength="20" style="width:90%;"/>
								</td>
								<th scope="col" id="corpTd5"><label for="businessCon">업태</label></th>
								<td scope="col" id="corpTd6"><input type="text" class="inp_txt" id="businessCon" name="businessCon" maxlength="20" style="width:90%;"/></td>
							</tr>
							<tr>
								<th scope="col"><label for="corpPhone"><span class="required">*</span>대표전화</label></th>
								<td ><input type="text" class="inp_txt" id="corpPhone" name="corpPhone" maxlength="20" style="width:90%;"/>
									<br />
								...
								<td ><input type="text" class="inp_txt" id="corpFax" name="corpFax" maxlength="20" style="width:90%;"/>
									<br />
									<span style="font-weight:bold;color:#ff0000;" >예제)1588-1234 예제)061-777-7777</span>
								</td>
							</tr>
							<tr>
								...
								<td colspan="3"><input type="text" class="inp_txt" id="homepage" name="homepage" maxlength="50" style="width:35%;"/></td>
							</tr>
							<tr>
								<th scope="col"><label for="addr1"><span class="required">*</span>주소</label></th>
								<td colspan="3">
									<input type="text" class="inp_txt" id="zipcode" name="zipcode" maxlength="10" readonly="readonly">
									<input type="text" class="inp_txt" id="addr1" name="addr1" maxlength="50" readonly="readonly" style="width:37%;"/>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="inp_txt" id="addr2" name="addr2" maxlength="50" size="50" style="width:90%;"/></td>
							</tr>
							<tr style="display:none" id="userIdxTr">
								...
								<td colspan="3">
									...
									<input type="text" class="inp_txt" id="name" name="name" maxlength="15" style="width:17%;"/>
							...
							<tr>
								...
								<td colspan="3">
									<input type="hidden" class="inp_txt" id="mapX" name="mapX" maxlength="20">
									<input type="hidden" class="inp_txt" id="mapY" name="mapY" maxlength="20">
							...
							<tr id="labNameLine" style="display:none;">
								...
								<td colspan="3"><input type="text" class="inp_txt" id="labName" name="labName" maxlength="100" style="width:100%;"/></td>
							</tr>
							<tr id="labFaxLine" style="display:none;">
								<th scope="col"><label for="labPhone">연구소 전화번호</label></th>
								<td scope="col">
									<input type="text" class="inp_txt" id="labPhone" name="labPhone" maxlength="20" style="width:90%;"/>
									<br />
									<span style="font-weight:bold;color:#ff0000;" >예제)1588-1234 예제)061-777-7777</span>
								</td>
								<th scope="col"><label for="labFax">연구소 FAX</label></th>
								<td scope="col"><input type="text" class="inp_txt" id="labFax" name="labFax" maxlength="20" style="width:90%;"/>
									<br />
									<span style="font-weight:bold;color:#ff0000;" >예제)1588-1234 예제)061-777-7777</span>
								</td>
							</tr>
							<tr id="labAddr1Line" style="display:none;">
								...
								<td colspan="3">
									<input type="text" class="inp_txt" id="labZipcode" name="labZipcode" maxlength="10" readonly="readonly" />
									<input type="text" class="inp_txt" id="labAddr1" name="labAddr1" maxlength="50" size="50" readonly="readonly" />
							...
							<tr id="labAddr2Line" style="display:none;">
								...
								<td colspan="3"><input type="text" class="inp_txt" id="labAddr2" name="labAddr2" maxlength="50" style="width:100%;" /></td>
							</tr>
							<tr id="labMapLine" style="display:none;">
								<th scope="col"><label for="labMapX">연구소 지도</label></th>
								<td colspan="3">
									<input type="hidden" class="inp_txt" id="labMapX" name="labMapX" maxlength="20">
									<input type="hidden" class="inp_txt" id="labMapY" name="labMapY" maxlength="20">
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" class="inp_txt" id="br1Zipcode" name="br1ZipCode" maxlength="10" readonly="readonly">
									<input type="text" class="inp_txt" id="br1Addr1" name="br1Addr1" maxlength="50" readonly="readonly" style="width:37%;"/>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="inp_txt" id="br1Addr2" name="br1Addr2" maxlength="50" size="50" style="width:90%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" class="inp_txt" id="br2Zipcode" name="br2ZipCode" maxlength="10" readonly="readonly">
									<input type="text" class="inp_txt" id="br2Addr1" name="br2Addr1" maxlength="50" readonly="readonly" style="width:37%;"/>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="inp_txt" id="br2Addr2" name="br2Addr2" maxlength="50" size="50" style="width:90%;"/></td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			$('input[name="br1AreaCd"]').change(function(){
			    ...
			    $.ajax({
					...
					success : function(data) {
					    var tag = "";
					    if(areaCd == 1) {
					    	tag = "<select class='select_box' id='br1Area' name='br1Area'></select>";
					    } else {
					    	tag = "<select class='select_box' id='br1OtherAreaCd' name='br1OtherAreaCd'></select>";
					    }
			...
			$('input[name="br2AreaCd"]').change(function(){
			    ...
			    $.ajax({
					...
					success : function(data) {
					    var tag = "";
					    if(areaCd == 1) {
					    	tag = "<select class='select_box' id='br2Area' name='br2Area'></select>";
					    } else {
					    	tag = "<select class='select_box' id='br2OtherAreaCd' name='br2OtherAreaCd'></select>";
					    }
