...
<%
	...
	String excelName = "장비활용률현황_"+to_day;
...
<table class="skin_basic_list" summary="게시판 목록을 나타내는 표입니다..">
	...
	<thead>
		<tr>
			<th scope="col" rowspan="2" colspan="2" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">구분</th>
			<th scope="col" colspan="4" style = "border-right: solid 1px #e0e0e0;">장비활용률</th>
			<th scope="col" colspan="4" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">공동활용률</th>
		</tr>
		<tr>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">활용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">미활용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">합계</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">활용률(%)</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">활용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">미활용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">합계</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0;">활용률(%)</th>
