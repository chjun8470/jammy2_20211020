...
<%
	...
	String excelName = "활용범위현황_"+to_day;
...
<table class="skin_basic_list" summary="게시판 목록을 나타내는 표입니다..">
	...
	<thead>
		<tr>
			...
			<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">단독활용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">공동활용허용</th>
			<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">공동활용서비스</th>
		</tr>
	</thead>
	<tbody>
		<tr>
		...
		<tr>
			...
			<td scope="col"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
			<td scope="col"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
		...
		<tr>
			...
			<td scope="col"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
			<td scope="col"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
		...
		<tr>
			...
			<td scope="col"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
			<td scope="col"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
		...
		<tr>
			...
			<td scope="col"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
			<td scope="col"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
