		...
		<table class="skin_basic_list" summary="게시판 목록을 나타내는 표입니다..">
			...
			<tbody>
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(totalDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">장비구축비(원)</th>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("COL9"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("COL10"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL9"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL10"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(zeusDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">장비구축비(원)</th>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("COL9"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("COL10"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(etubeDataMap.get("COL5"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">장비구축비(원)</th>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("COL9"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("COL10"))))%><%}else{%>0<%}%></td>
				</tr>
			</tbody>
		</table>
	</div>
