		...
		<table class="skin_basic_list" summary="게시판 목록을 나타내는 표입니다..">
			...
			<tbody>
				...
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
				...
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
				...
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
				...
				<tr>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("COL4"))))%><%}else{%>0<%}%></td>
