...
<div class="skin_list">
			...
			<div class="search_box" style="padding:10px">
				<div class="board-search">
					...
					<label for="orgGrpNm">기관</label>
						...
						<input type="hidden" class="inp_txt" name="orgGrpNmH" id ="orgGrpNmH" />
	...
	<div>
		...
		<table class="skin_basic_list" summary="게시판 목록을 나타내는 표입니다..">
			...
			<tbody>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">등록기관수</th>
					...
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(nJeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(nJeinetDataMap.get("TOTAL1"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">등록대수(점)</th>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(totalDataMap.get("TOTAL2"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(jeinetDataMap.get("TOTAL2"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(zeusDataMap.get("TOTAL2"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(etubeDataMap.get("TOTAL2"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(nJeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(nJeinetDataMap.get("TOTAL2"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">등록금액(원)</th>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("TOTAL3"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("TOTAL3"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("TOTAL3"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("TOTAL3"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(nJeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(nJeinetDataMap.get("TOTAL3"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">내구연한<br>경과장비수<br>(점)</th>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(totalDataMap.get("TOTAL4"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(jeinetDataMap.get("TOTAL4"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(zeusDataMap.get("TOTAL4"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(etubeDataMap.get("TOTAL4"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(nJeinetDataMap.size() > 0){%><%=Math.round(Double.parseDouble(String.valueOf(nJeinetDataMap.get("TOTAL4"))))%><%}else{%>0<%}%></td>
				</tr>
				<tr>
					<th scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;">내구연한<br>경과장비<br>구축비(원)</th>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(totalDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(totalDataMap.get("TOTAL5"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(jeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(jeinetDataMap.get("TOTAL5"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(zeusDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(zeusDataMap.get("TOTAL5"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(etubeDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(etubeDataMap.get("TOTAL5"))))%><%}else{%>0<%}%></td>
					<td scope="col" style = "border-right: solid 1px #e0e0e0; border-left: solid 1px #e0e0e0;"><%if(nJeinetDataMap.size() > 0){%><%=util.getComma(Double.parseDouble(String.valueOf(nJeinetDataMap.get("TOTAL5"))))%><%}else{%>0<%}%></td>
				</tr>
			</tbody>
		</table>
	</div>
