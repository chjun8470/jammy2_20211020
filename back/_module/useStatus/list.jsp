...
<form id = "searchForm" name = "searchForm" method="post" action="./<%=myPage%>">
				...
				<div class="basic_grid">
					<div class="search_box" style="padding:10px">
						<div class="board-search">
							...
							<label for="searchType" class="hide">검색종류</label>
			...
			<div class="total" style="margin-top: 10px;">
				...
				<button type="button" id="excelDownload" class="btn_inp_b_01" onclick="location.href='/sys/useStatusExcel.do'">엑셀다운로드</button>
				</span>
			</div>
...
<script type="text/javascript">
	...
	function popupWindow(){
		...
		var popUrl="/sys/useStatus.do?mode=equPop";
