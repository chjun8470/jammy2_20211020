   ...
   <div class="content_center">
   		<div class="tabBox" style="margin-top:30px;">
			<ul id =tabul style="width: 1000px;">
				<li class="<%if(tap.equals("4")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_bank_creat.do?tap=4">특허실용</a></li>
				<li class="<%if(tap.equals("1")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_bank_creat.do?tap=1">상표</a></li>
				<li class="<%if(tap.equals("2")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_bank_creat.do?tap=2">디자인</a></li>
				<li class="<%if(tap.equals("5")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_bank_creat.do?tap=5">프로그램</a></li>
				<li class="<%if(tap.equals("3")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_bank_creat.do?tap=3">노하우</a></li>
			</ul>
		</div>
	   ...
	   <div>
	      <iframe src="/AIViewer55/temp/utility.jsp?reportParams=showMenuBar:false" id="tem" name="tem"  style="border:0px;width:100%; height:100%" onload="autoReportResize('tem')"></iframe>
	   </div>
