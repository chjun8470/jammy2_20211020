...
%>
   <div class="content_center">
   		...
   		<%-- <div class="tabBox" style="margin-top:30px;">
			<ul id =tabul>
				<li class="<%if(tap.equals("1")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_analysis.do?tap=1">기관별 구축액</a></li>
				<li class="<%if(tap.equals("2")){ %>on<%}%>" style="float:left;margin-left:10px;"><a href="/sys/sys_avg_analysis.do?tap=2">기관별 외산금액</a></li>
			</ul>
		</div>
		...
		<%if(tap.equals("1")){ %>
	   <div>
	      <iframe src="/AIViewer55/temp/analysis1.jsp?reportParams=showMenuBar:false" id="tem" name="tem" width="100%" height="100%" style="border:0px;" onload="autoReportResize('tem')"></iframe>
	   </div>
	   <%} else if(tap.equals("2")){ %>
	   <div>
	      <iframe src="/AIViewer55/temp/analysis2.jsp?reportParams=showMenuBar:false" id="tem" name="tem" width="100%" height="100%" style="border:0px;" onload="autoReportResize('tem')"></iframe>
	   </div>
	   <%}%>--%>
	</div>
