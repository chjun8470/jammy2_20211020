...
<div class="lnb_tit">
	...
	<!-- h2>
		<%=leftmenuTitleVO.getMenuNm().equals("시스템소개") ? "ABOUT<br/>SMBRND" :
			leftmenuTitleVO.getMenuNm().equals("사업공고") ? "BUSINESS<br/>INFORMATION" :
			leftmenuTitleVO.getMenuNm().equals("정보") ? "RND<br/>INFORMATION" :
			leftmenuTitleVO.getMenuNm().equals("중소기업통계") ? "SCIENCE<br/>INFORMATION" :
