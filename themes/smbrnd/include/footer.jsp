...
<div class="FooterBox">
	...
	<div class="f_menu">
		<ul>
			<li class="first"><a href="/smbrnd/sub.do?m=18"><span class="Blue">개인정보처리방침</span></a></li>
			<li><a href="/smbrnd/sub.do?m=17">이메일무단수집거부</a></li>
			<li><a href="/smbrnd/sub.do?m=19">저작권정책</a></li>
			<li><a href="/smbrnd/sub.do?m=15">찾아오시는길</a></li>
			<!--<li><a href="/smbrnd/sub.do?m=106">홈페이지의견접수</a></li>-->
