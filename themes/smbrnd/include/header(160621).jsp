...
<div class="Headerinner">
	...
	<div class="m_menu">
		<button class="m_menu_btn"><img src="/img/jntis/common/btn_m_menu.gif" /></button>
	</div>
...
%>
	...
	<!-- <form id = "allSearchForm" name = "allSearchForm" method="post" action="/jntis/sub.do?m=53" class="boardSearch"> -->
	<div class="search">
		<select name="select" class="select">
		<option value="allsearch">통합검색</option>
		</select>
		<input id="srch_txt" class="srch_txt" name="searchWord" type="text" title="검색단어입력" />
		<input type="image" src="/img/jntis/common/btn_srh.png" class="go_btn" alt="바로가기" />
	</div>
	<!-- </form> -->
	<!--gnbBox S-->
	<div class="gnbBox" >
