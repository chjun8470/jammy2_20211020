			...
			$(function(){
				...
				*/
                ...
                for(var i = 0 ;i < boardLatestProject.length;i++){
                      ...
                      if(rs['GB'] == '1'){
	                      inhtml += '<button class="busi_btn info_btn01">지역사업</button>';
					  } else if(rs['GB'] == '2'){
	                      inhtml += '<button class="busi_btn info_btn02">정부사업</button>';
					   }
                ...
                for(var i = 0 ;i < boardLatestProject2.length;i++){
                    ...
                    inhtml += '      <button class="busi_btn info_btn01">진행</button>';
                    }else{
                    inhtml += '      <button class="busi_btn info_btn02">완료</button>';
                    }
                    inhtml += '  </li>';
