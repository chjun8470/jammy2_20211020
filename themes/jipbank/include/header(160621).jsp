...
<div class="Headerinner">
	...
	<div class="top_menu">
		<ul>
			...
			<%} %>
			<li><a href="<c:out value='${BASE_URL}/sub.do?m=85'/>">SITEMAP</a></li>
		</ul>
	</div>
	<!--탑 메뉴 E-->
	...
	<div class="top_menu">
		<ul>
			...
			<li><a href="/jipbank/main.do">HOME</a></li>
			<% if (!EgovUserDetailsHelper.isAuthenticated()) {%>
			<li><a href="javascript:ssoPopupShow('login')">로그인</a></li>
			<li><a href="javascript:ssoPopupShow('join')">회원가입</a></li>
			<% } else { %>
...
%>
	...
	<!-- <form id = "allSearchForm" name = "allSearchForm" method="post" action="/jipbank/sub.do?m=53" class="boardSearch"> -->
	<div class="search">
		<select name="select" class="select">
		<option value="allsearch">통합검색</option>
		</select>
		<input id="srch_txt" class="srch_txt" name="searchWord" type="text" title="검색단어입력" />
		<input type="image" src="/img/jipbank/common/btn_srh.png" class="go_btn" alt="바로가기" />
	</div>
	<!-- </form> -->
	<!--gnbBox S-->
	<div class="gnbBox" >
