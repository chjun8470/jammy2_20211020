...
<div class="lnb_tit">
	...
	<p class="tit02">
		<%=leftmenuTitleVO.getMenuNm().equals("JIPBANK 소개") ? "ABOUT<br/>JIPBANK" :
			leftmenuTitleVO.getMenuNm().equals("지식재산검색") ? "JIPBANK<br/>SEARCH" :
			leftmenuTitleVO.getMenuNm().equals("지식재산상담") ? "JIPBANK<br/>CONSULTING" :
			leftmenuTitleVO.getMenuNm().equals("지식재산자료실") ? "JIPBANK<br/>RESOURCE ROOM" :
