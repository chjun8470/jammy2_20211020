...
<div class="Headerinner">
	...
	<div class="top_menu">
		<ul>
            <li class="home"><a href="http://jipbank.jnsp.re.kr/jipbank/main.do">홈</a></li>
			...
			<li><a href="javascript:ssoPopupShow('login','jipbank')">로그인</a></li>
			<li><a href="javascript:ssoPopupShow('join','jipbank')">회원가입</a></li>
			<% } else { %>
			<li><a href="<c:out value='${BASE_URL}/member/logout.do'/>">LOGOUT</a></li>
			<li><a href="javascript:ssoPopupShow('mypage','jipbank')">MYPAGE</a></li>
			<li><a href="<c:url value='/sys/main.do'/>" target="_blank">관리자</a></li>
			<%} %>
			<li><a href="http://jipbank.jnsp.re.kr/jipbank/sub.do?m=85">SITEMAP</a></li>
		</ul>
	</div>
	<!--탑 메뉴 E-->

	<div class="logo"><a href="/jipbank/main.do"><img src="/img/jipbank/common/logo.png" alt="JIPBANK 로고" /></a></div>
	
	<div class="m_login">
		<a href="javascript:ssoPopupShow('login','jipbank')">로그인</a>
	</div>

	<div class="m_menu">
		<button class="m_menu_btn"><img src="/img/jipbank/common/btn_m_menu.gif" alt="메뉴버튼" /></button>
	</div>
