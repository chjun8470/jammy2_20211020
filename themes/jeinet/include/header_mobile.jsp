...
<div class="width1200">
	...
	<h1>
		<a href="/jntis/main.do">
			<img src="/img/jeinet/main/logo.png" alt="JEINET 로고">
		</a>
	</h1>
	...
	<div class="m_nav_wrap" >
		...
		<div class="nav_login">
            ...
            <a  href="/sso/login.do?siteId=jeinet" class="login_btn">JEINET 로그인</a>
			<% } else { %>
			<a  href="/sso/home.do?siteId=jeinet" class="login_btn">마이페이지</a>
			<%} %>
		</div>
