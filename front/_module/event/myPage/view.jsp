...
<div class="clear_wrap">
				<div class="box_in">
					...
					<table class="skin_basic_write">
               		...
               		<h3>[행사정보]
               			<input type="button" class="btn_w_01" style="float:right; cursor: pointer" value="자세히보기" onclick="pageViewGo('<%=util.getStr(dataMap.get("EVENT_IDX"))%>');"/>
               		</h3>
											...
											<ul class="file" style="line-height: 30px; text-align: left; vertical-align: middle; padding: 5px;">
												...
												%>
													<li class="text"> 첨부파일 <%=fileCnt%> :
							                        	...
							                        	<%--<a href="/cmm/fms/ComFileDown.do<%=fileParam%>" title="첨부파일 다운로드"><img src = "/file/<%=fileGrp+"/"+rs.get("TITLE")%>" style="max-width:450px; padding:10px; vertical-align:middle "/></a>--%>
									...
									<table class="skin_basic_write">
										...
										<tbody>
			                				<tr>
				                				<th scope="col">기관명</th>
					                			<td scope="col" colspan="3">
					                				<%=util.getStr(dataMap.get("REFERENCE_ORG_NM"))%>
					                			</td>
					                		</tr>
				                			<tr>
					                			<th scope="col">부서명</th>
					                			<td scope="col" colspan="3">
					                				<%=util.getStr(dataMap.get("REFERENCE_ORG_SUB_NM"))%>
					                			</td>
				                			</tr>
				                			<tr>
					                			<th scope="col">담당자명</th>
					                			<td scope="col" colspan="3">
					                				<%=util.getStr(dataMap.get("REFERENCE_CHARGER"))%>
					                			</td>
				                			</tr>
				                			<tr>
					                			<th scope="col">전화번호</th>
					                			<td scope="col" colspan="3">
					                				<%=util.getStr(dataMap.get("REFERENCE_PHONE"))%>
					                			</td>
				                			</tr>
				                			<tr>
					                			<th scope="col">이메일</th>
					                			<td scope="col" colspan="3">
					                				<%=util.getStr(dataMap.get("REFERENCE_EMAIL"))%>
					                			</td>
				                			</tr>
				                		</tbody>
									</table>
