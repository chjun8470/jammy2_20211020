...
//]]>
        ...
        <!---contents----->
		<div class="contents" style="height:700px;padding-top:20px">

            <!----contents_btn----->
			<div class="contents_btn">


<form name="authForm" id="authForm" method="post" action="/web/jnspUserProc.do">
			...
			<tbody>
				 <tr>
					...
					<td class="td" colspan="3">
						<input type="radio" name="blngOrgGubun" value="2" checked="checked"  id="blngOrgGubunPerson" style="display: inline-block; width:20px;" title="개인"><label for="blngOrgGubunPerson">개인</label>
						<input type="radio" name="blngOrgGubun" value="1" id="blngOrgGubunOrg" style="width:20px;" title="기관"><label for="blngOrgGubunOrg">기관</label>
...
<!-- 							<input type="text" name="psnNm" maxlength="24" value="황인선" readonly="readonly" id="psnNm" style="background:#eeeeee; width:200px;" class="txtbox" title="이름"> -->
				...
				<tr>
					...
					<td class="td">
						<input type="radio" name="frgnYn" value="K" checked="checked" id="frgnYnY" style="width:20px;" title="내국인" /><label for="frgnYnY">내국인</label>
						<input type="radio" name="frgnYn" value="F" id="frgnYnN" style="margin-left: 20px; display: inline-block; width:20px" title="외국인" /><label for="frgnYnN">외국인</label>
					</td>
				</tr>
				<tr>
...
<!-- 						<span style="color:#f00; "><br> *  가입 완료 후 인증 메일이 발송 됩니다. <br/></span> -->
	...
	<div class="btn_box">
			<div class="btn_right_box" >
				<input type="button" onclick="window.location.href='/sso/login.do'" class="btn_inp_w_01" value="취소"/>
