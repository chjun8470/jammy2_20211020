...
<%--                    <p class="img_publist"><img id="<%=num %>" src="/file/<%=fileGrp+"/"+rs.get("TITLE")%>" width="199" height="281" /></p> --%>
                        ...
                        <%if(util.getStr(rs.get("EQU_SATISFACTION")).equals("1")) { %> <img src="/img/board/star1.png" alt="별점 1점" /> 1점 <% } %>
                              <%if(util.getStr(rs.get("EQU_SATISFACTION")).equals("2")) { %> <img src="/img/board/star2.png" alt="별점 2점" /> 2점 <% } %>
                              <%if(util.getStr(rs.get("EQU_SATISFACTION")).equals("3")) { %> <img src="/img/board/star3.png" alt="별점 3점" /> 3점 <% } %>
                              <%if(util.getStr(rs.get("EQU_SATISFACTION")).equals("4")) { %> <img src="/img/board/star4.png" alt="별점 4점" /> 4점 <% } %>
                              <%if(util.getStr(rs.get("EQU_SATISFACTION")).equals("5")) { %> <img src="/img/board/star5.png" alt="별점 5점" /> 5점 <% } %>
