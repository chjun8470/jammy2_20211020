...
%>
	...
	<div id="diaryView">
		...
		<div class="box_in">
			...
			<table id="step1"  class="skin_basic_write">
				...
				<tbody>
					...
					<tr>
						<th scope="col">기관</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_ORG")) %></td>
					</tr>
					<tr>
						<th scope="col">부서</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_DEPT")) %></td>
					</tr>
					<tr>
						<th scope="col">담당자</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_NM")) %></td>
					</tr>
					<tr>
						<th scope="col">직위</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_POSITION")) %></td>
					</tr>
					<tr>
						<th scope="col">전화번호</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_PHONE")) %></td>
					</tr>
					<tr>
						<th scope="col">이메일</th>
						<td scope="col" colspan="3"><%=util.getStr(diaryDataMap.get("EQU_USER_EMAIL")) %></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="box_in">
			...
			<table class="skin_basic_write">
				...
				<tr>
					<th scope="col" colspan="4">시료처리정보</th>
				</tr>
				<tr>
					<td colspan="4">
					<%
				...
				<tr>
					<th scope="col" colspan="4"> 장비사용료(VAT제외)</th>
				</tr>
				<tr>
					<td colspan="4"><%=util.setFormatNum(String.valueOf(diaryDataMap.get("RENTAL_FEE")), "comma") %>원</td>
				</tr>
				<tr>
					<td colspan="4">
				...
				<tr>
					<th scope="col" colspan="4"><label for="useNote">장비운영내용</label></th>
				</tr>
				<tr>
					<td colspan="4"><%=util.getStr(String.valueOf(diaryDataMap.get("USE_NOTE"))) %></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<%if(util.getStr(dataMap.get("DIARY_YN")).equals("")) { %>
		<form name="diaryfwrite" id="diaryfwrite" action="./sub.do" method="post" enctype="multipart/form-data" >
			...
			<div class="box_in">
				...
				<table id="step1"  class="skin_basic_write">
					...
					<tbody>
						...
						<tr>
							<th scope="col">기관</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserOrg" value="<%=util.getStr(dataMap.get("OWN_ORG_NM")) %>" readonly="readonly"/></td>
						</tr>
						<tr>
							<th scope="col">부서</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserDept" value="<%=util.getStr(dataMap.get("OWN_ORG_SUB_NM")) %>" readonly="readonly"/></td>
						</tr>
						<tr>
							<th scope="col">담당자</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserName" value="<%=util.getStr(dataMap.get("OPER_CHARGER")) %>" readonly="readonly"/></td>
						</tr>
						<tr>
							<th scope="col">직위</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserPosition" value="<%=util.getStr(dataMap.get("OPER_POSITION")) %>" readonly="readonly"/></td>
						</tr>
						<tr>
							<th scope="col">전화번호</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserPhone" value="<%=util.getStr(dataMap.get("OPER_TEL")) %>" readonly="readonly"/></td>
						</tr>
						<tr>
							<th scope="col">이메일</th>
							<td scope="col" colspan="3"><input type="text" class="inp_txt" name="equUserEmail" value="<%=util.getStr(dataMap.get("OPER_EMAIL")) %>" readonly="readonly"/></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="box_in">
				...
				<div class="scroll">
					<table class="skin_basic_write">
						...
						<tr>
							<th scope="col" colspan="4"><font color="red">*</font>시료처리정보</th>
						...
						<tr>
							<th scope="col" colspan="4"><font color="red">*</font>사용료(VAT 제외)</th>
						</tr>
						<tr>
							<td colspan="4"><input type="text" class="inp_txt" name="rentalFee" id="diaryRentalFee" />원</td>
						</tr>
						<tr>
							<th scope="col" colspan="4"><font color="red">*</font>세금계산서 등 증빙문서 등록</th>
						</tr>
						<tr>
							<td colspan="4">
							...
							function diaryAddRowFile(fileGrpnm){
								if(diaryArrfileCnt[fileGrpnm] < 11){
									var fileHtml = "<div class='diary_file'>";
		...
		<div class="skin_bbs_write">
			...
			<div class="box_in">
				...
				<table class="skin_basic_write">
					...
					<tr>
						<td colspan="4"><input type="text" class="inp_txt" name="rentalFee" id="diaryRentalFee" value="<%=util.setFormatNum(String.valueOf(diaryDataMap.get("RENTAL_FEE")), "comma") %>" />원</td>
					</tr>
					<tr>
						<th scope="col" colspan="4"><font color="red">*</font>세금계산서 등 증빙문서 등록</th>
					</tr>
					<tr>
						...
						%>
								...
								%>
									<li class="text">
										<input type="checkbox" name="fileFlog" id="fileFlog_<%=diaryFileCnt%>"
												value="<%=util.getStr(rs.get("FILE_ID"))%>" onclick="fileSet('<%=diaryFileCnt%>')" />&nbsp;
										<input type="hidden" name="fileSn" value="<%=diaryFileCnt%>"/>
