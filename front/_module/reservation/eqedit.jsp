...
function contains(char1,char2) {
	if (char1.indexOf(char2) != -1){
	  ...
	  <form name="fedit" id="fedit" action="./sub.do" method="post" enctype="multipart/form-data" >
	  	...
	  	<input type="hidden" name="m" id="mode"  value="<%=m%>" />
	  	<input type="hidden" name="reUrl" id="reUrl"  value="/mjeinet/sub.do?m=110" />
			...
			<table class="skin_basic_write">
				...
				<tr>
					...
					<td>
						...
						<br/>
						<input type="text" class="inp_txt" style="width:100%;margin-top:5px;" name="addr2" maxlength="100" value="<%=util.getStr(dataMap.get("ADDR2"))%>" id="addr2"  title="신청자주소" />
					</td>
				</tr>
				<tr>
		...
		<div style="margin:10px; "><h3><b>[장비 예약 정보]</b></h3></div>
			...
			<table class="skin_basic_write">
				...
				<tr>
					<th scope="col" rowspan="4">등록번호</th>
				</tr>
				<tr>
					<td scope="col" colspan="3">
	        ...
	        <div class="btn_box">
	        	<div class="btn_right_box">
		        	...
		        	<a href="./sub.do?m=110" class="btn_inp_w_01" style="text-align: center;">취소</a>
	        	</div>
	        </div>
	        <!--// bo_btn -->
