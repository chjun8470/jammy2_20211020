...
<div class="list_top" style="margin-top:-20px; border-bottom:1px solid #e1e1e1; padding-bottom:10px; margin-bottom:20px">
	<div class="b_btn_listBox">
		<button type="button" class="b_btn_block" id="cont_block" onclick="pageListGo('patentImageList')" title="블럭형"><img src="/img/board/btn_block.png" style="cursor:pointer"/></button>
		<button type="button" class="b_btn_blog" id="cont_blog" onclick="pageListGo('patentBlogList')" title="블로그형"><img src="/img/board/btn_blog_ovr.png" style="cursor:pointer"/> </button>
	</div>
</div>
	...
	<div class="PatentBox">
		...
		%>
			...
			<div class="patent_info02">
				<div class="patent_img02"><img src="<%=(util.getStr(rs.get("IMG_FILE_ID")).equals("") ? "/img/jipbank/main/no_image01.gif" : util.getStr(rs.get("IMG_FILE_PATH"))+"s/"+util.getStr(rs.get("IMG_TITLE")))%>" alt="대표이미지" /></div>
				<dl>
					<dt>보유기관명 :</dt> <dd>&nbsp;<span class="Blue2"><%=util.getStr(rs.get("ORG_NM"))%></span></dd>
