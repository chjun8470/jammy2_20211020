...
<%if(util.getStr(paramMap.get("totalCountPatent")).equals("") || util.getStr(paramMap.get("totalCountPatent")).equals(null)
	&& util.getStr(paramMap.get("totalCountDesign")).equals("") || util.getStr(paramMap.get("totalCountDesign")).equals(null)
	&& util.getStr(paramMap.get("totalCountBrand")).equals("") || util.getStr(paramMap.get("totalCountBrand")).equals(null)
	&& util.getStr(paramMap.get("totalCountProgram")).equals("") || util.getStr(paramMap.get("totalCountProgram")).equals(null)
	&& util.getStr(paramMap.get("totalCountKnowHow")).equals("") || util.getStr(paramMap.get("totalCountKnowHow")).equals(null)){ %>

<div class="txt_p_info"><img src="/img/board/result_none.png" alt="검색하신 내용의 데이터가 없습니다. 확인 후 다시 검색해 주세요." /></div>
...
<div class="list_top" style="margin-top:-20px; border-bottom:1px solid #e1e1e1; padding-bottom:10px; margin-bottom:20px">
	<div class="b_btn_listBox">
		<button type="button" class="b_btn_block" id="cont_block" onclick="pageListGo('patentImageList')" title="블럭형"><img src="/img/board/btn_block_ovr.png" style="cursor:pointer"/></button>
		<button type="button" class="b_btn_blog" id="cont_blog" onclick="pageListGo('patentBlogList')" title="블로그형"><img src="/img/board/btn_blog.png" style="cursor:pointer"/> </button>
	</div>
</div>
...
<!--PatentBox01 S-->
	<div class="PatentBox">
	<div class="tit_patent01">[특허실용신안]</div>
	...
	<ul class="patent_imglist">
		...
		<%if(util.getStr(paramMap.get("totalCountPatent")).equals("") || util.getStr(paramMap.get("totalCountPatent")).equals(null)) { %>
		<% } else { %>
			<div class="more"><a title="더보기 버튼" href="javascript:moreList('1')">더보기 +</a></div>
		<% } %>
	</ul>
...
<!--PatentBox01 S-->
	<div class="PatentBox">
	<div class="tit_patent01">[디자인]</div>
	<div class="patent_count">
	...
	<ul class="patent_imglist">
		...
		<li>
			...
			<%if(util.getStr(paramMap.get("totalCountDesign")).equals("") || util.getStr(paramMap.get("totalCountDesign")).equals(null)) { %>
			<% } else { %>
				<div class="more"><a title="더보기 버튼" href="javascript:moreList('2')">더보기 +</a></div>
			<% } %>
	</ul>
</div>
<!--PatentBox02 E-->
...
<!--PatentBox03 S-->
	...
	<ul class="patent_imglist">
		...
		<li>
			...
			<%if(util.getStr(paramMap.get("totalCountBrand")).equals("") || util.getStr(paramMap.get("totalCountBrand")).equals(null)) { %>
			<% } else { %>
				<div class="more"><a title="더보기 버튼" href="javascript:moreList('3')">더보기 +</a></div>
			<% } %>
	</ul>
</div>
<!--PatentBox03 E-->
...
<!--PatentBox04 S-->
	<div class="PatentBox">
	<div class="tit_patent01">[프로그램]</div>
	<div class="patent_count">
	...
	<ul class="patent_imglist">
		...
		<li>
			...
			<%if(util.getStr(paramMap.get("totalCountProgram")).equals("") || util.getStr(paramMap.get("totalCountProgram")).equals(null)) { %>
			<% } else { %>
				<div class="more"><a title="더보기 버튼" href="javascript:moreList('4')">더보기 +</a></div>
			<% } %>
	</ul>
</div>
<!--PatentBox04 E-->
...
<!--PatentBox05 S-->
	<div class="PatentBox">
	<div class="tit_patent01">[노하우]</div>
	<div class="patent_count">
	...
	<ul class="patent_imglist">
		...
		<li>
			...
			<%if(util.getStr(paramMap.get("totalCountKnowHow")).equals("") || util.getStr(paramMap.get("totalCountKnowHow")).equals(null)) { %>
			<% } else { %>
				<div class="more"><a title="더보기 버튼" href="javascript:moreList('5')">더보기 +</a></div>
			<% } %>
	</ul>
</div>
<!--PatentBox04 E-->
