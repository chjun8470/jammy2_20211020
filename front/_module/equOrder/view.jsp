...
<div class="clear_wrap">
	<h2>장비이용 예약 신청서</h2>
	                	...
	                	<tbody>
							...
							<tr>
	                			...
	                			<td scope="col" colspan="3">
	                				...
	                				<%if(util.getStr(dataMap.get("ORDER_STATE")).equals("2")) { %> <img alt="승인요청" src="/img/back/comm/order_state_img_2.png" /> <% } %>
	                				<%if(util.getStr(dataMap.get("ORDER_STATE")).equals("3")) { %> 
	                				<img alt="승인요청" src="/img/back/comm/order_state_img_3.png" /> <br /> 반려사유 :&nbsp;<%=util.getStr(dataMap.get("REJECT"))%> <% } %>
	                				<%if(util.getStr(dataMap.get("ORDER_STATE")).equals("4")) { %> <img alt="승인요청" src="/img/back/comm/order_state_img_4.png" /> <% } %>
			...
			<table id="satisfaction"  class="skin_basic_write">
				<colgroup>
					<col width="*%">
					<col width="15%">
					<col width="15%">
			...
			<% } %>--%>
	            ...
	            <div class="btn_right_box">
	            	...
	            	<% } %>
	                <% if(util.loginCheck() || userCheck) { %>
	            	<button class="btn_inp_w_01" type="button" onclick="pageEditGo()" style="float:right;">수정</button>
					<% } %>
	         	</div>
             </div>
...
<form id = "fview" name = "fview" method="post" action="./equorder.do">
	...
	<input type="hidden" id = "reUrl"  			name = "reUrl" 				value = "./equorder.do" />
