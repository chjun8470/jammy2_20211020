	...
	<div class="basic_writeWrap004">
        ...
        <table class="skin_write004">
			...
			<thead>
	            ...
	            <tr>
			    	<th scope="col"><span style="color:red; font-size:11pt;">*</span> 공지글여부</th>
			    	<td class="r_line_none p_top_btm_6">
			    		<div class="checkBox00402"><input type="checkbox" name="noticeAt" id="noticeAt" value="Y"  onclick="check_only(this)"/><label for="notice1"> 사용</label></div>
		            	<div class="checkBox00402"><input type="checkbox" name="noticeAt" id="noticeAt_N" value="N" checked="checked" onclick="check_only(this)"/><label for="notice2"> 미사용</label></div>
					</td>
			  	</tr>
	          	<%}%>
              	<tr>
			    	...
			    	<td class="r_line_none">
                        ...
                        <input type="checkbox" name="secretAt" id="secretAt" value="Y" />&nbsp;<label for="secretAt" >비밀글</label>
                        </div>
                    </td>
				</tr>
			</thead>
