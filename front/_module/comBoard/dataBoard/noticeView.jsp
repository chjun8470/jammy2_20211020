					...
					<div class="ideaBox" style="width: 100%;">
						<ul class="idea_list" style="display:">
							<li>
								...
								<div class="idea_txt" id="commentDiv<%=no%>" style="display:">
									<span id="comment<%=no%>"><%=util.getStr(rs.get("CMT_CONTENT")).replaceAll("\n", "<br/>") %></span>
									<textarea id="commentUdtInput<%=no%>" name="commentUdtInput" style=" display:none" class="input_idea"><%=util.getStr(rs.get("CMT_CONTENT")) %></textarea>
									&nbsp;
