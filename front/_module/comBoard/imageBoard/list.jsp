...
<!--     <th scope="col" class="r_line_none file">첨부</th> -->
					...
					<%
                     ...
                     <tr>
                           ...
                           <td class="b_notice" >
								<a href="javascript:goSubmit('noticeView','<%=util.getStr(rs.get("ARTICLE_ID"))%>','<%=util.getStr(rs.get("BOARD_ID"))%>')" title="<%=util.getStr(rs.get("SUBJECT"))%>" >
  ...
  <tr>
    ...
    <td class="b_notice" >
		<a href="javascript:goSubmit('view','','<%=util.getStr(rs.get("ARTICLE_ID"))%>')" title="<%=util.getStr(rs.get("SUBJECT"))%>" >
