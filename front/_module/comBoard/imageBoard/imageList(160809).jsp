...
<input type="image" class="b_go_btn005" src="/img/board/btn_ico_srch.png" onclick="goSubmit('list','image')" />
</div>
...
<div class="b_btn_listBox005">
	...
	<button type="button" class="b_btn_blog005" onclick="goSubmit('list','imageList')"><img src="/img/board/btn_blog_ovr.png" alt="블러그리스트" /></button>
	<button type="button" class="b_btn_list005" onclick="goSubmit('list','list')"><img src="/img/board/btn_list.png" alt="리스트" /></button>
</div>
...
<div class="pub_list03" id="cont_block">
	...
	<%
		...
		%>
			...
			%>
			<li>
				<p class="img_publist03_blog" style="cursor:pointer;width:194px;height:154px" onclick="goSubmit('view','imageList','<%=util.getStr(rs.get("ARTICLE_ID"))%>')">
						<%if(util.getStr(rs.get("FILE_ID")).equals("") || util.getStr(rs.get("FILE_ID")).equals(null)){ %>
							<img  style="width:180px; height:140px" src="/img/main/no_image01.gif" alt="이미지 없음"/>
						<%}else{%>
							<img  style="width:180px; height:140px" src = "/file/<%=fileGrp+"/"+rs.get("TITLE")%>" alt="이미지<%=cont%>"/>
						<%}%>
				</p>
				<div class="explanation" style="cursor:pointer;" onclick="goSubmit('view','imageList','<%=util.getStr(rs.get("ARTICLE_ID"))%>')">
					<p class="tit_publist03_blog01" onclick="goSubmit('view','imageList','<%=util.getStr(rs.get("ARTICLE_ID"))%>')">
