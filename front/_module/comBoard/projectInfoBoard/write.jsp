		...
		<table class="skin_write">
			...
			<%}%>
				...
				<tr>
					...
					<td class="r_line_none p_top_btm_6">
						<span id="orgGroupTd">
							<input type="text" name="OwnOrgNm" id="OwnOrgNm" value="<%=regOrgGrpNm%>" class="b_txtbox1" style="padding-left:2px; font-size:12px" />&nbsp;
							<input type="hidden" name="OwnOrg" id="OwnOrg" value="<%=regOrgGrpCd%>" />
						...
						<span>
							<input type="text" name="OwnDeptNm" id="OwnDeptNm" value="" class="b_txtbox1" style="padding-left:2px; font-size:12px" />&nbsp;
				...
				<tr>
					...
					<td class="r_line_none p_top_btm_6">
							<dl><dt style="float:left;width: 80px;font-weight: bold;" >성   명</dt><dd><input type="text" name="proChargeNm" id="proChargeNm" value="" class="b_txtbox1" /></dd></dl>
							<dl><dt style="float:left;width: 80px;font-weight: bold;" >직   위</dt><dd><input type="text" name="proChargePosition" id="proChargePosition" value="" class="b_txtbox1" /></dd></dl>
							<dl><dt style="float:left;width: 80px;font-weight: bold;" >전   화</dt><dd><input type="text" name="proChargeTel" id="proChargeTel" value="" class="b_txtbox1" maxlength="11"/></dd></dl>
							<dl><dt style="float:left;width: 80px;font-weight: bold;" >이메일</dt><dd><input type="text" name="proChargeEmail" id="proChargeEmail" value="" class="b_txtbox1" /></dd></dl>
					</td>
				</tr>
				<tr>
					<th class="col">
				...
				<tr>
					...
					<div style="display:inline-block;" id="<%=fileFullGrp%>fileGrpBox">
	              	...
	              	<div style="display:inline-block;vertical-align:bottom;padding-bottom:5px;">
						<button class="addImageBtn b_btn_00401" type="button" onclick="addRowFile('<%=fileFullGrp%>');" title="첨부파일 추가"><img src="/img/board/btn_plus.gif"/></button>
						<button class="delImageBtn b_btn_00401" type="button" onclick="delRowFile('<%=fileFullGrp%>');" title="첨부파일 삭제"><img src="/img/board/btn_del.gif"/></button>
