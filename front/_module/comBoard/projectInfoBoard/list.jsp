					...
					<%} %>
        			 ...
        			 <div class="list_top_1 margin_left_20px">
                     	<div class="b_srchBox_1 ">
                        	<div class="b_srchBox_1_du"><label for="searchReceipt">접수상태 :&nbsp;</label></div>
                                <select class="b_select_1" name="searchReceipt" id="searchReceipt" title="검색조건 선택">
                                	<option value="" selected="selected">전체</option>
                                    <option value="접수전" <%if("접수전".equals(util.getStr(paramMap.get("searchReceipt")))) {%> <%}%>>접수전</option>
                                    <option value="접수중" <%if("접수중".equals(util.getStr(paramMap.get("searchReceipt")))) {%> <%}%>>접수중</option>
                                    <option value="접수마감" <%if("접수마감".equals(util.getStr(paramMap.get("searchReceipt")))) {%> <%}%>>접수마감</option>
                                </select>
                            </div>
					 </div>
