...
<%
	...
	String boardTitle = util.getStr(boardMap.get("BOARD_NM"));
...
%>
	...
	<div class="MPTit MPTit02 MAB0"><%=boardTitle %></div>
	...
	<div class="list_top h30">
		...
		<input type="hidden" name="siteId" id="siteId" value="<%=siteId%>" />
			...
			<div class="b_srchBox">
				...
				<div class="b_srch">
					<input type="text" name="searchWord" id="searchWord" class="b_srch_txt" value="<%=util.getStr(paramMap.get("searchWord"))%>" title="검색어 입력박스" />
	...
	<div class="basic_listWrap">
		...
		<table class="skin_list01" summary="게시판 목록을 나타내는 표입니다..">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<%=actionString%>?m=<%=m %>&amp;boardComIdx=<%=boardComIdx %>&amp;mode=view&amp;boardIdx=<%=util.getStr(rs.get("ARTICLE_ID"))%>&amp;nowPage=<%=nowPage%>&amp;siteId=<%=siteId%>">
				...
				%>
				<tr>
					<td colspan="5" class="r_line_none" >데이터가 존재하지 않습니다</td>
				</tr>
				<%
				}
				%>
		...
		<div class="MPBtnWrap MAT10 MAB10">
