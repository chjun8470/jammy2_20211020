<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div id ="content" >
    	<form name="agreeForm" id="agreeForm" action="/front/login.do" method="post" >
		...
		<div class="btn_right_box">
			<input class="btn_inp_b_01" type="button" value="이전" onclick="window.location.href='/sso/login.do'"/>
