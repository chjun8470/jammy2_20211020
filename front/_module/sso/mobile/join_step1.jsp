<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<form name="agreeForm" id="agreeForm" action="/sso/join.do" method="post" onsubmit="return agreeSubmitCheck();" >
    		...
    		<input type="hidden" name="siteId" id="siteId" value="mjeinet" />

			<div class="join_order">
				<h2 class="join_step">STEP 01. 약관 및 동의서</h2>
				<!-- <img src="/img/login/img_join_order1.png" alt="STEP1 약관 및 동의서(현재단계), STEP2 정보입력, STEP3 가입완료" /> -->
			</div>
