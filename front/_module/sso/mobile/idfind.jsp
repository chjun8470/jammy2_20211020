	 ...
	 <form name="fwrite" id="fwrite" action="./findProc.do" method="post" enctype="multipart/form-data" onsubmit="return submitGo();" >
		...
		<input type="hidden" name="siteId" id="siteId" value="<%=siteId%>" />
			...
			<div class="pop_btnBox">
				<input type="button" class="btn_pop7" onclick="location.href='./login.do?siteId=<%=siteId%>'"value="확인"/>
			</div>
			</div>
		<%}else{%>
			...
			<div class="inputBox">
				...
				<input type="text" name="psnNm" maxlength="20" value="" id="psnNm" class="input_pop4" title="이름" placeholder="이름을 입력하세요">
				<!--<div class="txt_pop2">E-mail</div>-->
				<input type="text" name="email" maxlength="20" value="" id="email" class="input_pop402" title="이메일" placeholder="E-Mail을 입력하세요">
			</div>
			
			<div class="pop_btnBox">
				<input type="submit" class="btn_pop5" value="찾기" />
				<input type="button" class="btn_pop6" onclick="location.href='./login.do?siteId=<%=siteId%>'" value="이전"/>
			</div>
		<%}%>        	
     </form>