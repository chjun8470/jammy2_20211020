...
<%
	...
	if(siteId.equals("jeinet") || siteId.equals("mjeinet")){
		srvNo = "002001";
	...
	String retUrl   = "http://"+request.getServerName()+(request.getServerName().equals("221.144.12.3")?":12345":"")+"/sso/phoneCheck.do?siteId="+siteId;// 본인실명확인 결과수신 URL
