...
<ul>
	<li class="MPQL01">
			...
			<p class="txt_MPQL0101"><a href="/sso/mypagecon.do">회원정보관리</a></p>
			<p class="txt_MPQL0102">고객님의 회원정보를<br />관리하실 수 있습니다.</p>

	</li>
	<li class="MPQL02">

			<p class="txt_MPQL0201"><a href="/sso/equorder.do">예약정보</a></p>
			<p class="txt_MPQL0202">고객님의 장비 예약정보를<br /> 관리하실 수 있습니다.</p>

	</li>
	<li class="MPQL03">

			<p class="txt_MPQL0301"><a href="/sso/changeboard.do">담당자게시판</a></p>
			<p class="txt_MPQL0302">고객님의 담당자 <br />게시판입니다.</p>

	</li>
	<li class="MPQL04">

			<p class="txt_MPQL0401"><a href="/sso/myfav.do">장바구니</a></p>
