			...
			<table class="skin_basic_write" summary="회원정보입력 테이블로 이름, 성별구분, 외국인여부, 사용자 ID, 비밀번호, 비밀번호 확인, 전화번호, 핸드폰번호, 이메일 등으로 구성되어있습니다.">
				...
				<tbody>
					...
					<tr>
						...
						<th class="r_line l_line" align="center" valign="middle"> * 외국인여부</th>
						<td class="td">
					 ...
					 <tr>
						...
						<td class="r_line">
							<span id="inTel">
								...
								<select name="telNo1" id="telNo1" style="width: 60px;" title="지역번호 선택"><option value="02">02</option>
						...
						<th class="r_line l_line"><label for="cpNo1"> * 핸드폰번호</label></th>
						<td class="td">
							<span id="inCp">
								<input type="hidden" name="cpNo" value="" id="cpNo">
								<select name="cpNo1" id="cpNo1" style="width: 60px;" title="서비스 번호 선택"><option value="010">010</option>
