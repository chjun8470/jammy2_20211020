		...
		<div class="btn_box">
			<%if(util.loginCheck()){ %>
				<div class="btn_left_box">
					<span>
						<img src="/imgs/board/btn_modify.gif" alt="수정"  style="cursor:pointer;" onclick="pageEditGo()" />
					</span>
					<span>
						<img src="/imgs/board/btn_del.gif" alt="삭제"  style="cursor:pointer;" onclick="pageDelGo()" />
					</span>
				</div>
			<%} %>
