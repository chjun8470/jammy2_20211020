...
%>
	...
	<%@include file="/front/_temple/sso/mobile_t_top.jsp" %>
	...
	<%
		...
		if("login".equals(pageMode)) {
			if("".equals(util.getStr(loginVO.getUserIdx()))) {
				%><%@include file="/front/_module/sso/mobile/login.jsp" %><%
			 }else{
				%><script type="text/javascript" >location.href="/sso/home.do?siteId=<%=siteId%>";</script><%
			}
			...
			if(!"".equals(util.getStr(loginVO.getUserIdx()))) {
				...
				%>
				<%@include file="/front/_module/sso/mobile/join.jsp" %>
				<%
			}
			...
			if("".equals(util.getStr(loginVO.getUserIdx()))) {
				%><%@include file="/front/_module/sso/mobile/idpwd.jsp" %><%
			}else{
				%><%@include file="/front/_module/sso/mobile/home.jsp" %><%
			}

		}else if("mypagecon".equals(pageMode)) {
			if("".equals(util.getStr(loginVO.getUserIdx()))) {
				%><script type="text/javascript">location.href="/sso/login.do?siteId=<%=siteId%>";</script><%
			}else{
			%><%@include file="/front/_module/sso/mobile/mypagecon.jsp" %><%
			}
			...
			%><%@include file="/front/_module/sso/mobile/agecon.jsp" %><%
			}
			...
			%><%@include file="/front/_module/sso/mobile/agechange.jsp" %><%
			}
			...
			%><%@include file="/front/_module/sso/mobile/mypage.jsp" %><%
			}
			...
			if("".equals(util.getStr(loginVO.getUserIdx()))) {
				...
				%><%@include file="/front/_module/sso/mobile/deluser.jsp" %><%
			}
			...
			<%
				...
				if("".equals(util.getStr(loginVO.getUserIdx()))) {
					...
					%><%@include file="/front/_module/sso/mobile/leave.jsp" %><%
				}
		}else if("passChange".equals(pageMode)) {
			if("".equals(util.getStr(loginVO.getUserIdx()))) {
				%><script type="text/javascript">location.href="/sso/login.do?siteId=<%=siteId%>";</script><%
			}else{
				%><%@include file="/front/_module/sso/mobile/passChange.jsp" %><%
			}
	...
	<%@include file="/front/_temple/sso/mobile_t_footer.jsp" %>
