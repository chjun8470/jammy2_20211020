...
<head>
	...
	<%}else{ %>
			<link href="/css/cms/front/cont.css" rel="stylesheet" type="text/css"/>
			<link href="/css/cms/front/main.css" rel="stylesheet" type="text/css"/>
			<link href="/css/cms/front/base.css" rel="stylesheet" type="text/css"/>

			<link rel="stylesheet" type="text/css" href="/css/cms/front/cms_sys.css" />
